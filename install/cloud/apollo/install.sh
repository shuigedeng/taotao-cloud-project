...
docker run -d \
  ...
  --net=host \
  -e SPRING_DATASOURCE_URL="jdbc:mysql://192.168.10.200:3306/ApolloConfigDB?characterEncoding=utf8" \
  ...
  --name apollo-portal \
  --net=host \
  -e SPRING_DATASOURCE_URL="jdbc:mysql://192.168.10.200:3306/ApolloPortalDB?characterEncoding=utf8" \
  -e SPRING_DATASOURCE_USERNAME=root \
  -e SPRING_DATASOURCE_PASSWORD=123456 \
  -e APOLLO_PORTAL_ENVS=dev \
  -e DEV_META=http://192.168.10.200:8080 \
