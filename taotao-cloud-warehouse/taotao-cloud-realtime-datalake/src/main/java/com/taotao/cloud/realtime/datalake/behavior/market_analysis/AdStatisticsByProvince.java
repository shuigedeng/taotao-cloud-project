...
public class AdStatisticsByProvince {
    ...
    public static void main( String[] args ) throws Exception {
        ...
        DataStream<AdClickEvent> adClickEventStream =
        ...
        SingleOutputStreamOperator<AdClickEvent> filterAdClickStream =
                adClickEventStream
                        .keyBy("userId", "adId") // 基于用户id和广告id做分组
                        .process(new FilterBlackListUser(100));

        // 3. 基于省份分组，开窗聚合
        SingleOutputStreamOperator<AdCountViewByProvince> adCountResultStream =
                filterAdClickStream
