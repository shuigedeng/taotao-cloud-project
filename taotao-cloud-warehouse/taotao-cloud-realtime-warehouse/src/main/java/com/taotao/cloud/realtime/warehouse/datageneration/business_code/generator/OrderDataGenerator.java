...
public class OrderDataGenerator {
    ...
    private void generateOrderDetail( int count ) {
        ...
        String sql =
                "INSERT INTO order_detail (id, order_id, sku_id, sku_name, img_url, "
    ...
    private void generateOrderDetailActivity( int count ) {
        ...
        String sql =
                "INSERT INTO order_detail_activity (id, order_id, order_detail_id, "
    ...
    private void generateOrderDetailCoupon( int count ) {
        ...
        String sql =
                "INSERT INTO order_detail_coupon (id, order_id, order_detail_id, "
    ...
    private void generateOrderRefundInfo( int count ) {
        ...
        String sql =
                "INSERT INTO order_refund_info (id, user_id, order_id, sku_id, "
    ...
    private void generateRefundPayment( int count ) {
        ...
        String sql =
                "INSERT INTO refund_payment (id, out_trade_no, order_id, sku_id, "
