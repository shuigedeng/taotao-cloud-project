...
public class UserDataGenerator {
    ...
    private void generateUserInfo( int count ) {
        ...
        String sql =
                "INSERT INTO user_info (id, login_name, nick_name, passwd, name, phone_num, "
    ...
    private void generateUserAddress( int count ) {
        ...
        String sql =
                "INSERT INTO user_address (id, user_id, province_id, user_address, consignee, "
