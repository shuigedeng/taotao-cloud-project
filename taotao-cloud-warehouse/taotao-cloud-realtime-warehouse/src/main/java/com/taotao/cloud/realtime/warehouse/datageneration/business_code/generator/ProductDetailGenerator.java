...
public class ProductDetailGenerator {
    ...
    private void generateSkuAttrValue( int count ) {
        ...
        String sql =
                "INSERT INTO sku_attr_value (id, attr_id, value_id, sku_id, attr_name, value_name) "
                        + "VALUES (?, ?, ?, ?, ?, ?)";
    ...
    private void generateSkuImage( int count ) {
        ...
        String sql =
                "INSERT INTO sku_image (id, sku_id, img_name, img_url, spu_img_id, is_default) "
                        + "VALUES (?, ?, ?, ?, ?, ?)";
    ...
    private void generateSkuSaleAttrValue( int count ) {
        ...
        String sql =
                "INSERT INTO sku_sale_attr_value (id, sku_id, spu_id, sale_attr_value_id, "
    ...
    private void generateSpuPoster( int count ) {
        ...
        String sql =
                "INSERT INTO spu_poster (id, spu_id, img_name, img_url, create_time, update_time, is_deleted) "
                        + "VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    private void generateSpuSaleAttr( int count ) {
        ...
        String sql =
                "INSERT INTO spu_sale_attr (id, spu_id, base_sale_attr_id, sale_attr_name) "
                        + "VALUES (?, ?, ?, ?)";
    ...
    private void generateSpuSaleAttrValue( int count ) {
        ...
        String sql =
                "INSERT INTO spu_sale_attr_value (id, spu_id, base_sale_attr_id, sale_attr_value_name, "
