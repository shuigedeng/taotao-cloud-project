...
public class CouponDataGenerator {
    ...
    private void generateCouponInfo( int count ) {
        ...
        String sql =
                "INSERT INTO coupon_info (id, coupon_name, coupon_type, condition_amount, "
    ...
    private void generateCouponRange( int count ) {
        ...
        String sql =
                "INSERT INTO coupon_range (id, coupon_id, range_type, range_id) "
                        + "VALUES (?, ?, ?, ?)";
    ...
    private void generateCouponUse( int count ) {
        ...
        String sql =
                "INSERT INTO coupon_use (id, coupon_id, user_id, order_id, coupon_status, "
