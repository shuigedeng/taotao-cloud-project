...
package com.taotao.cloud.realtime.warehouse.datageneration.business_code.util;
...
public class RandomUtil {
    ...
    public static String generateNickName() {
        return NICK_PREFIXES[random.nextInt(NICK_PREFIXES.length)]
                + NICK_SUFFIXES[random.nextInt(NICK_SUFFIXES.length)];
    }
