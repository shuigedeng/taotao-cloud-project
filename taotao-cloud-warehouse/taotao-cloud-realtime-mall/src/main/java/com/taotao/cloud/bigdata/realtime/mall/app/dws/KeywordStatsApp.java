...
import com.taotao.cloud.bigdata.realtime.mall.app.func.KeywordUDTF;
import com.taotao.cloud.bigdata.realtime.mall.bean.KeywordStats;
...
public class KeywordStatsApp {
	...
	public static void main(String[] args) throws Exception {
        ...
        */
		...
		//TODO 7.转换为流
		DataStream<KeywordStats> keywordStatsDS = tableEnv
			.toAppendStream(reduceTable, KeywordStats.class);
