...
import com.taotao.cloud.bigdata.realtime.mall.bean.PaymentInfo;
...
public class PaymentWideApp {
	...
	public static void main(String[] args) throws Exception {
        ...
        */
		...
		//2.1 读取支付数据
		FlinkKafkaConsumer<String> paymentInfoSource = MyKafkaUtil
			.getKafkaSource(paymentInfoSourceTopic, groupId);
		...
		//4.1 支付流的Watermark
		SingleOutputStreamOperator<PaymentInfo> paymentInfoWithWatermarkDS = paymentInfoDS
		...
		//4.2 订单流的Watermark
		SingleOutputStreamOperator<OrderWide> orderWideWithWatermarkDS = orderWideDS
			.assignTimestampsAndWatermarks(
