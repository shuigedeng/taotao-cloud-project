...
`taotao-cloud` (taotao云平台) 基于gradle8.4、jdk21, 采用最新的SpringCloud Alibaba 2022.0.0、SpringCloud 2022.0.4、SpringBoot 3.1.5、SpringSecurity 6.1.4、Nacos 2.2、Mybatis-Plus 3.5、Redis 7等框架，开发的一款企业级微服务架构的云服务平台， 具有组件化、高性能、功能丰富的特点。代码简洁，架构清晰，组件可自由搭配，遵循SpringBoot编程思想，高度模块化和可配置化。
...
dependencyManagement{
  imports {
    mavenBom "io.github.shuigedeng:taotao-cloud-dependencies:2023.11"
  }
}
...
* **主体框架**：采用最新的Spring Boot 3.1.5、Spring Cloud 2022.0.4、Spring Cloud Alibaba 2022.0.0.0 版本进行设计
