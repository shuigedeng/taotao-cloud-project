...
`taotao-cloud` (taotao云平台) 基于gradle8.10.2、jdk21, 支持graalvm21, 采用最新的spring 6.1.13、SpringBoot 3.3.5、SpringCloud 2023.0.3、SpringSecurity 6.3.3、Nacos 2.4.2、Mybatis-Plus 3.5.8、Redis 7等框架，开发的一款企业级微服务架构的云服务平台， 
...
* **主体框架**：采用最新的`Spring Boot 3.3.5`、`Spring Cloud 2023.0.3`、`Spring Cloud Alibaba 2023.0.1.2` 版本进行设计
