...
**taotao-cloud** (taotao云平台) 基于gradle8.14.2、jdk21, 支持graalvm21, 采用最新的spring 6.2.8、SpringBoot 3.5.0、SpringCloud 2025.0.0、SpringSecurity 6.5.0、Nacos 3.0.1、Mybatis-Plus 3.5.12、Redis 7.4.0等框架，开发的一款企业级微服务架构的云服务平台， 
