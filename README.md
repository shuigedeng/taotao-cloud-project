...
**taotao-cloud(taotao云平台)**  基于**Gradle 9.4.0** 、**Jdk 25**, 支持**Graalvm 25**, 采用最新的**Spring 7.0.2**、**SpringBoot 4.0.2**、**SpringCloud 2025.1.1**、**SpringSecurity 7.0.2**、**Nacos 3.1.1**、**Mybatis-Plus 3.5.16**、**Redis 7.4.0**等框架，开发的一款企业级微服务架构的云服务平台， 
