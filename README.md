# <center>**taotao-cloud-project**</center>
...
taotao cloud project 创建这个仓库的目的就是工作以来的技术总结和技术沉淀 **仓库代码中不涉及公司任何业务代码** 主要包括如下几部分

- **大数据模块** 集成日志数据处理和分析、用户行为分析、数据仓库、数据湖等大数据处理
  

- **微服务脚手架模块** 集成了公司技术团队的基础框架,用于基础服务的集成和跟业务无关的基础技术集成, 提供大量的starter作为技术底层支持，
  同时基础框架集中统一优化中间件相关服务及使用，为开发人员提供高性能,更方便的基础服务接口及工具
...
总之基于Spring Cloud Alibaba的微服务架构。旨在为大家提供技术框架的基础能力的封装，减少开发工作，让您只关注业务
