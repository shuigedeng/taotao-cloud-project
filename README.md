...
dependencyManagement{
  imports {
    mavenBom "io.github.shuigedeng:taotao-cloud-dependencies:2024.06"
  }
}
...
* **主体框架**：采用最新的`Spring Boot 3.2.5`、`Spring Cloud 2023.0.1`、`Spring Cloud Alibaba 2023.0.1.0` 版本进行设计
