...
**taotao-cloud** (taotao云平台) 基于gradle8.12、jdk21, 支持graalvm21, 采用最新的spring 6.2.0、SpringBoot 3.4.0、SpringCloud 2023.0.4、SpringSecurity 6.4.1、Nacos 2.4.3、Mybatis-Plus 3.5.9、Redis 7.4.0等框架，开发的一款企业级微服务架构的云服务平台， 
