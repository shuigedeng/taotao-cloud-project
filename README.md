...
api "io.github.shuigedeng:taotao-boot-starter-webmvc"
```
...
<dependencies>
    <dependency>
      <groupId>io.github.shuigedeng</groupId>
      <artifactId>taotao-boot-starter-webmvc</artifactId>
    </dependency>
</dependencies>
```
...
## 14.基础组件 taotao-cloud-starter 项目模块 (暂未开源)
...
+--- Project ':taotao-boot-starter-base'
|    +--- Project ':taotao-boot-starter-base:taotao-boot-starter-agent'
|    +--- Project ':taotao-boot-starter-base:taotao-boot-starter-common'
|    +--- Project ':taotao-boot-starter-base:taotao-boot-starter-core'
|    +--- Project ':taotao-boot-starter-base:taotao-boot-starter-ddd'
|    +--- Project ':taotao-boot-starter-base:taotao-boot-starter-processor'
|    \--- Project ':taotao-boot-starter-base:taotao-boot-starter-test'
...
+--- Project ':taotao-boot-starter-connector'
|    +--- Project ':taotao-boot-starter-connector:taotao-boot-starter-apollo'
|    +--- Project ':taotao-boot-starter-connector:taotao-boot-starter-canal'
|    +--- Project ':taotao-boot-starter-connector:taotao-boot-starter-client'
|    +--- Project ':taotao-boot-starter-connector:taotao-boot-starter-dingtalk'
|    +--- Project ':taotao-boot-starter-connector:taotao-boot-starter-mail'
|    +--- Project ':taotao-boot-starter-connector:taotao-boot-starter-mqtt'
|    \--- Project ':taotao-boot-starter-connector:taotao-boot-starter-zookeeper'
...
|    +--- Project ':taotao-boot-starter-extension:taotao-boot-starter-eventbus'
...
|    +--- Project ':taotao-boot-starter-extension:taotao-boot-starter-lock'
...
|    +--- Project ':taotao-boot-starter-extension:taotao-boot-starter-seata'
...
|    +--- Project ':taotao-boot-starter-observability:taotao-boot-starter-logger'
...
|    +--- Project ':taotao-boot-starter-web:taotao-boot-starter-openapi'
|    +--- Project ':taotao-boot-starter-web:taotao-boot-starter-springdoc'
|    +--- Project ':taotao-boot-starter-web:taotao-boot-starter-webagg'
|    +--- Project ':taotao-boot-starter-web:taotao-boot-starter-webmvc'
|    +--- Project ':taotao-boot-starter-web:taotao-boot-starter-websocket'
|    \--- Project ':taotao-boot-starter-web:taotao-boot-starter-websocket-netty'
...
|    +--- Project ':taotao-boot-starter-webguard:taotao-boot-starter-validation'
|    +--- Project ':taotao-boot-starter-webguard:taotao-boot-starter-webguard-common' 
