...
**taotao-cloud(taotao云平台)**  基于**gradle9.2.1** 、**jdk25**, 支持**graalvm25**, 采用最新的**spring 7.0.1**、**SpringBoot 4.0.1**、**SpringCloud 2025.1.0**、**SpringSecurity 7.0.0**、**Nacos 3.1.1**、**Mybatis-Plus 3.5.16**、**Redis 7.4.0**等框架，开发的一款企业级微服务架构的云服务平台， 
...
* **主体框架**：采用最新的`Spring Boot 4.0.1`、`Spring Cloud 2025.1.0`、`Spring Cloud Alibaba 2025.1.0.0` 版本进行设计
