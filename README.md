...
**taotao-cloud** (taotao云平台) 基于gradle8.13、jdk21, 支持graalvm21, 采用最新的spring 6.2.4、SpringBoot 3.4.5、SpringCloud 2024.0.1、SpringSecurity 6.4.4、Nacos 2.5.1、Mybatis-Plus 3.5.11、Redis 7.4.0等框架，开发的一款企业级微服务架构的云服务平台， 
