...
public class UserJumpDetailApp {
	...
	public static void main(String[] args) throws Exception {
		...
		SingleOutputStreamOperator<JSONObject> jsonObjDS = dataStream
		...
		//TODO 4. 指定事件时间字段
		SingleOutputStreamOperator<JSONObject> jsonObjWithTSDS = jsonObjDS
        ...
        */
		...
		SingleOutputStreamOperator<String> filterDS = patternStream.flatSelect(
			...
			new PatternFlatSelectFunction<JSONObject, String>() {
				@Override
				public void flatSelect(Map<String, List<JSONObject>> pattern, Collector<String> out)
					throws Exception {
