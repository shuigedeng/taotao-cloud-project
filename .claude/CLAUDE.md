...
| Gradle | 9.6 Wrapper (`distributionUrl=gradle-9.7.1-bin.zip`) |
...
| BOM | `io.github.shuigedeng:taotao-cloud-dependencies:2026.10`（未开源，需私有仓库凭据） |
...
- 私有 BOM `taotao-cloud-dependencies:2026.10` 需私有仓库凭据
