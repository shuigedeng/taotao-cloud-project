...
docker run -d \
  ...
  --net=host \
  -e SPRING_DATASOURCE_URL="jdbc:mysql://172.16.6.151:3306/ApolloConfigDB?characterEncoding=utf8" \
  ...
  --name apollo-portal \
  --net=host \
  -e SPRING_DATASOURCE_URL="jdbc:mysql://172.16.6.151:3306/ApolloPortalDB?characterEncoding=utf8" \
  -e SPRING_DATASOURCE_USERNAME=root \
  -e SPRING_DATASOURCE_PASSWORD=123456 \
  -e APOLLO_PORTAL_ENVS=dev \
  -e DEV_META=http://172.16.6.151:8080 \
