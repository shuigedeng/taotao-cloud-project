 ...
 */
package com.taotao.cloud.order.api.dto.order_item;
 ...
 */
@Schema(name = "OrderItemQueryDTO", description = "订单项查询对象")
public class OrderItemQueryDTO implements Serializable {
	...
	public static final class OrderItemDTOBuilder {
		...
		public OrderItemQueryDTO build() {
			OrderItemQueryDTO orderItemSaveDTO = new OrderItemQueryDTO();
