...
ADD ./build/libs/taotao-cloud-order-biz-2022.07.jar ./

RUN java -Djarmode=layertools -jar taotao-cloud-order-biz-2022.07.jar extract
...
ARG APP_NAME=taotao-cloud-order
