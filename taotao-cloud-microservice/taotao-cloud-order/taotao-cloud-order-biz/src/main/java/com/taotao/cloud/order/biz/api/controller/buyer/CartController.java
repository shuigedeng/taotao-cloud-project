...
public class CartController {
	...
	@PreAuthorize("hasAuthority('dept:tree:data')")
	@GetMapping("/all")
	public Result<com.taotao.cloud.order.api.web.dto.cart.TradeDTO> cartAll() {
	...
	@PreAuthorize("hasAuthority('dept:tree:data')")
	@GetMapping("/checked")
	public Result<com.taotao.cloud.order.api.web.dto.cart.TradeDTO> cartChecked(@NotNull(message = "读取选中列表") String way) {
		//读取选中的列表
