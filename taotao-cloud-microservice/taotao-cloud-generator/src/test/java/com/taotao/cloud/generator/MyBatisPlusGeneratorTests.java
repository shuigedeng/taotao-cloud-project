...
class MyBatisPlusGeneratorTests {
    ...
    private enum DataSource {
         ...
         * 微服务
         */
        XUXIAOWEI_CLOUD("jdbc:mysql://127.0.0.1:3306/xuxiaowei_cloud_next", "root", "root", "微服务 数据库"),

        /**
         * 微服务-日志
         */
        XUXIAOWEI_CLOUD_LOG("jdbc:mysql://127.0.0.1:3306/xuxiaowei_cloud_next_log", "root", "root", "微服务 日志 数据库"),
        ;
    ...
    public static void main(String[] args) {
        ...
        List<Module> moduleList = Arrays.asList(
                ...
                new Module(
                        "cloud-commons-parent" + fileSeparator + "cloud-starter-oauth2", "cloud.xuxiaowei.next.oauth2"),
                new Module(
                        "cloud-commons-parent" + fileSeparator + "cloud-starter-system", "cloud.xuxiaowei.next.system"),
