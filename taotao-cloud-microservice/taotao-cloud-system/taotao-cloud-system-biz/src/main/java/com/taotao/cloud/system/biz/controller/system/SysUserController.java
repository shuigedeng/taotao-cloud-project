...
import com.taotao.cloud.system.api.dto.UserQueryCriteria;
import com.taotao.cloud.system.api.vo.UserPassVo;
import com.taotao.cloud.system.biz.entity.User;
...
import com.taotao.cloud.system.biz.service.UserService;
import com.taotao.cloud.system.biz.service.VerificationCodeService;
...
public class SysUserController {
    ...
    public ResponseEntity<Object> delete(@RequestBody Set<Long> ids) {
        ...
        for (Long id : ids) {
            Integer currentLevel = Collections.min(roleService.findByUsersId(user.getId()).stream().map(
