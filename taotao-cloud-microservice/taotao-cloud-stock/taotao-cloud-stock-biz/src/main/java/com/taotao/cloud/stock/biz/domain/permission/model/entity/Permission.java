...
public class Permission implements Entity<Permission> {
    ...
    public Permission(PermissionId permissionId, PermissionName permissionName, PermissionTypeEnum permissionType, PermissionLevelEnum permissionLevel, String menuIcon, PermissionCodes permissionCodes, int orderNum, com.taotao.cloud.stock.biz.domain.model.permission.MenuUrl menuUrl, Permission parent, StatusEnum status, List<Permission> subList) {
        this.permissionId = permissionId;
