package com.taotao.cloud.open.platform.common.handler;


import com.taotao.cloud.open.platform.common.enums.AsymmetricCryEnum;
import com.taotao.cloud.open.platform.common.handler.asymmetric.RSAAsymmetricCryHandler;
import com.taotao.cloud.open.platform.common.handler.asymmetric.SM2AsymmetricCryHandler;
...
public interface AsymmetricCryHandler {
	 ...
	 * 定义所有的非对称加密处理器
	 */
	Map<AsymmetricCryEnum, AsymmetricCryHandler> handlerMap = new EnumMap<AsymmetricCryEnum, AsymmetricCryHandler>(
		AsymmetricCryEnum.class) {{
