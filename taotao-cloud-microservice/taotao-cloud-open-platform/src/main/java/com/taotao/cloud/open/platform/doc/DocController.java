package com.taotao.cloud.open.platform.doc;
...
import com.taotao.cloud.open.platform.config.OpenApiConfig;
import com.taotao.cloud.open.platform.doc.annotation.OpenApiDoc;
import com.taotao.cloud.open.platform.doc.model.Api;
import com.taotao.cloud.open.platform.doc.model.Method;
import com.taotao.cloud.open.platform.doc.model.Param;
import com.taotao.cloud.open.platform.doc.model.Property;
import com.taotao.cloud.open.platform.doc.model.RetVal;
...
public class DocController {
	...
	private List<Property> getProperties(Type type) {
		...
		if (type instanceof Class) {
			...
			//枚举类型、接口类型等直接返回
			if (((Class<?>) type).isEnum() || ((Class<?>) type).isInterface()
				|| ((Class<?>) type).isAnnotation()) {
				return null;
			}
