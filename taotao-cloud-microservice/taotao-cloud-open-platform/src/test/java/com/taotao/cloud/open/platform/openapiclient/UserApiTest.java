...
public class UserApiTest {
	...
	public void getAllUsers() {
		...
		OpenApiClient client = new OpenApiClientBuilder(baseUrl, privateKey, remotePublicKey, "001",
			"userApi")
			.asymmetricCry(AsymmetricCryEnum.RSA)
			.retDecrypt(false)
	...
	public void addUser() {
		...
		OutParams outParams = apiClient.callOpenApi("addUser", (Object) "展昭", "13312341234",
			"1331234@qq.com", Gender.MALE);
		LogUtils.info("返回值：" + outParams);
	}
