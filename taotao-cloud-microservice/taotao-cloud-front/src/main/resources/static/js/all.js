  ...
  1: [function (a, b, c) {
      ...
      b.utils = c, a.Autocomplete = b, b.formatResult = function (a, b) {
        ...
        killerFn: null, initialize: function () {
          ...
          var b, c, d = this, e = d.options, f = e.formatResult, g = d.getQuery(d.currentValue),
              h = d.classes.suggestion, i = d.classes.selected, j = a(d.suggestionsContainer), k = e.beforeRender,
              l = "";
    ...
    !function (a) {
      ...
      a.fn.carousel = function (c) {
        ...
        var c, d, e = a(this), f = a(e.attr("data-target") || (c = e.attr("href")) && c.replace(/.*(?=#[^\s]+$)/, "")),
    ...
    !function (a, b) {
      ...
      j.prototype = {
        constructor: j, _process_options: function (b) {
          ...
          if (!this.isInline) {
            var b = this.picker.outerWidth(), c = this.picker.outerHeight(), d = 10, e = h.width(), f = h.height(),
                g = h.scrollTop(), i = parseInt(this.element.parents().filter(function () {
          ...
          var d, e = new Date(this.viewDate), f = e.getUTCFullYear(), g = e.getUTCMonth(),
              ...
              l = o[this.o.language].today || o.en.today || "", m = o[this.o.language].clear || o.en.clear || "";
    ...
    !function (a) {
      ...
      var b = "[data-toggle=dropdown]", c = ".sui-dropdown, .sui-dropup", d = function () {
        ...
        var c = a(this), d = c.parent(), e = c.parents(".sui-dropdown, .sui-dropup"), f = e.find("[role='menu']");
    ...
    !function (a) {
      ...
      a.extend({
        filesize: function (a, b) {
          var c, d = "", e = b || {}, f = Number(a), g = ["B", "kB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"],
    ...
    !function (a) {
      ...
      function l(a) {
        ...
        if (null !== c) {
          ...
          var x = document.createElement("div"), y = document.createElement("div"), z = document.createElement("div"),
    ...
    !function (a) {
      ...
      b.prototype = {
        constructor: b, init: function () {
          var b = this.$element, c = this.options, d = c.width, e = c.height, f = {small: 440, normal: 590, large: 790};
      ...
      a.fn.modal = function (c) {
        ...
        _modal: function (c, d) {
          ...
          var f = +new Date,
              g = a.extend({}, a.fn.modal.defaults, c, {id: f, okBtn: "纭畾"}, "string" == typeof d ? {body: d} : d),
              h = new b(null, g), i = h.$element;
    ...
    !function (a) {
      ...
      a.escape = c(b);
      var d = {evaluate: /<%([\s\S]+?)%>/g, interpolate: /<%=([\s\S]+?)%>/g, escape: /<%-([\s\S]+?)%>/g}, e = /(.)^/,
          f = {"'": "'", "\\": "\\", "\r": "r", "\n": "n", "\u2028": "u2028", "\u2029": "u2029"},
          g = /\\|'|\r|\n|\u2028|\u2029/g, h = function (a) {
            return "\\" + f[a]
          };
      ...
      b.prototype = {
        _defaultCfg: {
          ...
          if (!this.isInline && !this.isInDatepicker) {
            var b = this.picker.outerWidth(), c = this.picker.outerHeight(), d = 10, e = a(window), f = e.width(),
                g = e.height(), h = e.scrollTop(), i = parseInt(this.element.parents().filter(function () {
                  return "auto" !== a(this).css("z-index")
                }).first().css("z-index")) + 10,
                j = this.component ? this.component.parent().offset() : this.element.offset(),
                k = this.component ? this.component.outerHeight(!0) : this.element.outerHeight(!1),
          ...
          this.isInput ? this._events = [[this.element, {
            focus: a.proxy(this._show, this), keyup: a.proxy(function (b) {
              -1 === a.inArray(b.keyCode, [27, 37, 39, 38, 40, 32, 13, 9]) && this._updateUI()
            }, this), keydown: a.proxy(this._keydown, this)
          }]] : this.component && this.hasInput ? this._events = [[this.element.find("input"), {
          ...
          this.picker.on("click", ".J_up", function (c) {
            ...
            var d = c.currentTarget, e = a(d).parent().parent().parent(), f = e.attr("data-role"), g = d.innerHTML,
                h = b[f + "Attr"], i = parseInt(g - h.current, 10);
