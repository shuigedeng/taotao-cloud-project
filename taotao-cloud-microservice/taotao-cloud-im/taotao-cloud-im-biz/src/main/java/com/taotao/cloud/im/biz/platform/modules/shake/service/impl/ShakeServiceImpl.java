...
public class ShakeServiceImpl implements ShakeService {
	...
	private void sendShake(ShakeVo01 shakeVo) {
		...
		// 保存经纬度
		geoHashUtils.add(ApiConstant.REDIS_GEO, shakeVo.getLongitude(), shakeVo.getLatitude(),
				userId);
	}
	...
	private ShakeVo02 getShake() {
		...
		ChatUser chatUser = ChatUser.initUser(
				chatUserService.getById(NumberUtil.parseLong(userId)));
