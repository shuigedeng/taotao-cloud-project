...
public class ChatUserServiceImpl extends BaseServiceImpl<ChatUser> implements ChatUserService {
	...
	public String resetQrCode() {
		...
		QrConfig qrConfig = QrConfig.create().setWidth(ApiConstant.QR_CODE_SIZE)
				.setHeight(ApiConstant.QR_CODE_SIZE).setImg(original);
		...
		redisUtils.set(ApiConstant.REDIS_QR_CODE + userId, value, ApiConstant.REDIS_QR_CODE_TIME,
				TimeUnit.DAYS);
		return value;
	}
