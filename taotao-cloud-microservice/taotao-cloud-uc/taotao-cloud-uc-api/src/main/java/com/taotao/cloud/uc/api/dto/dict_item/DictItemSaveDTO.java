 ...
 */
@Schema(name = "DictItemSaveDTO", description = "字典项添加对象")
public class DictItemSaveDTO implements Serializable {
	...
	public DictItemSaveDTO() {
	}

	public DictItemSaveDTO(Long dictId, String itemText, String itemValue, String description,
		Integer status) {
		this.dictId = dictId;
		this.itemText = itemText;
		this.itemValue = itemValue;
