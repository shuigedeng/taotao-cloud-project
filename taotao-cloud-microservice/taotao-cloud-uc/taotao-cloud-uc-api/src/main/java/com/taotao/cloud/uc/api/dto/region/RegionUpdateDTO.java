 ...
 */
package com.taotao.cloud.uc.api.dto.region;
 ...
 */
@Schema(name = "RegionUpdateDTO", description = "地区更新对象")
public class RegionUpdateDTO implements Serializable {
	...
	public RegionUpdateDTO(String code, String name, Integer level, String cityCode,
