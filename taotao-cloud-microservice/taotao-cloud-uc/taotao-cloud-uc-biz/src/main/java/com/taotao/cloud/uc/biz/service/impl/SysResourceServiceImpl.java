...
public class SysResourceServiceImpl extends
	BaseSuperServiceImpl<SysResourceMapper, SysResource, SysResourceRepository, Long>
	implements ISysResourceService<SysResource, Long> {
	...
	//
	//@Override
	//public Page<SysResource> findResourcePage(Pageable pageable, ResourceQuery resourceQuery) {
	//	BooleanExpression expression = SYS_RESOURCE.delFlag.eq(false);
	//	OrderSpecifier<LocalDateTime> desc = SYS_RESOURCE.createTime.desc();
	//	return sysResourceRepository.findPageable(expression, pageable, desc);
	//}
	//
	//@Override
