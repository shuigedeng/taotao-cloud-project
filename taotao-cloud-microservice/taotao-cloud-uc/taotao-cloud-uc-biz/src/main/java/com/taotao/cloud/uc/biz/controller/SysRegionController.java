...
public class SysRegionController {
	...
	@Operation(summary = "根据父id查询", description = "根据父id查询", method = "GET",
	...
	public Result<List<QueryRegionByParentIdVO>> queryRegionByParentId(
		@Parameter(name = "parentId", description = "父id", required = true,
			schema = @Schema(implementation = Long.class, defaultValue = "1"), in = ParameterIn.QUERY)
	...
	@Operation(summary = "树形结构查询", description = "树形结构查询", method = "GET",
		security = @SecurityRequirement(name = HttpHeaders.AUTHORIZATION))
	@RequestOperateLog(description = "根据父id查询")
