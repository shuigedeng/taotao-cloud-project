 ...
 */
@Mapper
public interface SysCompanyMapper extends BaseSuperMapper<SysCompany, Long> {
	...
	@Select("""
		...
		""")
	List<SysUser> selectUserListByPage(Page<SysUser> page, @Param("id") Long id,
	...
	@Update("""
		...
		""")
	int updateUserByIds(@Param("ids") List<Long> ids, @Param("plan") SysUser plan);
	...
	@Select("<script>" +
		...
		" </foreach>" +
		" </script>")
	List<SysUser> selectAllUserbyIds(@Param("ids") List<String> ids);
	...
	IPage<SysUser> selectUserPlanByPage(Page<SysUser> page,
	...
	@Select("""
		...
		""")
	IPage<SysUser> selectLogByPage(Page<SysUser> page, @Param("typeName") String typeName,
	...
	@Select("""
		...
		""")
	IPage<SysUser> selectCompanybyPage(Page<SysUser> page,
	...
	public SysUser getUserById(@Param("id") Integer id);
	...
	List<SysUser> selectResourceByIds(@Param(Constants.WRAPPER) Wrapper<SysUser> wrapper);
