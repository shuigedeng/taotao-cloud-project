...
public interface UserMapper {
	 ...
	 * @version 1.0.0
	 */
	UserQueryVO sysUserToUserVO(SysUser sysUser);
	 ...
	 * @version 1.0.0
	 */
	List<UserQueryVO> sysUserToUserVO(List<SysUser> userList);

	/**
	 * UserDTO转SysUser
	 *
	 * @param userQueryDTO userDTO
	 * @return com.taotao.cloud.uc.biz.entity.SysUser
	 * @author shuigedeng
	 * @since 2020/11/11 14:52
	 * @version 1.0.0
	 */
	SysUser userDtoToSysUser(UserQueryDTO userQueryDTO);
