...
package com.taotao.cloud.auth.biz.oauth2.oauth2_server.processor;

import com.taotao.cloud.auth.biz.oauth2.core.definition.domain.HerodotusUser;
import com.taotao.cloud.auth.biz.oauth2.core.definition.service.EnhanceUserDetailsService;
import com.taotao.cloud.auth.biz.oauth2.core.definition.strategy.StrategyUserDetailsService;
...
//    }
	...
	public UserDetails loadUserBySocial(String source, AccessPrincipal accessPrincipal)
		...
		log.debug("[Herodotus] |- UserDetailsService loaded social user : [{}]",
	...
	public HerodotusUser loadHerodotusUserByUsername(String username)
		throws UsernameNotFoundException {
		HerodotusUser HerodotusUser = strategyUserDetailsService.findUserDetailsByUsername(
			username);
		log.debug("[Herodotus] |- UserDetailsService loaded user : [{}]", username);
		return HerodotusUser;
	}
