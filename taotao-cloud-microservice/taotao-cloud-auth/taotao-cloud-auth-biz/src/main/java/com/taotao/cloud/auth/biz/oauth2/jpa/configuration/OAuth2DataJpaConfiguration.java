...
package com.taotao.cloud.auth.biz.oauth2.jpa.configuration;

import com.taotao.cloud.auth.biz.oauth2.jpa.service.HerodotusAuthorizationConsentService;
import com.taotao.cloud.auth.biz.oauth2.jpa.service.HerodotusAuthorizationService;
import com.taotao.cloud.auth.biz.oauth2.jpa.service.HerodotusRegisteredClientService;
import com.taotao.cloud.auth.biz.oauth2.jpa.storage.JpaOAuth2AuthorizationConsentService;
import com.taotao.cloud.auth.biz.oauth2.jpa.storage.JpaOAuth2AuthorizationService;
import com.taotao.cloud.auth.biz.oauth2.jpa.storage.JpaRegisteredClientRepository;
...
public class OAuth2DataJpaConfiguration {
	...
	public OAuth2AuthorizationService authorizationService(
		...
		JpaOAuth2AuthorizationService jpaOAuth2AuthorizationService = new JpaOAuth2AuthorizationService(
	...
	public OAuth2AuthorizationConsentService authorizationConsentService(
		...
		RegisteredClientRepository registeredClientRepository) {
		JpaOAuth2AuthorizationConsentService jpaOAuth2AuthorizationConsentService = new JpaOAuth2AuthorizationConsentService(
