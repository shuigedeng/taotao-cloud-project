...
package com.taotao.cloud.auth.biz.oauth2.core.condition;
...
public class AutoUnlockUserAccountCondition implements Condition {
	...
	public boolean matches(ConditionContext conditionContext, AnnotatedTypeMetadata metadata) {
		boolean result = PropertyResolver.getBoolean(conditionContext,
			OAuth2Constants.ITEM_COMPLIANCE_AUTO_UNLOCK, true);
