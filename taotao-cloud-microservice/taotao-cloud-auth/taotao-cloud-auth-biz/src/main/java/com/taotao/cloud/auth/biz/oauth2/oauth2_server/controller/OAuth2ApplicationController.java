...
import com.taotao.cloud.auth.biz.oauth2.oauth2_server.dto.OAuth2ApplicationDto;
...
public class OAuth2ApplicationController extends BaseController<OAuth2Application, String> {
	...
	public Result<Map<String, Object>> findByPage(
		...
		if (ObjectUtils.isNotEmpty(pages) && CollectionUtils.isNotEmpty(pages.getContent())) {
			List<OAuth2ApplicationDto> auth2Applications = pages.getContent().stream()
				.map(this::toDto).collect(Collectors.toList());
			return result(
				getPageInfoMap(auth2Applications, pages.getTotalPages(), pages.getTotalElements()));
		}
	...
	@PutMapping
	public Result<OAuth2Application> authorize(@RequestParam(name = "applicationId") String scopeId,
