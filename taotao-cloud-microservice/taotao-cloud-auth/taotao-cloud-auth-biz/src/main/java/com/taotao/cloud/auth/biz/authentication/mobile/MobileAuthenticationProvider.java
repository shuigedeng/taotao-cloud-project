...
public class MobileAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication)
		...
		try {
			Authentication mobileAuthentication = authenticationManager.authenticate(mobileAuthenticationToken);
			Set<String> authorizedScopes = registeredClient.getScopes();

			if (!CollectionUtils.isEmpty(
				mobileAuthenticationToken.getScopes())) {
				Set<String> unauthorizedScopes = mobileAuthenticationToken.getScopes()
					.stream()
					.filter(
			...
			JwtEncodingContext context = JwtEncodingContext.with(headersBuilder, claimsBuilder)
				...
				.authorizationGrant(mobileAuthenticationToken)
				.build();
	...
	public boolean supports(Class<?> authentication) {
		return MobileAuthenticationToken.class.isAssignableFrom(
			authentication);
	}
