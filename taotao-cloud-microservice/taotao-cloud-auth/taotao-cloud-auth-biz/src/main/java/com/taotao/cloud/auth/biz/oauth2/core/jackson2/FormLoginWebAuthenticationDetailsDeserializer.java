...
package com.taotao.cloud.auth.biz.oauth2.core.jackson2;
...
import com.taotao.cloud.auth.biz.oauth2.core.definition.domain.FormLoginWebAuthenticationDetails;
 ...
 */
public class FormLoginWebAuthenticationDetailsDeserializer extends
	JsonDeserializer<FormLoginWebAuthenticationDetails> {

	@Override
	public FormLoginWebAuthenticationDetails deserialize(JsonParser jp,
		...
		return new FormLoginWebAuthenticationDetails(remoteAddress, sessionId, closed,
			parameterName, category, code, identity);
	}
