...
public enum ClientProviders {
	...
	WECHAT_WEB_LOGIN_CLIENT("wechat-web-login",
		...
		authorizationCodeGrantRequest -> {
			...
			URI uri = UriComponentsBuilder.fromUriString(tokenUri).queryParams(queryParameters)
				.build().toUri();
	 ...
	 * <a href="https://qyapi.weixin.qq.com/cgi-bin/gettoken?corpid=ID&corpsecret=SECRET">...</a>
	 */
	WORK_WECHAT_SCAN_CLIENT("work-wechat-scan",
		...
		authorizationCodeGrantRequest -> {
			...
			queryParameters.add(WechatParameterNames.CORP_SECRET,
