...
import com.taotao.cloud.auth.biz.oauth2.core.definition.domain.Authority;
import com.taotao.cloud.auth.biz.oauth2.core.definition.strategy.StrategyAuthorityDetailsService;
import com.taotao.cloud.auth.biz.oauth2.oauth2_server.entity.OAuth2Authority;
...
public class OAuth2AuthorityController implements Controller {
	...
	@Operation(summary = "查询所有权限数据", description = "查询所有权限数据用于给Scope分配权限",
		responses = {
			@ApiResponse(description = "权限列表", content = @Content(mediaType = "application/json", schema = @Schema(implementation = OAuth2Authority.class)))})
