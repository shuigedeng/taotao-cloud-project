...
import com.taotao.cloud.auth.biz.herodotus.authorization.customizer.HerodotusTokenCustomizer;
import com.taotao.cloud.auth.biz.herodotus.authorization.utils.OAuth2ConfigurerUtils;
import com.taotao.cloud.auth.biz.herodotus.core.enums.Certificate;
import com.taotao.cloud.auth.biz.herodotus.core.properties.OAuth2Properties;
...
import com.taotao.cloud.auth.biz.herodotus.core.response.HerodotusAuthenticationFailureHandler;
...
public class AuthorizationServerConfiguration {
	...
	public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity httpSecurity,
		JwtDecoder jwtDecoder, HttpCryptoProcessor httpCryptoProcessor) throws Exception {
		...
		SecurityFilterChain securityFilterChain = httpSecurity.formLogin(Customizer.withDefaults())
			.build();
