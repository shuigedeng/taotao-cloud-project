...
public class OneClickAuthenticationProvider implements AuthenticationProvider, InitializingBean,
	...
	private final OneClickUserDetailsService accountUserDetailsService;
	private MessageSourceAccessor messages = SpringSecurityMessageSource.getAccessor();

	public OneClickAuthenticationProvider(OneClickUserDetailsService accountUserDetailsService) {
	...
	public Authentication authenticate(Authentication authentication)
		...
		Assert.isInstanceOf(OneClickAuthenticationToken.class, authentication,
			() -> messages.getMessage(
