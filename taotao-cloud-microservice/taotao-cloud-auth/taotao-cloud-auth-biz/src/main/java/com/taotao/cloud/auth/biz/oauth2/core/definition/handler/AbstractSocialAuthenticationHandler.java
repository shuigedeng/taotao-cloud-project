...
import com.taotao.cloud.auth.biz.oauth2.core.definition.domain.SocialUserDetails;
import com.taotao.cloud.auth.biz.oauth2.core.exception.SocialCredentialsUserBindingFailedException;
import com.taotao.cloud.auth.biz.oauth2.core.exception.UsernameAlreadyExistsException;
...
public abstract class AbstractSocialAuthenticationHandler implements SocialAuthenticationHandler {
	 ...
	 */
	public abstract void additionalRegisterOperation(HerodotusUser HerodotusUser,
	 ...
	 */
	public abstract void additionalSignInOperation(HerodotusUser HerodotusUser,
		SocialUserDetails newSocialUserDetails, SocialUserDetails oldSocialUserDetails);
	...
	public HerodotusUser authentication(String source, AccessPrincipal accessPrincipal)
		...
		if (ObjectUtils.isEmpty(oldSocialUserDetails)) {
			...
			this.additionalSignInOperation(HerodotusUser, newSocialUserDetails,
				oldSocialUserDetails);
			return HerodotusUser;
		}
	}
}
