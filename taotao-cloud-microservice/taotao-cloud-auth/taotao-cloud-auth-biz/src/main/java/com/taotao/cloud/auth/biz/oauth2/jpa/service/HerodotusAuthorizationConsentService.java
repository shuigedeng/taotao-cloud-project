...
import com.taotao.cloud.auth.biz.oauth2.jpa.entity.HerodotusAuthorizationConsent;
import com.taotao.cloud.auth.biz.oauth2.jpa.repository.HerodotusAuthorizationConsentRepository;
...
public class HerodotusAuthorizationConsentService {
	...
	public Optional<HerodotusAuthorizationConsent> findByRegisteredClientIdAndPrincipalName(
		...
		Optional<HerodotusAuthorizationConsent> result = this.authorizationConsentRepository.findByRegisteredClientIdAndPrincipalName(
	...
	public void deleteByRegisteredClientIdAndPrincipalName(String registeredClientId,
		...
		this.authorizationConsentRepository.deleteByRegisteredClientIdAndPrincipalName(
			registeredClientId, principalName);
		log.debug(
			"[Herodotus] |- HerodotusAuthorizationConsent Service deleteByRegisteredClientIdAndPrincipalName.");
	}
}
