...
import com.taotao.cloud.auth.biz.idserver.entity.OAuth2Client;
import com.taotao.cloud.auth.biz.idserver.entity.dto.OAuth2ClientDTO;
import com.taotao.cloud.auth.biz.idserver.exception.NotFoundException;
import com.taotao.cloud.auth.biz.idserver.mapstruct.OAuth2ClientMapper;
import com.taotao.cloud.auth.biz.idserver.repository.OAuth2ClientRepository;
...
public class JpaRegisteredClientRepository implements OAuth2ClientService {
	...
	public void update(OAuth2ClientDTO client) {
		...
		OAuth2Client flush = this.oAuth2ClientRepository.findById(id).orElseThrow(
	...
	public RegisteredClient findByClientId(String clientId) {
		...
		return this.oAuth2ClientRepository.findByClientId(clientId)
			.map(OAuth2Client::toRegisteredClient).orElse(null);
	}
