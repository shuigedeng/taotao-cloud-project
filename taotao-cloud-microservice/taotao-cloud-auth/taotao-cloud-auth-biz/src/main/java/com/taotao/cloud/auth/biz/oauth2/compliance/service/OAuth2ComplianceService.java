...
package com.taotao.cloud.auth.biz.oauth2.compliance.service;

import cn.hutool.extra.servlet.ServletUtil;
import cn.hutool.http.useragent.UserAgent;
import cn.hutool.http.useragent.UserAgentUtil;
import com.google.common.net.HttpHeaders;
import com.taotao.cloud.auth.biz.oauth2.compliance.entity.OAuth2Compliance;
import com.taotao.cloud.auth.biz.oauth2.compliance.repository.OAuth2ComplianceRepository;
...
public class OAuth2ComplianceService {
	...
	public Page<OAuth2Compliance> findByCondition(int pageNumber, int pageSize,
		String principalName, String clientId, String ip) {
	...
	public OAuth2Compliance save(String principalName, String clientId, String operation,
	...
	public OAuth2Compliance toEntity(String principalName, String clientId, String operation,
		HttpServletRequest request) {
