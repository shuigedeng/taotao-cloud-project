                ...
                if (RuleConstant.ALL.equalsIgnoreCase(blackList.getRequestMethod())
                    ...
                    if (StringUtil.isNotBlank(blackList.getStartTime())
                        ...
                        if (DateUtils.between(
                                DateUtils.parseLocalTime(blackList.getStartTime(), CommonConstant.DATETIME_FORMAT),
                                DateUtils.parseLocalTime(blackList.getEndTime(), CommonConstant.DATETIME_FORMAT))) {
