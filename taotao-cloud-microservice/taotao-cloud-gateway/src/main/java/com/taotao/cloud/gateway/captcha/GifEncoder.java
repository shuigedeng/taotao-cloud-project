package com.taotao.cloud.gateway.captcha;
 ...
 *    e.finish();
 * </pre>
 * No Copyright (c) asserted on the source code of this class.  May be used for any purpose,
 * however, refer to the Unisys LZW patent for restrictions on use of the associated Encoder class.
 * Please forward any corrections to questions at fmsware.com.
 */
public class GifEncoder {
	 ...
	 * the next frame is received so that timing data can be inserted.  Invoking
	 * <code>finish()</code> flushes all frames.  If <code>setSize</code> was not invoked, the size
	 * of the first image is used for all subsequent frames.
	 *
