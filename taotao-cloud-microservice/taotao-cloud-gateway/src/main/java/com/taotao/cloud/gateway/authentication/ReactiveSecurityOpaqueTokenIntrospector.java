...
public class ReactiveSecurityOpaqueTokenIntrospector implements ReactiveOpaqueTokenIntrospector {
	...
	public ReactiveSecurityOpaqueTokenIntrospector(
		OAuth2EndpointProperties endpointProperties, OAuth2ResourceServerProperties resourceServerProperties) {
		this(
	 ...
	 * @since 2023-07-04 10:00:05
	 */
	public ReactiveSecurityOpaqueTokenIntrospector(String introspectionUri, String clientId, String clientSecret) {
	 ...
	 * @since 2023-07-04 10:00:05
	 */
	public ReactiveSecurityOpaqueTokenIntrospector(String introspectionUri, RestOperations restOperations) {
		Assert.notNull(introspectionUri, "introspectionUri cannot be null");
	 ...
	 * @since 2023-07-04 10:00:05
	 */
	private static String getIntrospectionUri(OAuth2EndpointProperties endpointProperties,
