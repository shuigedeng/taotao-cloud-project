package com.taotao.cloud.gateway.springcloud.captcha.utils;

import com.taotao.cloud.gateway.springcloud.captcha.BaseCaptcha;
import com.taotao.cloud.gateway.springcloud.captcha.ChineseCaptcha;
import com.taotao.cloud.gateway.springcloud.captcha.ChineseGifCaptcha;
import com.taotao.cloud.gateway.springcloud.captcha.GifCaptcha;
import com.taotao.cloud.gateway.springcloud.captcha.MathCaptcha;
import com.taotao.cloud.gateway.springcloud.captcha.MathGifCaptcha;
import com.taotao.cloud.gateway.springcloud.captcha.SpecCaptcha;
...
public class CaptchaUtil {
	 ...
	 * @return 验证码结果
	 */
	public static String outPng(int width, int height, int len, Font font,
	 ...
	 * @return 验证码结果
	 */
	private static String outCaptcha(int width, int height, int len, Font font, int cType,
		OutputStream outputStream) {
