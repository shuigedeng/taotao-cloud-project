...
import com.taotao.cloud.websocket.netty.support.ByteMethodArgumentResolver;
import com.taotao.cloud.websocket.netty.support.EventMethodArgumentResolver;
import com.taotao.cloud.websocket.netty.support.HttpHeadersMethodArgumentResolver;
import com.taotao.cloud.websocket.netty.support.MethodArgumentResolver;
import com.taotao.cloud.websocket.netty.support.PathVariableMapMethodArgumentResolver;
import com.taotao.cloud.websocket.netty.support.PathVariableMethodArgumentResolver;
import com.taotao.cloud.websocket.netty.support.RequestParamMapMethodArgumentResolver;
import com.taotao.cloud.websocket.netty.support.RequestParamMethodArgumentResolver;
import com.taotao.cloud.websocket.netty.support.SessionMethodArgumentResolver;
import com.taotao.cloud.websocket.netty.support.TextMethodArgumentResolver;
import com.taotao.cloud.websocket.netty.support.ThrowableMethodArgumentResolver;
...
public class PojoMethodMapping {
	...
	public PojoMethodMapping(Class<?> pojoClazz, ApplicationContext context,
		AbstractBeanFactory beanFactory) throws DeploymentException {
	...
	Object[] getBeforeHandshakeArgs(Channel channel, FullHttpRequest req) throws Exception {
		return getMethodArgumentValues(channel, req, beforeHandshakeParameters,
			beforeHandshakeArgResolvers);
	}
	...
	Object[] getOnMessageArgs(Channel channel, TextWebSocketFrame textWebSocketFrame)
		throws Exception {
		return getMethodArgumentValues(channel, textWebSocketFrame, onMessageParameters,
			onMessageArgResolvers);
	}
	...
	Object[] getOnBinaryArgs(Channel channel, BinaryWebSocketFrame binaryWebSocketFrame)
		throws Exception {
		return getMethodArgumentValues(channel, binaryWebSocketFrame, onBinaryParameters,
			onBinaryArgResolvers);
	}
	...
	private Object[] getMethodArgumentValues(Channel channel, Object object,
		MethodParameter[] parameters, MethodArgumentResolver[] resolvers) throws Exception {
