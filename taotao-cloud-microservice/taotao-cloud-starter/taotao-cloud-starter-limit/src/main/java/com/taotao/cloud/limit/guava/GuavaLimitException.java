 ...
 */
public class GuavaLimitException extends BaseException {

	public GuavaLimitException(String message) {
		super(message);
	}

	public GuavaLimitException(Integer code, String message) {
		super(code, message);
	}
	...
	public GuavaLimitException(Integer code, String message, Throwable e) {
