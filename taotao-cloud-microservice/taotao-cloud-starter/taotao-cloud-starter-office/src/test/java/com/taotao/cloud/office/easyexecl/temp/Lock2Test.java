...
public class Lock2Test {
	...
	public void test() throws Exception {
		...
		List<Object> list = EasyExcel.read("/Users/zhuangjiaju/test/test3.xlsx").sheet(0)
	...
	public void write() throws Exception {
		String fileName =
			TestFileUtil.getPath() + "styleWrite" + System.currentTimeMillis() + ".xlsx";
		// 头的策略
		...
		EasyExcel.write(fileName, DemoData.class).registerWriteHandler(horizontalCellStyleStrategy)
			.sheet("模板")
			.doWrite(data());
	}
	...
	public void simpleRead() {
		...
		EasyExcel.read(fileName, LockData.class, new LockDataListener()).useDefaultListener(false)
			.sheet().doRead();
	}
