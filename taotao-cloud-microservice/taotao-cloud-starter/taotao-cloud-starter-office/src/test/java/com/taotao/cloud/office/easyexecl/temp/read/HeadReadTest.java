...
public class HeadReadTest {
	...
	public void test() throws Exception {
		...
		EasyExcel.read(file, HeadReadData.class, new HeadListener()).ignoreEmptyRow(false).sheet(0)
			.doRead();
	...
	public void testCache() throws Exception {
		...
		EasyExcel.read(file, HeadReadData.class, new HDListener()).readCache(new Ehcache(20))
			.sheet(0).doRead();
