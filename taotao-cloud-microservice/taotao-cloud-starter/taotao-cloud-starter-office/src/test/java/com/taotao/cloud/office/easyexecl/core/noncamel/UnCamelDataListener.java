package com.taotao.cloud.office.easyexecl.core.noncamel;
...
public class UnCamelDataListener extends AnalysisEventListener<UnCamelData> {
    ...
    public void invokeHeadMap(Map<Integer, String> headMap, AnalysisContext context) {
        LogUtils.debug("Head is:{}", JSON.toJSONString(headMap));
    ...
    public void doAfterAllAnalysed(AnalysisContext context) {
        ...
        LogUtils.debug("First row:{}", JSON.toJSONString(list.get(0)));
    }
}
