package com.taotao.cloud.office.easyexecl.core.multiplesheets;
...
public class MultipleSheetsDataTest {
	...
	private void read(File file) {
		...
		ExcelReader excelReader = EasyExcel.read(file, MultipleSheetsData.class,
			multipleSheetsListener).build();
