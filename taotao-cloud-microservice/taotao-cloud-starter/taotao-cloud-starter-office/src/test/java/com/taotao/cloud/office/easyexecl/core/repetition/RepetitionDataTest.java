package com.taotao.cloud.office.easyexecl.core.repetition;
...
public class RepetitionDataTest {
	...
	private void readAndWrite(File file) {
		...
		ExcelReader excelReader = EasyExcel.read(file, RepetitionData.class,
			new RepetitionDataListener()).build();
