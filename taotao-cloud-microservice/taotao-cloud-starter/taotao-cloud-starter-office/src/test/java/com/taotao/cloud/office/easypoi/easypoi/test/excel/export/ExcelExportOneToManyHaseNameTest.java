...
import com.taotao.cloud.office.easypoi.test.entity.onettomany.DataitemEntity;
import com.taotao.cloud.office.easypoi.test.entity.onettomany.DemandEntity;
import com.taotao.cloud.office.easypoi.test.entity.onettomany.SupMaterialEntity;
import com.taotao.cloud.office.easypoi.test.entity.onettomany.hasname.DeptEntity;
import java.io.File;
	...
	public void demandEntityTest() {
		...
		try {
			...
			FileOutputStream fos = new FileOutputStream(
				"D:/home/excel/ExcelExportOneToManyHaseNameTest.demandEntityTest.xlsx");
			workbook.write(fos);
			fos.close();
		} catch (IOException e) {
			e.printStackTrace();
