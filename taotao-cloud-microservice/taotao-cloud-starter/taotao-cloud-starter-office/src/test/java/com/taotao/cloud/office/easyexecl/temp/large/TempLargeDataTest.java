...
import com.taotao.cloud.office.easyexecl.core.large.LargeDataTest;
...
public class TempLargeDataTest {
	...
	public static void init() {
		...
		fileWriteTemp07 = TestFileUtil.createNewFile(
			"large" + File.separator + "fileWriteTemp07.xlsx");
		fileWritePoi07 = TestFileUtil.createNewFile(
			"large" + File.separator + "fileWritePoi07.xlsx");
	...
	public void read() throws Exception {
		...
		EasyExcel.read(new FileInputStream("D:\\test\\MRP生产视图(1).xlsx"), LargeData.class,
	...
	public void noModelRead() throws Exception {
		...
		long start = System.currentTimeMillis();
		EasyExcel.read(TestFileUtil.readUserHomeFile("test/ld.xlsx"),
	...
	public void noModelRead2() throws Exception {
		...
		EasyExcel.read(
				new File(
					"/Users/zhuangjiaju/IdeaProjects/easyexcel/target/test-classes/large1617887262709.xlsx"),
				new NoModelLargeDataListener())
			.sheet().doRead();
		LOGGER.info("Large data total time spent:{}", System.currentTimeMillis() - start);
	}
