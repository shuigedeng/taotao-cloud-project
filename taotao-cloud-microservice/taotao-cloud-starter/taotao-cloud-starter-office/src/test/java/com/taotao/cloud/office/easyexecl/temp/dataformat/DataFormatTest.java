...
import com.taotao.cloud.office.easyexecl.core.dataformat.DateFormatData;
import com.taotao.cloud.office.easyexecl.temp.Lock2Test;
...
public class DataFormatTest {
	...
	public void tests1() throws IOException, InvalidFormatException {
		String file = "D://test/dataformat1.xlsx";
		List<DateFormatData> list = EasyExcel.read(file, DateFormatData.class, null).sheet()
			.doReadSync();
