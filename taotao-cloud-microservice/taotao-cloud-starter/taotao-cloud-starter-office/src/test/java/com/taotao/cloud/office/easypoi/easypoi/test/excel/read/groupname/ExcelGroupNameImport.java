...
import com.taotao.cloud.office.easypoi.test.entity.groupname.GnEntity;
import com.taotao.cloud.office.easypoi.test.entity.groupname.GroupNameEntity;
import java.io.File;
...
public class ExcelGroupNameImport {
	...
	public void groupNameTest() {
		...
		List<GroupNameEntity> list = ExcelImportUtil.importExcel(
			new File(FileUtilTest.getWebRootPath("import/groupName.xlsx")), GroupNameEntity.class,
			params);
	...
	public void groupNameEntityTest() {
		...
		List<GnEntity> list = ExcelImportUtil.importExcel(
			new File(FileUtilTest.getWebRootPath("import/groupName_GnEntity.xlsx")), GnEntity.class,
			params);
		System.out.println(new Date().getTime() - start);
		Assert.assertEquals(10, list.size());
		System.out.println(ReflectionToStringBuilder.toString(list.get(0)));
