package com.taotao.cloud.office.easyexecl.temp.csv;
...
public class CsvReadTest {
	...
	public void write() throws Exception {
		Appendable out = new PrintWriter(
			new OutputStreamWriter(
				new FileOutputStream(TestFileUtil.createNewFile("csvWrite1.csv"))));
	...
	public void read1() throws Exception {
		...
		for (CSVRecord record : records) {
			...
			LogUtils.info("row:{},{}", lastName, firstName);
		}
	...
	public void csvWrite() throws Exception {
		// 写法1
		String fileName =
			TestFileUtil.getPath() + "simpleWrite" + System.currentTimeMillis() + ".csv";
		...
		LogUtils.info("数据：{}", list.size());
		for (Object data : list) {
			LogUtils.info("返回数据：{}", JSON.toJSONString(data));
		}
	}
	...
	public void writeFile() throws Exception {
		FileInputStream fileInputStream = new FileInputStream(
			new File("/Users/zhuangjiaju/test/test1.csv"));
		FileMagic fileMagic = FileMagic.valueOf(fileInputStream);
		LogUtils.info("{}", fileMagic);
	}
