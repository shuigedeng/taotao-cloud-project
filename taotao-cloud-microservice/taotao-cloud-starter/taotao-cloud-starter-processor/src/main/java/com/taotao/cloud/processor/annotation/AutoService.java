...
package com.taotao.cloud.processor.annotation;

import com.taotao.cloud.processor.service.AutoServiceProcessor;
 ...
 * AutoServiceProcessor} generates the configuration files which allows service providers to be
