 ...
 */
package com.taotao.cloud.processor.model;
 ...
 */
@SupportedAnnotationTypes({"com.taotao.cloud.processor.model.Version"})
...
public class VersionProcessor extends AbstractProcessor {
	...
	public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
		for (TypeElement currentAnnotation : annotations) {
			...
			if (qualifiedName.contentEquals("com.taotao.cloud.processor.Version")) {
