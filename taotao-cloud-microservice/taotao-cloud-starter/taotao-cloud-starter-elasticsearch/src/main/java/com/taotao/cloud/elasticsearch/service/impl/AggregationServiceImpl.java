    ...
    public Map<String, Object> requestStatAgg(String indexName, String routing) throws IOException {
        ...
        searchSourceBuilder.aggregation(
                ...
                AggregationBuilders
                        ...
                        .field("timestamp")
                        .addRange(
                                dateTime.atZone(ZoneId.systemDefault()), currDt.plusDays(1).atZone(ZoneId.systemDefault())
                        )
                        .subAggregation(
                                AggregationBuilders
                                        .cardinality("uv")
                ...
                AggregationBuilders
                        ...
                        .field("timestamp")
                        .addRange(dateTime.minusDays(1).atZone(ZoneId.systemDefault()), currDt.atZone(ZoneId.systemDefault()))
                        .subAggregation(
                                //聚合并且按小时分组查询当天内的数据
                                AggregationBuilders
                ...
                AggregationBuilders
                        .dateRange("currMonth")
                        .field("timestamp")
                        .addRange(dateTime.minusDays(30).atZone(ZoneId.systemDefault()), currDt.atZone(ZoneId.systemDefault()))
        ).aggregation(
                //聚合查询浏览器的数据
                AggregationBuilders
                        .terms("browser")
                ...
                AggregationBuilders
                        ...
                        .field("timestamp")
                        .addRange(
                                dateTime.minusHours(1).atZone(ZoneId.systemDefault()), currDt.atZone(ZoneId.systemDefault())
                        )
                        .subAggregation(
                                AggregationBuilders
                                        .cardinality("uv")
