...
public class SearchBuilder {
	...
	public SearchBuilder setHighlight(String field, String preTags, String postTags) {
		if (StrUtil.isNotEmpty(field) && StrUtil.isNotEmpty(preTags) && StrUtil.isNotEmpty(
			postTags)) {
...
////							concat(field.fragments()));
//					}
//				}
//			} catch (InvocationTargetException | IllegalAccessException | NoSuchMethodException e) {
//				throw new UncategorizedElasticsearchException(
//					"failed to set highlighted value for field: " + field.getName()
