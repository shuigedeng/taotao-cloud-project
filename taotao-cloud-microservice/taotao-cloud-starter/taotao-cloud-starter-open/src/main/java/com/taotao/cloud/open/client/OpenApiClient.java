package com.taotao.cloud.open.client;
...
import com.taotao.cloud.open.common.model.BinaryParam;
...
public class OpenApiClient {
    ...
    private void logCostTime(String operate, long startTime) {
        LogUtil.debug("{}{}耗时:{}ms", logPrefix.get(), operate, (System.nanoTime() - startTime) / 100_0000);
    }
