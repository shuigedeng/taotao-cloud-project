package com.taotao.cloud.monitor.alarm.core;


import com.taotao.cloud.monitor.alarm.core.helper.ExecuteHelper;
import com.taotao.cloud.monitor.alarm.core.loader.ConfLoaderFactory;
...
public class AlarmWrapper {
	...
	private final ConcurrentHashMap<String, AtomicInteger> alarmCountMap;


	private final IConfLoader confLoader;
	...
	public void initExecutorService() {
		...
		alarmExecutorService = new ThreadPoolExecutor(3, 5, 60,
			...
			new DefaultThreadFactory("taotao-cloud-monitor-sms-sender"),
			new ThreadPoolExecutor.CallerRunsPolicy());

		// 每分钟清零一把报警计数
		ScheduledExecutorService scheduleExecutorService = new ScheduledThreadPoolExecutor(1,
			new DefaultThreadFactory("taotao-cloud-monitor-clear-sender"));
