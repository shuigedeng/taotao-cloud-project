...
public class HuaWeiOssConfiguration implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		LogUtils.started(HuaWeiOssConfiguration.class, StarterName.OSS_HUAWEI_STARTER);
	}
	...
	public ObsClient obsClient(HuaweiOssConfig huaweiOssConfig) {
		return new ObsClient(huaweiOssConfig.getAccessKey(), huaweiOssConfig.getSecretKey(),
			huaweiOssConfig.getClientConfig());
	}
}
