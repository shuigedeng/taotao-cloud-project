 ...
 */
public class AliyunOssUploadFileServiceImpl extends AbstractUploadFileService {
	...
	public AliyunOssUploadFileServiceImpl(AliyunOssProperties properties, OSS oss) {
		this.oss = oss;
