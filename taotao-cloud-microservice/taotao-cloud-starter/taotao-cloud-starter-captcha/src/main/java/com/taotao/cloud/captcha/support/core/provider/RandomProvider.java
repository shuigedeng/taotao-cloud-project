 ...
 * @author shuigedeng
 * @version 2022.07
 * @since 2022-07-12 12:58:28
 */
public class RandomProvider {

	private static final String[] CHARACTERS = {"2", "3", "4", "5", "6", "7", "8", "9", "A", "B",
		"C", "D", "E", "F", "G", "H", "J", "K", "M", "N", "P", "Q", "R", "S", "T", "U", "V", "W",
		"X", "Y", "Z", "a", "b", "c", "d", "e", "f", "g", "h", "j", "k", "m", "n", "p", "q", "r",
		"s", "t", "u", "v", "w", "x", "y", "z"};
	 ...
	 * 常用言责
	 */
	private static final int[][] COLOR = {{0, 135, 255}, {51, 153, 51}, {255, 102, 102},
		{255, 153, 0}, {153, 102, 0}, {153, 102, 153}, {51, 153, 153}, {102, 102, 255},
		{0, 102, 204}, {204, 51, 51}, {0, 153, 204}, {0, 51, 102}};
	private static final String[] DICTIONARY = new String[]{"\u7684", "\u4e00", "\u4e86", "\u662f",
		"\u6211", "\u4e0d", "\u5728", "\u4eba", "\u4eec", "\u6709", "\u6765", "\u4ed6", "\u8fd9",
		"\u4e0a", "\u7740", "\u4e2a", "\u5730", "\u5230", "\u5927", "\u91cc", "\u8bf4", "\u5c31",
		"\u53bb", "\u5b50", "\u5f97", "\u4e5f", "\u548c", "\u90a3", "\u8981", "\u4e0b", "\u770b",
		"\u5929", "\u65f6", "\u8fc7", "\u51fa", "\u5c0f", "\u4e48", "\u8d77", "\u4f60", "\u90fd",
		...
		"\u6025", "\u6797", "\u505c", "\u606f", "\u53e5", "\u533a", "\u8863", "\u822c", "\u62a5",
		"\u53f6", "\u538b", "\u6162", "\u53d4", "\u80cc", "\u7ec6"};
	private static final List<String> WORDS = Arrays.stream(DICTIONARY)
	...
	public static Color[] randomColors(int number) {
		List<Color> colors = IntStream.range(0, number).mapToObj(i -> randomColor())
			.collect(Collectors.toList());
	...
	public static String[] randomCharacters(int number, CaptchaCharacter captchaCharacter) {
		List<String> characters = IntStream.range(0, number)
			.mapToObj(i -> randomCharacter(captchaCharacter)).collect(Collectors.toList());
