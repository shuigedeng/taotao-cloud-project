...
public class CaptchaAutoConfiguration implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		LogUtils.started(CaptchaAutoConfiguration.class, StarterName.CAPTCHA_STARTER);
	}
	...
	public CaptchaService captchaService(CaptchaProperties prop) {
		...
		config.put(CaptchaConst.REQ_FREQUENCY_LIMIT_ENABLE, prop.getReqFrequencyLimitEnable() ? "1" : "0");
