...
package com.taotao.cloud.captcha.support.core.constants;
...
public interface CaptchaConstants  {
     ...
     * security
     */
    String PROPERTY_PREFIX_CAPTCHA = "taotao.cloud" + ".captcha";

    String CACHE_NAME_TOKEN_CAPTCHA = "taotao.cloud" +  "captcha:";
