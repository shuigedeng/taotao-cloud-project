...
//	private SecurityProperties securityProperties;
	...
	public boolean hasPermission(Authentication authentication, String requestMethod,
		String requestURI) {
...
//			TenantContextHolder.setTenant(clientId);
			...
			for (SecurityMenu menu : menuList) {
				if (StrUtil.isNotEmpty(menu.getUrl()) && antPathMatcher
					.match(menu.getUrl(), requestURI)) {
