...
//
//	public RedisTokenStoreComponent(RedisConnectionFactory connectionFactory,
...
//			.getIncludeClientIds();
//		//黑名单
//		List<String> exclusiveClientIds = securityProperties.getAuth().getRenew()
...
//		byte[] approvalKey = serializeKey(
//			SecurityConstant.REDIS_UNAME_TO_ACCESS + getApprovalKey(authentication));
//		byte[] clientId = serializeKey(
//			SecurityConstant.REDIS_CLIENT_ID_TO_ACCESS + authentication.getOAuth2Request()
//				.getClientId());
//
//		RedisConnection conn = getConnection();
//		try {
...
//						.invoke(conn, authToAccessKey, serializedAccessToken);
//				} catch (Exception ex) {
...
//				byte[] refreshToAccessKey = serializeKey(
...
//					this.redisConnectionSet_2_0
//						.invoke(conn, refreshAuthKey, serialize(authentication));
//				} catch (Exception ex) {
//					throw new RuntimeException(ex);
//				}
//			} else {
...
//	}
//
//	private void expireRefreshToken(OAuth2RefreshToken refreshToken, RedisConnection conn,
//		byte[] refreshKey, byte[] refreshAuthKey) {
//		if (refreshToken instanceof ExpiringOAuth2RefreshToken) {
//			ExpiringOAuth2RefreshToken expiringRefreshToken = (ExpiringOAuth2RefreshToken) refreshToken;
//			Date expiration = expiringRefreshToken.getExpiration();
//			if (expiration != null) {
//				int seconds = Long
//					.valueOf((expiration.getTime() - System.currentTimeMillis()) / 1000L)
//					.intValue();
...
//		String userName) {
//		byte[] approvalKey = serializeKey(
//			SecurityConstant.REDIS_UNAME_TO_ACCESS + getApprovalKey(clientId, userName));
//		List<byte[]> byteList;
//		RedisConnection conn = getConnection();
//		try {
