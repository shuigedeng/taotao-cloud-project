package com.taotao.cloud.security.springsecurity.jwt.model;
...
public class AuthInfo {
	...
	public AuthInfo(String token, String tokenType, String refreshToken, String name,
		String account, String avatar, String workDescribe, Long userId, long expire,
		LocalDateTime expiration, Long expireMillis) {
		this.token = token;
