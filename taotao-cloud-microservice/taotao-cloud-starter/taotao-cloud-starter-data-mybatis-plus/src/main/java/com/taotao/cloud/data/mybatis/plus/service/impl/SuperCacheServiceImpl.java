...
import com.taotao.cloud.common.model.CacheKeyBuilder;
...
public abstract class SuperCacheServiceImpl<M extends SuperMapper<T>, T> extends
	SuperServiceImpl<M, T> implements
...
//	}
	...
	public boolean saveOrUpdateBatch(Collection<T> entityList, int batchSize) {
		...
		return SqlHelper
			.executeBatch(getEntityClass(), log, entityList, batchSize, (sqlSession, entity) -> {
