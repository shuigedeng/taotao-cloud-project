...
public final class ReflectMethodUtils {
    ...
    public static List<String> getParamTypeNames(final Method method) {
        ...
        return ArrayUtils.toList(paramTypes, new IHandler<Class<?>, String>() {
            @Override
    ...
    public static String buildSetMethodName(final String propertyName) {
        ...
        return MethodConst.SET_PREFIX + StringUtils.firstToUpperCase(propertyName);
    }
    ...
    public static String buildGetMethodName(final Class fieldType,
        ...
        if(boolean.class.equals(fieldType)) {
            return MethodConst.IS_PREFIX + StringUtils.firstToUpperCase(propertyName);
        }
        return MethodConst.GET_PREFIX + StringUtils.firstToUpperCase(propertyName);
    }
