...
public interface DatePattern {
	 ...
	 */
	DateTimeFormatter NORM_DATE_FORMAT = DateTimeFormatter.ofPattern(NORM_DATE_PATTERN)
	 ...
	 */
	DateTimeFormatter NORM_TIME_FORMAT = DateTimeFormatter.ofPattern(NORM_TIME_PATTERN)
		.withZone(ZoneId.systemDefault());
	 ...
	 */
	DateTimeFormatter NORM_DATETIME_MINUTE_FORMAT = DateTimeFormatter.ofPattern(
		NORM_DATETIME_MINUTE_PATTERN).withZone(ZoneId.systemDefault());
	 ...
	 */
	DateTimeFormatter NORM_DATETIME_FORMAT = DateTimeFormatter.ofPattern(NORM_DATETIME_PATTERN)
		.withZone(ZoneId.systemDefault());
	 ...
	 */
	DateTimeFormatter NORM_DATETIME_MS_FORMAT = DateTimeFormatter.ofPattern(
		NORM_DATETIME_MS_PATTERN).withZone(ZoneId.systemDefault());
	 ...
	 */
	DateTimeFormatter CHINESE_DATE_FORMAT = DateTimeFormatter.ofPattern(CHINESE_DATE_PATTERN)
		.withZone(ZoneId.systemDefault());
	 ...
	 */
	DateTimeFormatter PURE_DATE_FORMAT = DateTimeFormatter.ofPattern(PURE_DATE_PATTERN)
		.withZone(ZoneId.systemDefault());
	 ...
	 */
	DateTimeFormatter PURE_DATETIME_MS_FORMAT = DateTimeFormatter.ofPattern(
	 ...
	 */
	DateTimeFormatter HTTP_DATETIME_FORMAT = DateTimeFormatter.ofPattern(HTTP_DATETIME_PATTERN,
	 ...
	 */
	DateTimeFormatter JDK_DATETIME_FORMAT = DateTimeFormatter.ofPattern(JDK_DATETIME_PATTERN,
		Locale.US);
	 ...
	 */
	DateTimeFormatter UTC_FORMAT = DateTimeFormatter.ofPattern(UTC_PATTERN)
	 ...
	 */
	DateTimeFormatter UTC_WITH_ZONE_OFFSET_FORMAT = DateTimeFormatter.ofPattern(
		UTC_WITH_ZONE_OFFSET_PATTERN).withZone(ZoneOffset.UTC);
	 ...
	 */
	DateTimeFormatter UTC_MS_FORMAT = DateTimeFormatter.ofPattern(UTC_MS_PATTERN)
		.withZone(ZoneOffset.UTC);
	 ...
	 * UTC时间{@link DateTimeFormatter}：yyyy-MM-dd'T'HH:mm:ssZ
	 */
	DateTimeFormatter UTC_MS_WITH_ZONE_OFFSET_FORMAT = DateTimeFormatter.ofPattern(
		UTC_MS_WITH_ZONE_OFFSET_PATTERN).withZone(ZoneOffset.UTC);
