...
public abstract class BeanCopier {
	...
	private static final Signature IS_ASSIGNABLE_VALUE = TypeUtils.parseSignature(
		"boolean isAssignableValue(Class, Object)");
	...
	public static class Generator extends AbstractClassGenerator {
		...
		public void generateClass(ClassVisitor v) {
			...
			PropertyDescriptor[] getters = ReflectionUtil.getBeanGetters(source);
			PropertyDescriptor[] setters = ReflectionUtil.getBeanSetters(target);
			...
			for (PropertyDescriptor setter : setters) {
				...
				CopyProperty targetIgnoreCopy = ReflectionUtil.getAnnotation(target, propName,
					CopyProperty.class);
				// set 上有忽略的 注解
...
//					}
		 ...
		 */
		private void generateClassFormMap(ClassEmitter ce, CodeEmitter e, Type sourceType,
			Type targetType) {
			// 支持链式 bean
