...
public class SmsCodeException extends BaseException {
	...
	public SmsCodeException(Integer code, String message, Throwable e) {
		super(code, message, e);
	}

	public SmsCodeException(ResultEnum result) {
		super(result);
	}

	public SmsCodeException(ResultEnum result, Throwable e) {
		super(result, e);
	}
}
