...
public class ConvertUtils {
	...
	private static boolean isBaseDataType(Class clazz) throws Exception {
		return (clazz.equals(String.class) || clazz.equals(Integer.class) || clazz.equals(
			Byte.class) || clazz.equals(Long.class) || clazz.equals(Double.class) || clazz.equals(
			Float.class) || clazz.equals(Character.class) || clazz.equals(Short.class)
			|| clazz.equals(BigDecimal.class) || clazz.equals(BigInteger.class) || clazz.equals(
	...
	public static String camelName(String name) {
		...
		if (name == null || name.isEmpty()) {
			// 没必要转换
			return "";
		} else if (!name.contains(CommonConstant.UNDER)) {
			// 不含下划线，仅将首字母小写
	...
	public static <F, T> T entityToModel(F entity, Class<T> modelClass) {
		LogUtils.debug("entityToModel : Entity属性的值赋值到Model");
		Object model = null;
