...
import com.taotao.cloud.common.support.tuple.KeyPair;
...
public class RSAUtils {
	...
	public static PublicKey getPublicKey(String base64PubKey) {
		...
		byte[] keyBytes = org.springframework.util.Base64Utils.decodeFromString(base64PubKey);
	...
	public static PrivateKey getPrivateKey(String base64PriKey) {
		...
		byte[] keyBytes = org.springframework.util.Base64Utils.decodeFromString(base64PriKey);
	...
	public static String getKeyString(Key key) {
		return org.springframework.util.Base64Utils.encodeToString(key.getEncoded());
	}
	...
	public static String encryptToBase64(PublicKey publicKey, @Nullable String data) {
		...
		return org.springframework.util.Base64Utils.encodeToString(encrypt(publicKey, data.getBytes(StandardCharsets.UTF_8)));
	}
	...
	public static byte[] decryptByPublicKeyFromBase64(PublicKey publicKey, byte[] base64Data) {
		return decryptByPublicKey(publicKey, org.springframework.util.Base64Utils.decode(base64Data));
	}
	...
	public static String decryptFromBase64(PrivateKey privateKey, @Nullable String base64Data) {
		...
		return new String(decrypt(privateKey, org.springframework.util.Base64Utils.decodeFromString(base64Data)),
	...
	public static byte[] decryptFromBase64(String base64PrivateKey, byte[] base64Data) {
		return decrypt(base64PrivateKey, org.springframework.util.Base64Utils.decode(base64Data));
	}
	...
	public static String decryptByPublicKeyFromBase64(PublicKey publicKey,
		...
		return new String(decryptByPublicKey(publicKey, org.springframework.util.Base64Utils.decodeFromString(base64Data)),
			StandardCharsets.UTF_8);
	}
