...
public class ValidatorUtils {
	 ...
	 * 验证器实例
	 */
	private static final Validator VALIDATOR_INSTANCE = Validation.buildDefaultValidatorFactory()
		.getValidator();
	//private static final Validator VALIDATOR_INSTANCE = ContextUtils.getBean(Validator.class, true);
	...
	public static boolean simpleValidate(Object object, Class<?>... groups) {
		Set<ConstraintViolation<Object>> constraintViolations = VALIDATOR_INSTANCE.validate(object,
			groups);
