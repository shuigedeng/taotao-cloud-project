...
import com.taotao.cloud.feign.configuration.FeignInterceptorConfiguration;
import com.taotao.cloud.feign.configuration.VersionLoadbalancerAutoConfiguration;
...
@Import({FeignAutoConfiguration.class,
	...
	VersionLoadbalancerAutoConfiguration.class})
public @interface EnableTaoTaoCloudFeignClients {
	 ...
	 * @return the array of 'basePackages'.
	 */
	String[] basePackages() default {"com.taotao.cloud.*.api.feign"};
