package com.taotao.cloud.schedule.gloriaapi.service.impl;
...
import com.gloria.schedule.common.utils.Query;
import com.gloria.schedule.dao.ScheduleJobDao;
import com.gloria.schedule.entity.ScheduleJobEntity;
import com.gloria.schedule.service.ScheduleJobService;
import com.gloria.schedule.utils.ScheduleUtils;
...
public class ScheduleJobServiceImpl extends ServiceImpl<ScheduleJobDao, ScheduleJobEntity> implements ScheduleJobService {
	...
	public void saveJob(ScheduleJobEntity scheduleJob) {
		...
		scheduleJob.setStatus(SqlConstant.ScheduleStatus.NORMAL.getValue());
    ...
    public void pause(Long[] jobIds) {
    	...
    	updateBatch(jobIds, SqlConstant.ScheduleStatus.PAUSE.getValue());
    }
    ...
    public void resume(Long[] jobIds) {
    	...
    	updateBatch(jobIds, SqlConstant.ScheduleStatus.NORMAL.getValue());
    }
