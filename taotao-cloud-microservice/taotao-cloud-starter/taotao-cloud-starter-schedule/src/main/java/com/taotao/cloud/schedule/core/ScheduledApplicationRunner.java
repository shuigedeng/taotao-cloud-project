...
import com.taotao.cloud.schedule.common.annotation.ScheduledOrder;
import com.taotao.cloud.schedule.common.utils.AnnotationUtils;
import com.taotao.cloud.schedule.common.utils.proxy.Chain;
import com.taotao.cloud.schedule.common.utils.proxy.Point;
import com.taotao.cloud.schedule.common.utils.proxy.ProxyUtils;
import com.taotao.cloud.schedule.core.interceptor.BaseStrengthen;
import com.taotao.cloud.schedule.core.interceptor.RunnableBaseInterceptor;
...
public class ScheduledApplicationRunner implements ApplicationRunner, ApplicationContextAware {
	 ...
	 */
	@Autowired
	private com.taotao.cloud.schedule.core.ScheduledConfig scheduledConfig;
	/**
	 * 定时任务执行线程
	 */
	@Autowired
	...
	public void run(ApplicationArguments args) {
		...
		for (String name : nameToScheduledSource.keySet()) {
			...
			//执行方法
			try {
				ScheduledFuture<?> schedule = com.taotao.cloud.schedule.core.ScheduledFutureFactory.create(threadPoolTaskScheduler
