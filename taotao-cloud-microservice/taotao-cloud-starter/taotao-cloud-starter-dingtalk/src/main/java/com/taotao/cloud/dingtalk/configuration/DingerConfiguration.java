 ...
 */
@Configuration
@AutoConfigureAfter({BeanConfiguration.class, HttpClientConfiguration.class,
	ThreadPoolConfiguration.class})
public class DingerConfiguration implements InitializingBean {

	private final DingerProperties properties;
	private final ResourceLoader resourceLoader;

	public DingerConfiguration(
