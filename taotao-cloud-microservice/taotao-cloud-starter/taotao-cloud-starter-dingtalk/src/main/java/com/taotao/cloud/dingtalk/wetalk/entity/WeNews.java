 ...
 */
package com.taotao.cloud.dingtalk.wetalk.entity;


import com.taotao.cloud.dingtalk.core.entity.ImageTextDeo;
import com.taotao.cloud.dingtalk.wetalk.entity.enums.WeTalkMsgType;
			...
			if (List.class.isInstance(value)) {
				...
				for (ImageTextDeo imageText : imageTexts) {
					this.news.articles.add(
						new News.Article(imageText.getTitle(), imageText.getDescription(),
							imageText.getUrl(), imageText.getPicUrl()));
				}
			}
			break;
		}
