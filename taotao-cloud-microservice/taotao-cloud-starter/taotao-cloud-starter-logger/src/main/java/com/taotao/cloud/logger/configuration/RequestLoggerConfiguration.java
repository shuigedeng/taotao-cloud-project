...
public class RequestLoggerConfiguration implements InitializingBean {
	...
	@Bean
	public RedisRequestLoggerServiceImpl redisRequestLogService(RedisRepository redisRepository) {
	...
	@Bean
	public KafkaRequestLoggerServiceImpl kafkaRequestLogService(KafkaTemplate<String, String> kafkaTemplate) {
