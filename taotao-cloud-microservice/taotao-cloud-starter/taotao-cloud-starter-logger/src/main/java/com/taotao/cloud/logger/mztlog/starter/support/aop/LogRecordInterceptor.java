...
import com.taotao.cloud.logger.mztlog.beans.LogRecordOps;
...
import com.taotao.cloud.logger.mztlog.starter.support.parse.LogRecordValueParser;
...
public class LogRecordInterceptor extends LogRecordValueParser implements InitializingBean, MethodInterceptor, Serializable {
    ...
    private Object execute(MethodInvocation invoker, Object target, Method method, Object[] args) throws Throwable {
        ...
        try {
            ...
            LogUtil.error("log record parse before function exception", e);
        }
        try {
            ret = invoker.proceed();
        } catch (Exception e) {
        ...
        try {
            ...
            //记录日志错误不要影响业务
			LogUtil.error("log record parse exception", t);
        } finally {
    ...
    private void recordExecute(Object ret, Method method, Object[] args, Collection<LogRecordOps> operations,
        ...
        for (LogRecordOps operation : operations) {
            try {
                ...
                LogUtil.error("log record execute exception", t);
            }
        }
    }
