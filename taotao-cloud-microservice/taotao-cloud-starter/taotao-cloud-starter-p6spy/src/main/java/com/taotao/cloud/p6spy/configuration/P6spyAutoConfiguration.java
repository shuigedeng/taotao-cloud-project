...
public class P6spyAutoConfiguration implements ApplicationRunner , InitializingBean {

	@Override
	public void afterPropertiesSet() throws Exception {
		LogUtil.started(P6spyAutoConfiguration.class, StarterName.P6SPY_STARTER);
	}
