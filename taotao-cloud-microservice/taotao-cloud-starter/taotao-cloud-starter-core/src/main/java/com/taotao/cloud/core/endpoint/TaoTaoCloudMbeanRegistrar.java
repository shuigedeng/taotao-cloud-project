 ...
 */
public class TaoTaoCloudMbeanRegistrar implements ApplicationContextAware, InitializingBean, DisposableBean {
	...
	public TaoTaoCloudMbeanRegistrar() throws MalformedObjectNameException {
	}
