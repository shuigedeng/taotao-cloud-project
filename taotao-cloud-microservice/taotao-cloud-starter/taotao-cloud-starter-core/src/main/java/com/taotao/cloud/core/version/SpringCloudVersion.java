...
public final class SpringCloudVersion {
	...
	private static String determineSpringCloudVersion() {
		String implementationVersion = BootstrapConfiguration.class.getPackage()
			.getImplementationVersion();
		if (implementationVersion != null) {
			return implementationVersion;
		}
		CodeSource codeSource = BootstrapConfiguration.class.getProtectionDomain().getCodeSource();
		if (codeSource == null) {
			return null;
		}
