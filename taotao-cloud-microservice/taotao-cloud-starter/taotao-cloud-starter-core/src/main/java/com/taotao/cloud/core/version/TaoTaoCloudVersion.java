 ...
 * @since 1.3.0
 */
public final class TaoTaoCloudVersion {

	private TaoTaoCloudVersion() {
	}
	...
	public static String getVersion() {
		return determineTaoTaoCloudVersion();
	}

	private static String determineTaoTaoCloudVersion() {
		String implementationVersion = TaoTaoCloudVersion.class.getPackage()
			.getImplementationVersion();
		if (implementationVersion != null) {
			return implementationVersion;
		}
		CodeSource codeSource = TaoTaoCloudVersion.class.getProtectionDomain().getCodeSource();
		if (codeSource == null) {
			return null;
		}
