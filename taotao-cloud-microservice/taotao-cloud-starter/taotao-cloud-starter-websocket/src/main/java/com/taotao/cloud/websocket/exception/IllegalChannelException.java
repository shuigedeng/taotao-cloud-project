...
public class IllegalChannelException extends WebSocketException {
	...
	public IllegalChannelException(Integer code, String message) {
		super(code, message);
	}
	...
	public IllegalChannelException(Integer code, String message, Throwable e) {
