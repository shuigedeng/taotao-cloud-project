...
public class Session {
	 ...
	 * is supposed to be down-cast into more concrete type such as {@link InetSocketAddress} to
	...
	/**
	 * Get how many bytes must be drained from underlying buffers until {@link #isWritable()}
	 * returns {@code true}. This quantity will always be non-negative. If {@link #isWritable()} is
	 * {@code true} then 0.
	 */
