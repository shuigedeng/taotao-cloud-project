package com.taotao.cloud.mail.util;
...
public class MailUtils {
	 ...
	 * @since 4.0.3
	 */
	public String send(String to, String cc, String bcc, String subject, String content,
		boolean isHtml, File... files) {
		return send(splitAddress(to), splitAddress(cc), splitAddress(bcc), subject, content, isHtml,
			files);
	}
	 ...
	 * @since 4.0.3
	 */
	public String send(Collection<String> tos, Collection<String> ccs, Collection<String> bccs,
	 ...
	 * @since 3.2.0
	 */
	public String send(MailAccount mailAccount, String to, String subject, String content,
		boolean isHtml, File... files) {
	 ...
	 * @return message-id
	 */
	public String send(MailAccount mailAccount, Collection<String> tos, String subject,
	 ...
	 * @since 4.0.3
	 */
	public String send(MailAccount mailAccount, Collection<String> tos, Collection<String> ccs,
	 ...
	 * @return message-id
	 */
	public String send(String to, String subject, String content, Map<String, InputStream> imageMap,
		boolean isHtml, File... files) {
	...
	public String send(String to, String cc, String bcc, String subject, String content,
		...
		return send(splitAddress(to), splitAddress(cc), splitAddress(bcc), subject, content,
			imageMap, isHtml, files);
	}
	 ...
	 * @since 3.2.0
	 */
	public String sendHtml(Collection<String> tos, String subject, String content,
		Map<String, InputStream> imageMap, File... files) {
	 ...
	 */
	public String send(Collection<String> tos, Collection<String> ccs, Collection<String> bccs,
		String subject, String content, Map<String, InputStream> imageMap, boolean isHtml,
		File... files) {
		return send(getMailAccount(), true, tos, ccs, bccs, subject, content, imageMap, isHtml,
			files);
	}
	 ...
	 * @since 4.6.3
	 */
	private String send(MailAccount mailAccount, boolean useGlobalSession, Collection<String> tos,
