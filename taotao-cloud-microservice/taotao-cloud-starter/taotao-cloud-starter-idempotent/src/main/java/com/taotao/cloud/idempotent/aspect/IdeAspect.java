//package com.taotao.cloud.idempotent.aspect;
//
...
//
//			//1.判断模式
//			if (idempotent.ideTypeEnum() == IdeTypeEnum.ALL || idempotent.ideTypeEnum() == IdeTypeEnum.RID) {
...
//			}
//
//			if (idempotent.ideTypeEnum() == IdeTypeEnum.ALL
//				|| idempotent.ideTypeEnum() == IdeTypeEnum.KEY) {
...
//
//				if (idempotent.ideTypeEnum() == IdeTypeEnum.ALL
//					|| idempotent.ideTypeEnum() == IdeTypeEnum.RID) {
//					ServletRequestAttributes attributes = (ServletRequestAttributes) RequestContextHolder
//						.getRequestAttributes();
//					HttpServletRequest request = attributes.getRequest();
//					String rid = request.getHeader(HEADER_RID_KEY);
