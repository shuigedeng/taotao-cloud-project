...
import com.taotao.cloud.web.exception.handler.DefaultGlobalExceptionHandler;
import com.taotao.cloud.web.exception.handler.MailGlobalExceptionHandler;
import com.taotao.cloud.web.exception.handler.MultiGlobalExceptionHandler;
import com.taotao.cloud.web.exception.resolver.SecurityHandlerExceptionResolver;
...
public class ExceptionAutoConfiguration {
	...
	public GlobalExceptionHandler multiGlobalExceptionHandler(ExceptionHandleProperties properties,
		...
		if (properties.getType() != null) {
			...
			//		return new DefaultGlobalExceptionHandler();
			//	case MAIL:
			//		return new MailGlobalExceptionHandler(properties,
			//			context.getBean(MailSender.class),
			//			context.getApplicationName());
			//	default:
			//		return new DingTalkGlobalExceptionHandler(properties,
			//			context.getBean(DingTalkSender.class),
			//			context.getApplicationName());
			//}
		}
		// 为空 或者 为 false
		...
		return new MultiGlobalExceptionHandler(properties, context.getApplicationName(),
			mailSender);
	}
	...
	//public GlobalExceptionHandler dingTalkGlobalExceptionHandler(
	//	ExceptionHandleProperties exceptionHandleProperties,
	//	ApplicationContext context) {
	//	return new DingTalkGlobalExceptionHandler(exceptionHandleProperties,
	//		context.getBean(DingTalkSender.class),
	//		applicationName);
	//}
	...
	public GlobalExceptionHandler mailGlobalExceptionHandler(
		ExceptionHandleProperties exceptionHandleProperties,
		ApplicationContext context) {
		return new MailGlobalExceptionHandler(exceptionHandleProperties,
			context.getBean(MailSender.class),
			applicationName);
	}
