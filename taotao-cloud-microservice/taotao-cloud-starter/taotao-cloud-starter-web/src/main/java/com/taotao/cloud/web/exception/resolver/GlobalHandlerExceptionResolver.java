...
public class GlobalHandlerExceptionResolver {
	...
	//	String errorMessage =
	//		GlobalConstants.ENV_PROD.equals(profile) ? PROD_ERR_MSG : e.getLocalizedMessage();
	...
	//	String errorMsg = bindingResult.getErrorCount() > 0 ? bindingResult.getAllErrors().get(0)
	//		.getDefaultMessage()
	//		: "未获取到错误信息!";
	//
