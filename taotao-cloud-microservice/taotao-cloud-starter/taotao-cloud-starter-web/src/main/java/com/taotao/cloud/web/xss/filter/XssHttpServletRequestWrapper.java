 ...
 *  Xss 请求参数包装器
 * <p>
 * Content-Type	传参方式	接收方式 application/x-www-form-urlencoded	表单key-value	HttpServletRequest
 * Parameters 获取 multipart/form-data	表单key-value	HttpServletRequest Parameters 获取
