...
import com.taotao.cloud.pay.alipay.ali.constants.AliPayConstant;
import com.taotao.cloud.pay.alipay.ali.domain.AliPayQuery;
...
public class AliPay {
	...
	public AliPay(String serverUrl, String appId, String privateKey, String alipayPublicKey,
		String signType) {
	...
	public AliPay(String serverUrl, String appId, String privateKey, String format, String charset,
		...
		this.client = new DefaultAlipayClient(serverUrl, appId, privateKey, format, charset,
	 ...
	 * 手机网站支付-复杂支付
	 */
	public AlipayTradeWapPayResponse mobileWapPay(AlipayTradePayModel model)
		throws AlipayApiException {
		return mobileWapPay(model, returnUrl, notifyUrl);
	}
	 ...
	 * 手机网站支付-复杂支付
	 */
	public AlipayTradeWapPayResponse mobileWapPay(AlipayTradePayModel model, String returnUrl,
		String notifyUrl)
		throws AlipayApiException {
	 ...
	 * 电脑网站支付-复杂支付
	 */
	public AlipayTradePagePayResponse computerWapPay(AlipayTradePayModel model)
		throws AlipayApiException {
		return computerWapPay(model, returnUrl, notifyUrl);
	}
	 ...
	 * 电脑网站支付-复杂支付
	 */
	public AlipayTradePagePayResponse computerWapPay(AlipayTradePayModel model, String returnUrl,
		String notifyUrl)
		throws AlipayApiException {
	 ...
	 * @return com.alipay.api.response.AlipayTradeWapPayResponse
	 */
	public AlipayTradeAppPayResponse appPay(String sn, BigDecimal amount, String subject)
		throws AlipayApiException {
	 ...
	 * APP支付-复杂支付
	 */
	public AlipayTradeAppPayResponse appPay(AlipayTradePayModel model, String notifyUrl)
		throws AlipayApiException {
	 ...
	 * 付款码支付-复杂支付
	 */
	public AlipayTradePayResponse codePay(AlipayTradePayModel model, String notifyUrl)
		throws AlipayApiException {
	 ...
	 */
	public AlipayTradePrecreateResponse qrPay(String sn, BigDecimal amount, String subject)
		throws AlipayApiException {
	 ...
	 * 二维码付款-复杂支付
	 */
	public AlipayTradePrecreateResponse qrPay(AlipayTradePrecreateModel model)
		throws AlipayApiException {
		return qrPay(model, notifyUrl);
	}
	 ...
	 * @return com.alipay.api.response.AlipayTradeQueryResponse
	 */
	public AlipayTradeRefundResponse refund(String sn, BigDecimal amount)
		throws AlipayApiException {
	 ...
	 * @return com.alipay.api.response.AlipayTradeQueryResponse
	 */
	public AlipayTradeRefundResponse refund(String sn, String tradeNo, BigDecimal amount)
		throws AlipayApiException {
