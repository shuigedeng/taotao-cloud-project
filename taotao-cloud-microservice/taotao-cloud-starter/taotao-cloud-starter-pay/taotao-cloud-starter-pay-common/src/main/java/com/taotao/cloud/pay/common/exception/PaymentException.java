...
public class PaymentException extends BaseException {
	...
	public PaymentException(Integer code, String message, Throwable e) {
		super(code, message, e);
	}

	public PaymentException(ResultEnum result) {
		super(result);
	}

	public PaymentException(ResultEnum result, Throwable e) {
		super(result, e);
	}
}
