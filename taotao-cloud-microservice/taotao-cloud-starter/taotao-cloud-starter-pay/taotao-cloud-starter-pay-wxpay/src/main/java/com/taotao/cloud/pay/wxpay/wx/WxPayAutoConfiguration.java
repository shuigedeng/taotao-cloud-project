...
public class WxPayAutoConfiguration {
	...
	public WxPay wxPay(WxPayProperties properties) {
		// 获取配置
		WxPayProperties.Config config =
			properties.isSandbox() ? properties.getDev() : properties.getProd();

		WxPay wxPay = new WxPay(config.getAppId(), config.getMchId(), config.getMckKey(),
