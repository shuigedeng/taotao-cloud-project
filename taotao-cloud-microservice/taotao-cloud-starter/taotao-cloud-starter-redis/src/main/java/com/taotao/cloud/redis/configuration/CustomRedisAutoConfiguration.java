 ...
 */
@Configuration
public class CustomRedisAutoConfiguration implements InitializingBean {

	private final RedissonClient redissonClient;

	public CustomRedisAutoConfiguration(RedissonClient redissonClient) {
		this.redissonClient = redissonClient;
	}

	@Override
	public void afterPropertiesSet() throws Exception {
		LogUtil.started(CustomRedisAutoConfiguration.class, StarterNameConstant.REDIS_STARTER);
	}
