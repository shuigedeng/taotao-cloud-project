...
public interface NamedHandlerList<T extends DisruptorEvent> extends List<DisruptorHandler<T>> {
	...
	/**
	 * Returns a new {@code HandlerChain<T>} instance that will first execute this list's {@code
	 * Handler}s (in list order) and end with the execution of the given {@code handlerChain}
	 * instance.
	 *
