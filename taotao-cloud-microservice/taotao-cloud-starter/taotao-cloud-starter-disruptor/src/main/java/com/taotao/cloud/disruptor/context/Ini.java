...
public class Ini implements Map<String, Ini.Section> {
	...
	/**
	 * Returns {@code true} if no sections have been configured, or if there are sections, but the
	 * sections themselves are all empty, {@code false} otherwise.
	 *
	 * @return {@code true} if no sections have been configured, or if there are sections, but the
	 * sections themselves are all empty, {@code false} otherwise.
	 */
	...
	/**
	 * Returns the names of all sections managed by this {@code Ini} instance or an empty collection
	 * if there are no sections.
	 *
	 * @return the names of all sections managed by this {@code Ini} instance or an empty collection
	 * if there are no sections.
	 */
	...
	/**
	 * Returns the {@link Section} with the given name or {@code null} if no section with that name
	 * exists.
	 *
	 * @param sectionName the name of the section to retrieve.
	 * @return the {@link Section} with the given name or {@code null} if no section with that name
	 * exists.
	 */
	 ...
	 * @return the section created if it did not yet exist, or the existing Section that already
	 * existed.
	 */
	...
	/**
	 * Removes the section with the specified name and returns it, or {@code null} if the section
	 * did not exist.
	 *
	...
	/**
	 * Sets a name/value pair for the section with the given {@code sectionName}.  If the section
	 * does not yet exist, it will be created.  If the {@code sectionName} is null or empty, the
	 * name/value pair will be placed in the default (unnamed, empty string) section.
	 *
	...
	/**
	 * Returns the value of the specified section property, or {@code null} if the section or
	 ...
	 * @return the value of the specified section property, or {@code null} if the section or
	 * property do not exist.
	 */
	...
	/**
	 * Returns the value of the specified section property, or the {@code defaultValue} if the
	 * section or property do not exist.
	 *
	 * @param sectionName  the name of the section to add the name/value pair
	 * @param propertyName the name of the property to add
	 * @param defaultValue the default value to return if the section or property do not exist.
	 * @return the value of the specified section property, or the {@code defaultValue} if the
	 * section or property do not exist.
	 */
	...
	/**
	 * Loads the INI-formatted text backed by the given InputStream into this instance.  This
	 * implementation will close the input stream after it has finished loading.  It is expected
	 * that the stream's contents are UTF-8 encoded.
	 *
	...
	/**
	 * Loads the INI-formatted text backed by the given Reader into this instance.  This
	 * implementation will close the reader after it has finished loading.
	 *
	...
	/**
	 * An {@code Ini.Section} is String-key-to-String-value Map, identifiable by a {@link #getName()
	 * name} unique within an {@link Ini} instance.
	 */
		...
		protected static String[] splitKeyValue(String keyValueLine) {
			...
			for (int i = 0; i < line.length(); i++) {
				...
				if (buildingKey) {
					...
					if (valueBuffer.length() == 0 && isKeyValueSeparatorChar(c) && !isCharEscaped(
						line, i)) {
