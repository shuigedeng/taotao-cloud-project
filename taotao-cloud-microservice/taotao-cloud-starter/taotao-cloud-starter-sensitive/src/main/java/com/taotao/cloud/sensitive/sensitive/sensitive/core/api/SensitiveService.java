package com.taotao.cloud.sensitive.sensitive.sensitive.core.api;
...
import com.taotao.cloud.sensitive.sensitive.sensitive.core.api.context.SensitiveContext;
import com.taotao.cloud.sensitive.sensitive.sensitive.core.exception.SensitiveRuntimeException;
import com.taotao.cloud.sensitive.sensitive.sensitive.core.util.entry.SensitiveEntryUtil;
import com.taotao.cloud.sensitive.sensitive.sensitive.core.util.strategy.SensitiveStrategyBuiltInUtil;
						...
						if (CollectionUtils.isNotEmpty(entryCollection)) {
							...
							if (needHandleEntryType(collectionEntryClass)) {
								for (Object collectionEntry : entryCollection) {
									handleClassField(context, collectionEntry,
