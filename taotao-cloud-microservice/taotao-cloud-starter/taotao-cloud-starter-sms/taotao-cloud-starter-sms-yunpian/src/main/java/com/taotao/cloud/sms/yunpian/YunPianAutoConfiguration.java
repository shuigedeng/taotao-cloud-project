...
@ConditionalOnProperty(prefix = SmsProperties.PREFIX, name = "type", havingValue = "YUNPIAN")
@EnableConfigurationProperties(YunPianProperties.class)
public class YunPianAutoConfiguration implements InitializingBean {

	@Override
	public void afterPropertiesSet() throws Exception {
		LogUtils.started(YunPianAutoConfiguration.class, StarterName.SMS_YUNPIAN_STARTER);
	}
