...
@ConditionalOnProperty(prefix = SmsProperties.PREFIX, name = "type", havingValue = "CHINAMOBILE")
@EnableConfigurationProperties(ChinaMobileProperties.class)
public class ChinaMobileAutoConfiguration implements InitializingBean {

	@Override
	public void afterPropertiesSet() throws Exception {
		LogUtils.started(ChinaMobileAutoConfiguration.class, StarterName.SMS_CHINAMOBILE_STARTER);
	}
