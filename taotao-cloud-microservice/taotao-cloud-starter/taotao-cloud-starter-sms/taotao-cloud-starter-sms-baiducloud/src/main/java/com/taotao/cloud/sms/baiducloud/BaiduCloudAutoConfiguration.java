...
public class BaiduCloudAutoConfiguration implements InitializingBean {

	@Override
	public void afterPropertiesSet() throws Exception {
		LogUtils.started(BaiduCloudAutoConfiguration.class, StarterName.SMS_BAIDUCLOUD_STARTER);
	}
