 ...
 * //作用就是在被加锁的节点挂了时，无法释放锁，造成其他节点无法进行下一任务 //这里默认55s //关于ISO8601
 * Duration格式用的不到，具体可上网查询下相关资料，应该就是一套规范，规定一些时间表达方式
 **/
@AutoConfiguration
@EnableSchedulerLock(defaultLockAtMostFor = "PT55S")
public class ShedLockRedisAutoConfiguration implements InitializingBean {

	@Override
	public void afterPropertiesSet() throws Exception {
		LogUtils.started(ShedLockRedisAutoConfiguration.class, StarterName.JOB_SCHEDULE_STARTER);
	}
