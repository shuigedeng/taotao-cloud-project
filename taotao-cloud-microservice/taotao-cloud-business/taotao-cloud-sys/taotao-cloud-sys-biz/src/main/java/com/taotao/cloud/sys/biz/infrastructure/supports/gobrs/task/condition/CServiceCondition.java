...
package com.taotao.cloud.sys.biz.infrastructure.supports.gobrs.task.condition;
...
import com.taotao.cloud.sys.biz.supports.gobrs.task.condition.AServiceCondition;
...
public class CServiceCondition extends AsyncTask<String, AnyConditionResult<String>> {
    ...
    public AnyConditionResult<String> task(String o, TaskSupport support) {
        ...
        /** 获取 所依赖的父任务的结果 */
        String result = getResult(support, com.taotao.cloud.sys.biz.supports.gobrs.task.condition.AServiceCondition.class, String.class);
