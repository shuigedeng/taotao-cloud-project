...
package com.taotao.cloud.sys.biz.infrastructure.supports.gobrs.task;
...
import com.taotao.cloud.sys.biz.supports.gobrs.task.AService;
...
public class CService extends AsyncTask<String, Integer> {
    ...
    public Integer task(String o, TaskSupport support) {
        try {
            ...
            String result = getResult(support, com.taotao.cloud.sys.biz.supports.gobrs.task.AService.class, String.class);
