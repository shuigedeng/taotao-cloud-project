package com.taotao.cloud.sys.biz.infrastructure.supports.mbg;

import static com.taotao.cloud.sys.biz.supports.mbg.AppDynamicSqlSupport.*;
import static org.mybatis.dynamic.sql.SqlBuilder.isEqualTo;

import com.taotao.cloud.sys.biz.supports.mbg.App;
...
public interface AppMapper extends CommonSelectMapper, CommonCountMapper, CommonDeleteMapper, CommonUpdateMapper {
    ...
    int insert(InsertStatementProvider<com.taotao.cloud.sys.biz.supports.mbg.App> insertStatement);

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    @InsertProvider(type=SqlProviderAdapter.class, method="insertMultipleWithGeneratedKeys")
    @Options(useGeneratedKeys=true,keyProperty="records.id")
    int insertMultiple(@Param("insertStatement") String insertStatement, @Param("records") List<com.taotao.cloud.sys.biz.supports.mbg.App> records);
    ...
    List<com.taotao.cloud.sys.biz.supports.mbg.App> selectMany(SelectStatementProvider selectStatement);

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("AppResult")
    Optional<com.taotao.cloud.sys.biz.supports.mbg.App> selectOne(SelectStatementProvider selectStatement);
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insert( com.taotao.cloud.sys.biz.supports.mbg.App row) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insertMultiple(Collection<com.taotao.cloud.sys.biz.supports.mbg.App> records) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insertSelective( com.taotao.cloud.sys.biz.supports.mbg.App row) {
        return MyBatis3Utils.insert(this::insert, row, app, c ->
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default Optional<com.taotao.cloud.sys.biz.supports.mbg.App> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, app, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default List<com.taotao.cloud.sys.biz.supports.mbg.App> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, app, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default List<com.taotao.cloud.sys.biz.supports.mbg.App> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, app, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default Optional<com.taotao.cloud.sys.biz.supports.mbg.App> selectByPrimaryKey(Long id_) {
        return selectOne(c ->
            c.where(id, isEqualTo(id_))
        );
    }
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    static UpdateDSL<UpdateModel> updateAllColumns( com.taotao.cloud.sys.biz.supports.mbg.App row, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    static UpdateDSL<UpdateModel> updateSelectiveColumns( com.taotao.cloud.sys.biz.supports.mbg.App row, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int updateByPrimaryKey( com.taotao.cloud.sys.biz.supports.mbg.App row) {
        return update(c ->
