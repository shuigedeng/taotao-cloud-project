...
package com.taotao.cloud.sys.biz.infrastructure.supports.gobrs.task.interrupt;
...
import com.taotao.cloud.sys.biz.supports.gobrs.task.interrupt.InterruptTaskA;
...
public class InterruptTaskC extends AsyncTask<String, Integer> {
    ...
    public Integer task(String o, TaskSupport support) {
        try {
            ...
            String result = getResult(support, com.taotao.cloud.sys.biz.supports.gobrs.task.interrupt.InterruptTaskA.class, String.class);
