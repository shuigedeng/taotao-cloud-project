...
package com.taotao.cloud.sys.biz.infrastructure.supports.aggregate;
...
import com.taotao.cloud.sys.biz.supports.aggregate.Address;
import com.taotao.cloud.sys.biz.supports.aggregate.AddressCondition;
import com.taotao.cloud.sys.biz.supports.aggregate.AddressFuzzyQueries;
import com.taotao.cloud.sys.biz.supports.aggregate.AddressQueries;
...
public class AggregateTestController {
     ...
     */
    @PostMapping("/get")
    public Result<List<com.taotao.cloud.sys.biz.supports.aggregate.Address>> get(
        ...
        QueryWrapper<com.taotao.cloud.sys.biz.supports.aggregate.Address> wrapper = AggregateQueries.splicingAggregateQueries(new QueryWrapper<>(), aggregate);
