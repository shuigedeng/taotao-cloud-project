package com.taotao.cloud.sys.biz.file.src.test.java.com.taotao.cloud.file.biz.milliondataexport.mybatis;
...
public class AuthorsService {
	...
	public void streamDownload(HttpServletResponse httpServletResponse)
		...
		MybatisTest.CustomResultHandler customResultHandler = new MybatisTest.CustomResultHandler(new MybatisTest.DownloadProcessor(httpServletResponse));
