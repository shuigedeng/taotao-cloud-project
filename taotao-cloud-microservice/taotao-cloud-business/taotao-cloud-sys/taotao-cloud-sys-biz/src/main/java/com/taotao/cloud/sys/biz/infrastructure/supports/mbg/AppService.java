...
import com.taotao.cloud.sys.biz.supports.mbg.AppMapper;
...
public class AppService {
    ...
    public List<com.taotao.cloud.sys.biz.supports.mbg.App> getSysUserList( String account1 ) {
    ...
    public boolean insert( String account, String name ) {
        com.taotao.cloud.sys.biz.supports.mbg.App sysUser = new App();
