...
import com.taotao.cloud.sys.api.inner.response.setting.GoodsSettingApiResponse;
import com.taotao.cloud.sys.api.inner.response.setting.OrderSettingApiResponse;
import com.taotao.cloud.sys.api.inner.response.setting.PointSettingApiResponse;
import com.taotao.cloud.sys.api.inner.response.setting.QQConnectSettingApiResponse;
import com.taotao.cloud.sys.api.inner.response.setting.SeckillSettingApiResponse;
import com.taotao.cloud.sys.api.inner.response.setting.SettingApiResponse;
import com.taotao.cloud.sys.api.inner.response.setting.WechatConnectSettingApiResponse;
import com.taotao.cloud.sys.api.inner.response.setting.WechatPaymentSettingApiResponse;
