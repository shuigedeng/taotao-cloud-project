...
@org.springframework.data.relational.core.mapping.Table(name = OrderItemBack.TABLE_NAME, comment = "订单明细表")
public class OrderItemBack extends BasePO<OrderItemBack> {
