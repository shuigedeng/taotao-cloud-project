package com.taotao.cloud.order.biz.application.statemachine.cola.order.service;

import com.alibaba.cola.statemachine.Action;
import com.alibaba.cola.statemachine.Condition;
import com.alibaba.cola.statemachine.StateMachine;
import com.alibaba.cola.statemachine.StateMachineFactory;
import com.taotao.cloud.order.biz.application.statemachine.cola.order.repository.OrderRepository;
import com.taotao.cloud.order.biz.statemachine.cola.config.StateMachineRegister;
import com.taotao.cloud.order.biz.statemachine.cola.entity.Order;
import com.taotao.cloud.order.biz.statemachine.cola.enums.OrderEvent;
import com.taotao.cloud.order.biz.statemachine.cola.enums.OrderStatus;
...
public class OrderService {
    ...
    public void save( Order order ) {
        StateMachine<OrderStatus, OrderEvent, Order> stateMachine = StateMachineFactory.get(
                StateMachineRegister.STATE_MACHINE_ID);
        // 触发状态机
