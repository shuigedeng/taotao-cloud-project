...
@org.springframework.data.relational.core.mapping.Table(name = OrderComplaint.TABLE_NAME, comment = "订单交易投诉表")
public class OrderComplaint extends BasePO<OrderComplaint> {
