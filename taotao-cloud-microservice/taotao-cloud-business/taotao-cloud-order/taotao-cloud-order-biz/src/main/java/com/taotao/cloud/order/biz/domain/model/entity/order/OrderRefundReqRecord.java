...
@org.springframework.data.relational.core.mapping.Table(name = OrderRefundReqRecord.TABLE_NAME, comment = "售后退款操作记录表")
public class OrderRefundReqRecord extends BasePO<OrderRefundReqRecord> {
