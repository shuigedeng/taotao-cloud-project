...
public class OrderServiceImpl extends ServiceImpl<IOrderMapper, Order> implements IOrderService {
                        ...
                        item -> {
                            ...
                            item.getCheckedSkuList()
                                    .forEach(
                                            sku ->
                                                    orderItems.add(
                                                            new OrderItem(sku, item, tradeDTO)));
                            // 写入子订单信息
    ...
    public List<Order> queryListByPromotion(
        ...
        queryWrapper
                ...
                .and(
                        i ->
                                i.eq(Order::getParentOrderSn, parentOrderSn)
    ...
    public List<Order> queryListByPromotion(Long pintuanId) {
        ...
        queryWrapper.nested(
                i ->
                        i.eq(Order::getPayStatus, PayStatusEnum.PAID.name())
                                .or()
    ...
    public void payOrder(String orderSn, String paymentMethod, String receivableNo) {
        ...
        order.setCanReturn(
                !PaymentMethodEnum.BANK_TRANSFER.name().equals(order.getPaymentMethod()));
        this.updateById(order);
    ...
    @Override
    @OrderLogPoint(
            description = "'订单['+#orderSn+']发货，发货单号['+#logisticsNo+']'",
            orderSn = "#orderSn")
    ...
    @Override
    @OrderLogPoint(
            description = "'订单['+#orderSn+']核销，核销码['+#verificationCode+']'",
            orderSn = "#orderSn")
    ...
    @Override
    public IPage<PaymentLogVO> queryPaymentLogs(
            ...
            TimeTriggerMsg timeTriggerMsg =
                    new TimeTriggerMsg(
                            ...
                            DelayQueueTools.wrapperUniqueKey(
                                    DelayTypeEnums.PINTUAN_ORDER, (pintuanId + parentOrderSn)),
    ...
    private List<Order> getPintuanOrder(Long pintuanId, String parentOrderSn) {
        ...
        queryWrapper.and(
                i ->
                        i.eq(Order::getSn, parentOrderSn)
