...
package com.taotao.cloud.order.biz.domain.domain.model.vo.cart;
...
public record CartVO(
        @Schema(description = "购物车中的产品列表") List<CartSkuVO> skuList,
        @Schema(description = "sn") String sn,
        @Schema(description = "购物车页展示时，店铺内的商品是否全选状态.1为店铺商品全选状态,0位非全选") Boolean checked,
        @Schema(description = "满优惠活动") FullDiscountVO fullDiscount,
