...
@org.springframework.data.relational.core.mapping.Table(name = PurchaseOrderItemPO.TABLE_NAME, comment = "采购单子内容表")
public class PurchaseOrderItemPO extends BaseSuperEntity<PurchaseOrderItemPO, Long> {
    ...
    public boolean equals(Object o) {
        ...
        PurchaseOrderItemPO purchaseOrderItemPO = (PurchaseOrderItemPO) o;
        return getId() != null && Objects.equals(getId(), purchaseOrderItemPO.getId());
    }
