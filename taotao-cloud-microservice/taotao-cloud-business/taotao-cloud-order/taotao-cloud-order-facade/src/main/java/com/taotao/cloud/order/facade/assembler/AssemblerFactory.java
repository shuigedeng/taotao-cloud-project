...
import com.taotao.cloud.order.adapter.assembler.Assembler;
...
public class AssemblerFactory {
     ...
     * @param target    T对象
     */
    public <S, T> void assemble(com.taotao.cloud.order.adapter.assembler.Assembler<S, T> assembler, S source, T target) {
