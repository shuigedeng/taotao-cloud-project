...
public record OrderComplaintCO(
        @Schema(description = "投诉对话") List<OrderComplaintCommunicationCO> orderComplaintCommunications,
        @Schema(description = "投诉图片") String[] orderComplaintImages,
        @Schema(description = "申诉商家上传的图片") String[] appealImagesList,
        OrderComplaintBaseCO orderComplaintBase)
