package com.taotao.cloud.job.biz.powerjob.mr;
...
public class StaticSliceProcessor implements MapReduceProcessor {
	...
	public ProcessResult process(TaskContext context) throws Exception {
		...
		if (isRootTask()) {
			...
			Map<String, String> paramsMap = Splitter.on("&").withKeyValueSeparator("=")
				.split(jobParams);
		...
		if (subTask instanceof SubTask) {
			...
			return new ProcessResult(true,
				"subTask:" + ((SubTask) subTask).getIndex() + " process successfully");
		}
