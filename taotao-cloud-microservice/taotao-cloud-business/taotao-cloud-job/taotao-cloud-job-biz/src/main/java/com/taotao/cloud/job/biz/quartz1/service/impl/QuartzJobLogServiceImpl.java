...
import com.taotao.cloud.job.biz.quartz1.dao.QuartzJobLogMapper;
...
import com.taotao.cloud.job.biz.quartz1.service.QuartzJobLogService;
...
public class QuartzJobLogServiceImpl implements QuartzJobLogService {
	...
	public PageResult<QuartzJobLogVO> page(QuartzJobLogQuery quartzJobLogQuery) {
		...
		wrapper
			...
			.eq(Objects.nonNull(quartzJobLogQuery.getSuccess()), QuartzJobLogEntity::getSuccess,
