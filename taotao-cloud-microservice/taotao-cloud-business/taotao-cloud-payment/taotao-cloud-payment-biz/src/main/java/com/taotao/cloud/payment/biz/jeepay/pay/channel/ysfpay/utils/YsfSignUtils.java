...
package com.taotao.cloud.payment.biz.jeepay.pay.channel.ysfpay.utils;
...
public class YsfSignUtils {
    ...
    /**
     * 签名 注意事项： 签名需商户申请 5.1.0版本证书； 文档：
     * https://open.unionpay.com/tjweb/acproduct/list?apiSvcId=468&index=2 1. 排序并拼接为[key=value]格式；
     * 2. 对原始签名串使用SHA-256算法做摘要 3. 使用商户私钥做签名（使用 SHA-256） 4. 进行Base64处理 *
     */
