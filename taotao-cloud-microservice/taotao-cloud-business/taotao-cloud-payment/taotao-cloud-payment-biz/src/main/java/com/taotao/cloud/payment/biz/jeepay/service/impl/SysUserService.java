...
import com.taotao.cloud.payment.biz.jeepay.service.mapper.SysUserMapper;
...
public class SysUserService extends ServiceImpl<SysUserMapper, SysUser> {
    ...
    public void addSysUser(SysUser sysUser, String sysType) {
        ...
        sysUserAuthService.addUserAuthDefault(
                sysUserId, sysUser.getLoginUsername(), sysUser.getTelphone(), authPwd, sysType);
