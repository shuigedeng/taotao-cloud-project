...
public class MchPayPassageConfigController extends CommonCtrl {
    ...
    /**
     * @Author: ZhuXiao @Description: 根据appId、支付方式查询可用的支付接口列表 @Date: 11:05 2021/5/13
     */
    ...
    /**
     * @Author: ZhuXiao @Description: @Date: 11:05 2021/5/13
     */
    @GetMapping("/{id}")
    ...
    /**
     * @Author: ZhuXiao @Description: 应用支付通道配置 @Date: 11:05 2021/5/13
     */
