...
public class DateKit {
    ...
    /**
     * 获取自定义查询时间 today|0 -- 今天 yesterday|0 -- 昨天 near2now|7 -- 近xx天， 到今天 near2yesterday|30 -- 近xx天，
     * 到昨天 customDate|2020-01-01,N -- 自定义日期格式 N表示为空， 占位使用 customDateTime|2020-01-01
     * 23:00:00,2020-01-01 23:00:00 -- 自定义日期时间格式
     *
     * @return
     */
