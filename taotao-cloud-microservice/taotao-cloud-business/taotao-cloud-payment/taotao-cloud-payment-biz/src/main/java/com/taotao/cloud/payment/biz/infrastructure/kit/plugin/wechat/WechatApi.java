...
import com.taotao.cloud.payment.biz.infrastructure.kit.core.kit.HttpKit;
import com.taotao.cloud.payment.biz.infrastructure.kit.core.kit.PayKit;
import com.taotao.cloud.payment.biz.infrastructure.kit.core.kit.WxPayKit;
...
public class WechatApi {
     ...
     * 发起请求
     *
     * @param apiUrl 接口 URL 通过 {@link WechatApi#getReqUrl(WechatApiEnum)} 或者 {@link
     *     WechatApi#getReqUrl(WechatApiEnum, WechatDomain, boolean)} 来获取
     * @param params 接口请求参数
     ...
     */
    public static PaymentHttpResponse v3(
     ...
     */
    @Deprecated
    public static Map<String, Object> v3Execution(
            RequestMethodEnums method,
            String urlPrefix,
            String urlSuffix,
            String mchId,
    ...
    public static PaymentHttpResponse get(
            String url, String authorization, String serialNumber, Map<String, Object> params) {
    ...
    public static PaymentHttpResponse upload(
            String url, String authorization, String serialNumber, String data, File file) {
