    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            FacePayAuthInfoBiz facePayAuthInfo =
                    WxPay.getFacePayAuthInfo(
                            mchId, "门店ID", "门店名称", "刷脸支付信息", "设备ID", null, null, key);
            ...
            RefundOrder refundOrder =
                    WxPay.orderRefund("1556267522899", mchId, "0.1", null, "退款描述", null, key);
            ...
            WxDownloadBillBiz downloadBillBiz =
                    WxPay.downloadBill(mchId, "2020-01-29", null, null, key);
