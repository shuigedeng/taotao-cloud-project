...
import com.taotao.cloud.payment.biz.jeepay.service.mapper.TransferOrderMapper;
...
public class TransferOrderService extends ServiceImpl<TransferOrderMapper, TransferOrder> {
    ...
    public boolean updateInit2Ing(String transferId) {
        ...
        return update(
                updateRecord,
                new LambdaUpdateWrapper<TransferOrder>()
                        .eq(TransferOrder::getTransferId, transferId)
                        .eq(TransferOrder::getState, TransferOrder.STATE_INIT));
    }
    ...
    public boolean updateIng2Success(String transferId, String channelOrderNo) {
        ...
        if (!update(
                ...
                new LambdaUpdateWrapper<TransferOrder>()
                        .eq(TransferOrder::getTransferId, transferId)
                        .eq(TransferOrder::getState, TransferOrder.STATE_ING))) {
            return false;
        }
    ...
    public boolean updateIng2Fail(
            String transferId, String channelOrderNo, String channelErrCode, String channelErrMsg) {
