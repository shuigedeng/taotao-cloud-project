...
public class YsfpayPaymentService extends AbstractPaymentService {
    ...
    public JSONObject packageParamAndReq(
            String apiUri, JSONObject reqParams, String logPrefix, MchAppConfigContext mchAppConfigContext)
            throws Exception {
        ...
        YsfpayIsvsubMchParams isvsubMchParams = (YsfpayIsvsubMchParams) configContextQueryService.queryIsvsubMchParams(
    ...
    public static void ysfPublicParams(JSONObject reqParams, PayOrder payOrder) {
        ...
        reqParams.put(
                "orderTime", DateUtil.format(new Date(), DatePattern.PURE_DATETIME_PATTERN)); // 订单时间 如：20180702142900
