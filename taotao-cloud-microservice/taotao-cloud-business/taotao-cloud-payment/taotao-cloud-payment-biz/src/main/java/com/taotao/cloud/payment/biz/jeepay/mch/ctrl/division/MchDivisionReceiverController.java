...
import com.taotao.cloud.payment.biz.jeepay.jeepay.model.DivisionReceiverBindReqModel;
import com.taotao.cloud.payment.biz.jeepay.jeepay.request.DivisionReceiverBindRequest;
...
public class MchDivisionReceiverController extends CommonCtrl {
    ...
    public ApiRes add() {
        ...
        if (mchApp == null
                || mchApp.getState() != CS.PUB_USABLE
                || !mchApp.getMchNo().equals(getCurrentMchNo())) {
