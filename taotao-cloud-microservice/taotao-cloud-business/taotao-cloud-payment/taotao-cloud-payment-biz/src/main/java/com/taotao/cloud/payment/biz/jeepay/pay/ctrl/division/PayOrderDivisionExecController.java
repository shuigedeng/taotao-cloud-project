...
package com.taotao.cloud.payment.biz.jeepay.pay.ctrl.division;
...
import com.taotao.cloud.payment.biz.jeepay.pay.rqrs.division.PayOrderDivisionExecRQ;
import com.taotao.cloud.payment.biz.jeepay.pay.rqrs.division.PayOrderDivisionExecRS;
    ...
    public ApiRes exec() {
        ...
        try {
            ...
            if (payOrder.getState() != PayOrder.STATE_SUCCESS
                    ...
                    || payOrder.getDivisionMode() != PayOrder.DIVISION_MODE_MANUAL) {
            ...
            bizRS.setState(
                    channelRetMsg.getChannelState() == ChannelRetMsg.ChannelState.CONFIRM_SUCCESS
            ...
            if (receiver.getDivisionProfit() != null) {
                ...
                if (receiver.getDivisionProfit().compareTo(BigDecimal.ZERO) < 0) {
                    throw new BizException(
                            "分账用户receiverId=[" + receiver.getReceiverId() == null
                                    ? ""
                                    : receiver.getReceiverId()
                                                            + "],"
                                                            + "receiverGroupId=["
                                                            + receiver.getReceiverGroupId()
                                                    == null
                                            ? ""
                                            : receiver.getReceiverGroupId() + "] 分账比例不得小于0%");
                }
                    ...
                    throw new BizException(
                            "分账用户receiverId=[" + receiver.getReceiverId() == null
                                    ...
                                    : receiver.getReceiverId()
                                                    ...
                                                    == null
                                            ? ""
                                            : receiver.getReceiverGroupId() + "] 分账比例不得高于100%");
                }
            }
        }
