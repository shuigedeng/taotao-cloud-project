...
import com.taotao.cloud.payment.biz.jeepay.core.model.params.IsvsubMchParams;
...
import com.taotao.cloud.payment.biz.jeepay.pay.model.IsvConfigContext;
import com.taotao.cloud.payment.biz.jeepay.pay.model.MchAppConfigContext;
import com.taotao.cloud.payment.biz.jeepay.pay.model.MchInfoConfigContext;
...
import com.taotao.cloud.payment.biz.jeepay.service.impl.IsvInfoService;
...
public class ConfigContextService {
    ...
    public synchronized void initIsvConfigContext(String isvNo) {
        ...
        mchInfoService
                .list(MchInfo.gw().select(MchInfo::getMchNo).eq(MchInfo::getIsvNo, isvNo))
        ...
        if (!mchNoList.isEmpty()) {
            mchAppService
                    .list(MchApp.gw().select(MchApp::getAppId).in(MchApp::getMchNo, mchNoList))
