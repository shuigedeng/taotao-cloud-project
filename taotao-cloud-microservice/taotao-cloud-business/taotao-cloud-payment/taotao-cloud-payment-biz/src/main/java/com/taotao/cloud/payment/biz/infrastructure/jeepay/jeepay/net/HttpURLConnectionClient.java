...
import com.taotao.cloud.payment.biz.infrastructure.jeepay.jeepay.exception.APIConnectionException;
import com.taotao.cloud.payment.biz.infrastructure.jeepay.jeepay.util.StreamUtils;
...
public class HttpURLConnectionClient extends HttpClient {
    ...
    @Override
    public APIJeepayResponse request(
            APIJeepayRequest request) throws APIConnectionException {
