...
/**
 * @Author: ZhuXiao @Description: @Date: 15:22 2021/5/26
 */
@Slf4j
public class WxpayV3Util {
    ...
    public static JSONObject unifiedOrderV3(
            String reqUrl, JSONObject reqJSON, WxPayService wxPayService) throws WxPayException {
    ...
    public static String getPayInfo(String response, WxPayConfig wxPayConfig)
        ...
        try {
            ...
            throw (e instanceof WxPayException)
                    ? (WxPayException) e
                    : new WxPayException(e.getMessage(), e);
        }
    }
