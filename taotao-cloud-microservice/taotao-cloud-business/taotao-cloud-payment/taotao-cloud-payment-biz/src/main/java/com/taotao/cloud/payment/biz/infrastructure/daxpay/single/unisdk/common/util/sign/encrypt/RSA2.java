...
package com.taotao.cloud.payment.biz.infrastructure.daxpay.single.unisdk.common.util.sign.encrypt;
...
public class RSA2 {
    ...
    public static String encrypt(String content, String publicKey, String cipherAlgorithm, String characterEncoding) throws GeneralSecurityException, IOException {
        return Base64.encode(
                RSA.encrypt(content.getBytes(characterEncoding), RSA.getPublicKey(publicKey), 2048, 11, cipherAlgorithm));
    }
}
