...
/**
 * 将spring容器的 [bean注册器]放置到属性中，为 RabbitConfig提供访问。 顺序： 1. postProcessBeanDefinitionRegistry (存放注册器)
 * 2. postProcessBeanFactory （没有使用） 3. 注册延迟消息交换机的bean: delayedExchange 4. 动态配置RabbitMQ所需的bean。
 *
 * @author terrfly
