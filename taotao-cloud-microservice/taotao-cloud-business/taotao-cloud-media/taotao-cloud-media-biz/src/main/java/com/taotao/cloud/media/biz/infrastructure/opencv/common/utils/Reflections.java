...
package com.taotao.cloud.media.biz.infrastructure.opencv.common.utils;
...
/**
 * 反射工具类. 提供调用getter/setter方法, 访问私有变量, 调用私有方法, 获取泛型类型Class, 被AOP过的真实类等工具函数. 创建者 张志朋 创建时间 2016年8月1日
 */
