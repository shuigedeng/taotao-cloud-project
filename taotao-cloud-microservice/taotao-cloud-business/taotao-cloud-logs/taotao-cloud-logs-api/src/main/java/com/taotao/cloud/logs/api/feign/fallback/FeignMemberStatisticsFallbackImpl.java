package com.taotao.cloud.logs.api.feign.fallback;

import com.taotao.cloud.logs.api.feign.IFeignMemberStatisticsApi;
import com.taotao.cloud.logs.api.model.dto.MemberStatisticsDTO;
import com.taotao.cloud.logs.api.model.vo.MemberStatisticsVO;
 ...
 */
public class FeignMemberStatisticsFallbackImpl implements
	FallbackFactory<IFeignMemberStatisticsApi> {
