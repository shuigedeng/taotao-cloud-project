...
@org.springframework.data.relational.core.mapping.Table(name = DistributionGoods.TABLE_NAME, comment = "分销商品表")
public class DistributionGoods extends BasePO<DistributionGoods> {
