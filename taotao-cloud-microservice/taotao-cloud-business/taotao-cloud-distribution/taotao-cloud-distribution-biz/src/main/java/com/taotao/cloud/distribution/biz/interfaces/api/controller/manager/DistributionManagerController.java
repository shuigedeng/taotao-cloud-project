...
package com.taotao.cloud.distribution.biz.interfaces.api.controller.manager;
...
public class DistributionManagerController {
    ...
    public Result<Void> retreat(@Parameter(description = "分销商id") @PathVariable String id) {
