...
@org.springframework.data.relational.core.mapping.Table(name = DistributionOrder.TABLE_NAME, comment = "分销订单表")
public class DistributionOrder extends BasePO<DistributionOrder> {
