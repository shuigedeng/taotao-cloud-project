...
package com.taotao.cloud.flowable.biz.api.controller.buyer;
...
public class StoreBuyerController {
    ...
    /** 店铺 */
    @Autowired private IFeignStoreApi storeApi;
    /** 店铺商品分类 */
    @Autowired private IFeignStoreGoodsLabelApi storeGoodsLabelApi;
    /** 店铺详情 */
    @Autowired private IFeignStoreDetailApi storeDetailApi;
    ...
    public Result<PageResult<StoreVO>> getByPage(StorePageQuery storePageQuery) {
        return Result.success(storeApi.findByConditionPage(storePageQuery));
    }
