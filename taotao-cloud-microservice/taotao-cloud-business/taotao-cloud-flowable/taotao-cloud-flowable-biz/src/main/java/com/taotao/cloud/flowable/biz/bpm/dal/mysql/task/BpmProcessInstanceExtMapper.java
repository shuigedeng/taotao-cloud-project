...
package com.taotao.cloud.flowable.biz.bpm.dal.mysql.task;
...
public interface BpmProcessInstanceExtMapper extends BaseMapperX<BpmProcessInstanceExtDO> {
    ...
    default PageResult<BpmProcessInstanceExtDO> selectPage(
            Long userId, BpmProcessInstanceMyPageReqVO reqVO) {
        return selectPage(
                reqVO,
                new LambdaQueryWrapperX<BpmProcessInstanceExtDO>()
                        ...
                        .betweenIfPresent(
                                BpmProcessInstanceExtDO::getCreateTime, reqVO.getCreateTime())
