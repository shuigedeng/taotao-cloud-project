...
import com.taotao.cloud.wechat.biz.weixin.config.WxMpProperties;
import lombok.*;
...
@AllArgsConstructor
@Configuration
@EnableConfigurationProperties(com.taotao.cloud.wechat.biz.weixin.config.WxMpProperties.class)
public class WxMpConfiguration {
    ...
    private final com.taotao.cloud.wechat.biz.weixin.config.WxMpProperties properties;
