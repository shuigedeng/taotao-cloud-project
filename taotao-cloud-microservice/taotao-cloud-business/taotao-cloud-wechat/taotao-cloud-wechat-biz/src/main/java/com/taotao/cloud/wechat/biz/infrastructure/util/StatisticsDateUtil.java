...
package com.taotao.cloud.wechat.biz.infrastructure.util; // package com.taotao.cloud.wechat.biz.util;
//
//
...
//        }
//        //按照年月查询
//        else if (statisticsQueryParam.getMonth() != null && statisticsQueryParam.getYear() !=
// null) {
