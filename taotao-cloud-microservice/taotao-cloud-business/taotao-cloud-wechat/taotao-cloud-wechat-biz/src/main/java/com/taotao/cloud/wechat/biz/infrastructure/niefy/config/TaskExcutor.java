...
package com.taotao.cloud.wechat.biz.infrastructure.niefy.config;
...
public class TaskExcutor {
    ...
    private static class ExcutorHolder {
        /**
         * 线程池 corePoolSize=5 核心线程数 maximumPoolSize=30 最大线程数 keepAliveTime=10，unit=TimeUnit.SECOND
    ...
    /**
     * 将任务提交到系统线程池中执行 1.如果线程数未达核心线程，创建核心线程 2.已达核心线程数，添加到任务队列 3.核心线程已满、队列已满，创建新空闲线程
