...
public class WechatNotifyController {
    ...
    @Autowired protected WxOpenServiceDemo wxOpenService;
    ...
    public Object receiveTicket(
        ...
        WxOpenXmlMessage inMessage =
                WxOpenXmlMessage.fromEncryptedXml(
                        requestBody,
    ...
    public Object callback(
        ...
        WxMpXmlMessage inMessage =
                WxOpenXmlMessage.fromEncryptedMpXml(
                        requestBody,
                        wxOpenService.getWxOpenConfigStorage(),
                        timestamp,
                        nonce,
            ...
            try {
                if (StringUtils.equals(inMessage.getMsgType(), "text")) {
                    if (StringUtils.equals(inMessage.getContent(), "TESTCOMPONENT_MSG_TYPE_TEXT")) {
                        out =
                                WxOpenXmlMessage.wxMpOutXmlMessageToEncryptedXml(
                        ...
                        String msg =
                                inMessage.getContent().replace("QUERY_AUTH_CODE:", "")
                                        + "_from_api";
