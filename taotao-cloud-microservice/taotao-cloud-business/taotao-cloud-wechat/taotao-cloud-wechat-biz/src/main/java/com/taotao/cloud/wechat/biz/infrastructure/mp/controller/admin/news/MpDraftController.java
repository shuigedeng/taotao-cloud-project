...
package com.taotao.cloud.wechat.biz.infrastructure.mp.controller.admin.news;
...
public class MpDraftController {
    ...
    public CommonResult<PageResult<WxMpDraftItem>> getDraftPage(MpDraftPageReqVO reqVO) {
        ...
        // 返回分页
        return success(
                new PageResult<>(draftList.getItems(), draftList.getTotalCount().longValue()));
    }
    ...
    public CommonResult<String> deleteDraft(
            @RequestParam("accountId") Long accountId, @RequestBody WxMpAddDraft draft) {
