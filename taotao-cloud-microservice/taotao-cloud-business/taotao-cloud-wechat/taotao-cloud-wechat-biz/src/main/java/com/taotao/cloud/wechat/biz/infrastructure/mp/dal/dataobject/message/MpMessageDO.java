...
package com.taotao.cloud.wechat.biz.infrastructure.mp.dal.dataobject.message;
...
public class MpMessageDO extends BaseDO {
     ...
     * 公众号粉丝的编号
     *
     * <p>关联 {@link MpUserDO#getId()}
     */
    private Long userId;
    /**
     * 公众号粉丝标志
     *
     * <p>冗余 {@link MpUserDO#getOpenid()}
     */
     ...
     * 消息类型
     *
     * <p>枚举 {@link WxConsts.XmlMsgType}
     */
    private String type;
    /**
     * 消息来源
     *
     * <p>枚举 {@link MpMessageSendFromEnum}
     */
     ...
     * 语音识别后文本
     *
     * <p>消息类型为 {@link WxConsts.XmlMsgType} 的 VOICE
     */
     ...
     * 标题
     *
     * <p>消息类型为 {@link WxConsts.XmlMsgType} 的 VIDEO、MUSIC、LINK
     */
     ...
     * 点击图文消息跳转链接
     *
     * <p>消息类型为 {@link WxConsts.XmlMsgType} 的 LINK
     */
    private String url;
     ...
     * 地理位置维度
     *
     * <p>消息类型为 {@link WxConsts.XmlMsgType} 的 LOCATION
     */
     ...
     * 事件类型
     *
     * <p>枚举 {@link WxConsts.EventType}
     */
    private String event;
    /**
     * 事件 Key
     *
     * <p>1. {@link WxConsts.EventType} 的 SCAN：qrscene_ 为前缀，后面为二维码的参数值 2. {@link WxConsts.EventType}
     * 的 CLICK：与自定义菜单接口中 KEY 值对应
     */
    ...
    public static class Article implements Serializable {
         ...
         * 图片链接
         *
         * <p>支持 JPG、PNG 格式，较好的效果为大图 360*200，小图 200*200
         */
