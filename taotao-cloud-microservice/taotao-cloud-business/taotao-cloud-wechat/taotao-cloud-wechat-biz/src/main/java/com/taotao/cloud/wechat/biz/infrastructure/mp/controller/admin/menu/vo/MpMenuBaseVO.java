...
package com.taotao.cloud.wechat.biz.infrastructure.mp.controller.admin.menu.vo;
...
public class MpMenuBaseVO {
     ...
     * 按钮类型
     *
     * <p>枚举 {@link WxConsts.MenuButtonType}
     */
    private String type;
    ...
    @NotEmpty(
            message = "网页链接不能为空",
            groups = {ViewButtonGroup.class, MiniProgramButtonGroup.class})
