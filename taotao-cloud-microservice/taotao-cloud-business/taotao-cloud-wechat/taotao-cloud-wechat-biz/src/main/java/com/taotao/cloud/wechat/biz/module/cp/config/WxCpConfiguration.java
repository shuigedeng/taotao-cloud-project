...
public class WxCpConfiguration {
	...
	@Autowired
	public WxCpConfiguration(LogHandler logHandler, NullHandler nullHandler,
	...
	public void initServices() {
		cpServices = this.properties.getAppConfigs().stream().map(a -> {
			...
			return service;
				...
				Collectors.toMap(service -> service.getWxCpConfigStorage().getAgentId(), a -> a));
	}
	...
	private WxCpMessageRouter newRouter(WxCpService wxCpService) {
		...
		newRouter.rule().async(false).msgType(WxConsts.XmlMsgType.EVENT)
				.event(WxCpConsts.EventType.CHANGE_CONTACT).handler(new ContactChangeHandler())
				.end();
