...
import com.taotao.cloud.report.biz.mapper.MemberStatisticsMapper;
import com.taotao.cloud.report.biz.model.entity.MemberStatisticsData;
import com.taotao.cloud.report.biz.service.IMemberStatisticsService;
import com.taotao.cloud.report.biz.util.StatisticsDateUtil;
...
public class MemberStatisticsServiceImpl
	...
	@Override
	public long newlyAdded(Date endTime, Date startTime) {
		return 0;
	}
