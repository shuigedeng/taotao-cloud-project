...
import com.taotao.cloud.report.biz.mapper.PlatformViewMapper;
import com.taotao.cloud.report.biz.service.IPlatformViewService;
...
//                    PlatformViewData::getStoreId,
//                    StringUtils.isEmpty(queryParam.getStoreId()) ? "-1" : queryParam.getStoreId());
