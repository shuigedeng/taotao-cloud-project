...
class MyBatisPlusGeneratorTests {
	...
	public static void main(String[] args) {
		...
		List<Module> moduleList = Arrays.asList(new Module("gateway", "cloud.xuxiaowei.next.gateway"),
				...
				new Module("cloud-commons-parent" + fileSeparator + "cloud-starter-oauth2",
