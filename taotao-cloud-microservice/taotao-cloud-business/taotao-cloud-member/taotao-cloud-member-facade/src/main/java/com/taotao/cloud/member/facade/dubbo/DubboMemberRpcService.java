...
@Service
@AllArgsConstructor
@DubboService(interfaceClass = MemberRpcService.class, validation = "true")
public class DubboMemberRpcService implements MemberRpcService {

	@Override
	public MemberQueryResponse findMemberByRequest(MemberQueryRequest memberQueryRequest) {
		return null;
	}
}
