...
package com.taotao.cloud.member.infrastructure.persistent.dept.repository.inf;
 ...
 */
public interface IDeptRepository extends BaseInterfaceSuperRepository<com.taotao.cloud.member.infrastructure.persistent.dept.po.DeptPO, Long> {

	@Query("select d from DeptPO d where d.version <> ?1")
	com.taotao.cloud.member.infrastructure.persistent.dept.po.DeptPO findByVersionNot(Integer version);
	...
	@Query(
		value = """
			...
			""", nativeQuery = true)
	com.taotao.cloud.member.infrastructure.persistent.dept.po.DeptPO find(@Param("deptPO") com.taotao.cloud.member.infrastructure.persistent.dept.po.DeptPO deptPO);
	//
	// @Query(value = """
