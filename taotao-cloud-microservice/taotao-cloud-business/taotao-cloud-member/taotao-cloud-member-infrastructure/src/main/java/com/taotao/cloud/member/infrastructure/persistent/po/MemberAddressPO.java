...
@NoArgsConstructor
@Entity
@Table(name = MemberAddressPO.TABLE_NAME)
@TableName(MemberAddressPO.TABLE_NAME)
@org.springframework.data.relational.core.mapping.Table(name = MemberAddress.TABLE_NAME, comment = "会员收货地址表")
