...
import com.taotao.cloud.workflow.biz.infrastructure.entity.RewardPunishmentEntity;
...
public interface RewardPunishmentService extends IService<RewardPunishmentEntity> {
     ...
     * @throws WorkFlowException 异常
     */
    void submit(String id, RewardPunishmentEntity entity, Map<String, List<String>> candidateList)
