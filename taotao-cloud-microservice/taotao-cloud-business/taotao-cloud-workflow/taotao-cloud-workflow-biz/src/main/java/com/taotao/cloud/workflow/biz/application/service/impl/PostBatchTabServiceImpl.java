...
import com.taotao.cloud.workflow.biz.application.service.PostBatchTabService;
...
public class PostBatchTabServiceImpl extends ServiceImpl<PostBatchTabMapper, PostBatchTabEntity>
    ...
    public void data(String id, String data) {
        PostBatchTabForm postBatchTabForm = JacksonUtils.getJsonToBean(data, PostBatchTabForm.class);
