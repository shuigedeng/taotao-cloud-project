...
import com.taotao.cloud.workflow.biz.infrastructure.entity.ArticlesWarehousEntity;
...
public interface ArticlesWarehousService extends IService<ArticlesWarehousEntity> {
     ...
     * @throws WorkFlowException 异常
     */
    void submit(String id, ArticlesWarehousEntity entity, Map<String, List<String>> candidateList)
