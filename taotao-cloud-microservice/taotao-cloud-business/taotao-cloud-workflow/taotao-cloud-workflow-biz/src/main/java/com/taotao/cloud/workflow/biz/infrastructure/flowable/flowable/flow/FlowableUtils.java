...
package com.taotao.cloud.workflow.biz.infrastructure.flowable.flowable.flow;
...
public class FlowableUtils {
     ...
     * @return
     */
    public static Collection<FlowElement> getAllElements(
            Collection<FlowElement> flowElements, Collection<FlowElement> allElements) {
     ...
     * @return
     */
    public static List<UserTask> iteratorFindParentUserTasks(
     ...
     * @return
     */
    public static List<UserTask> findChildProcessUserTasks(
            FlowElement source, Set<String> hasSequenceFlow, List<UserTask> userTaskList) {
        hasSequenceFlow = hasSequenceFlow == null ? new HashSet<>() : hasSequenceFlow;
        userTaskList = userTaskList == null ? new ArrayList<>() : userTaskList;
     ...
     * @return
     */
    public static Set<String> iteratorFindDirtyRoads(
            FlowElement source,
     ...
     * @return
     */
    public static Set<String> findChildProcessAllDirtyRoad(
    ...
    public static List<String> historicTaskInstanceClean(
        ...
        while (!stack.empty()) {
            ...
            if (stack.peek().getDeleteReason() != null
                    && !"MI_END".equals(stack.peek().getDeleteReason())) {
                // 可以理解为脏线路起点
                String dirtyPoint = "";
            ...
            for (int i = 0; i < deleteKeyList.size(); i++) {
                ...
                if (multiKey == null
                        && multiTask.contains(stack.peek().getTaskDefinitionKey())
