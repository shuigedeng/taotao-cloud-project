...
import com.taotao.cloud.workflow.biz.infrastructure.entity.ExpenseExpenditureEntity;
...
public interface ExpenseExpenditureService extends IService<ExpenseExpenditureEntity> {
     ...
     * @throws WorkFlowException 异常
     */
    void submit(String id, ExpenseExpenditureEntity entity, Map<String, List<String>> candidateList)
