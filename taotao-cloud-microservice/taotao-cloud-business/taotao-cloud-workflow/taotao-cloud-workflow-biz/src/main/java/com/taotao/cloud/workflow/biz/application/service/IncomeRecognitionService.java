...
import com.taotao.cloud.workflow.biz.infrastructure.entity.IncomeRecognitionEntity;
...
public interface IncomeRecognitionService extends IService<IncomeRecognitionEntity> {
     ...
     * @throws WorkFlowException 异常
     */
    void submit(String id, IncomeRecognitionEntity entity, Map<String, List<String>> candidateList)
