...
package com.taotao.cloud.workflow.biz.infrastructure.common.database.enums.datatype;
...
public enum DtPostgreSQL implements DtInterface {
    ...
    /** */
    NUMERIC("numeric", ViewDataTypeConst.DECIMAL, 0, 1000, 0, 100),
    /** 默认长度：无 */
    TEXT("text", ViewDataTypeConst.TEXT, false),
    /** 默认长度：32 */
    INT4("int4", ViewDataTypeConst.INT, false),
    /** 默认长度：64 */
    INT8("int8", ViewDataTypeConst.BIGINT, false);
