...
package com.taotao.cloud.workflow.biz.interfaces.controller;
...
import com.taotao.cloud.workflow.biz.infrastructure.entity.MaterialEntryEntity;
...
public class MaterialRequisitionController {
    ...
    @Operation("获取领料单信息")
    @GetMapping("/{id}")
    public Result<MaterialRequisitionInfoVO> info(@PathVariable("id") String id, String taskOperatorId)
    ...
    public Result create(@RequestBody @Valid MaterialRequisitionForm materialRequisitionForm) throws WorkFlowException {
        ...
        materialRequisitionService.submit(
                material.getId(), material, materialEntryList, materialRequisitionForm.getCandidateList());
