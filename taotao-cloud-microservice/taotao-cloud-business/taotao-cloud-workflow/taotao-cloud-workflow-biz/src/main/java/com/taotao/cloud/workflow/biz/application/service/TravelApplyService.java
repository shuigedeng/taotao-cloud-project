...
import com.taotao.cloud.workflow.biz.infrastructure.entity.TravelApplyEntity;
...
public interface TravelApplyService extends IService<TravelApplyEntity> {
     ...
     * @throws WorkFlowException 异常
     */
    void submit(String id, TravelApplyEntity entity, Map<String, List<String>> candidateList) throws WorkFlowException;
