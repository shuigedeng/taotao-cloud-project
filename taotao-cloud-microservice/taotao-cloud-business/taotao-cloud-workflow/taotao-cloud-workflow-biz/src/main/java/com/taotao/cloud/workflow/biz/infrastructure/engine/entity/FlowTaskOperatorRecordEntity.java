...
package com.taotao.cloud.workflow.biz.infrastructure.engine.entity;
...
public class FlowTaskOperatorRecordEntity extends SuperPO<FlowTaskOperatorRecordEntity, String> {
    /** 节点流转主键 */
    @TableId("id")
    private String id;
