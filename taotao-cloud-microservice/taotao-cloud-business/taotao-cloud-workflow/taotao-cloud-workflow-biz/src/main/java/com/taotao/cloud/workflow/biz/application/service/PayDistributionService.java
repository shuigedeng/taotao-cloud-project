...
import com.taotao.cloud.workflow.biz.infrastructure.entity.PayDistributionEntity;
...
public interface PayDistributionService extends IService<PayDistributionEntity> {
     ...
     * @throws WorkFlowException 异常
     */
    void submit(String id, PayDistributionEntity entity, Map<String, List<String>> candidateList)
