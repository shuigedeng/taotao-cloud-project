...
import com.taotao.cloud.workflow.biz.infrastructure.entity.ArchivalBorrowEntity;
...
public interface ArchivalBorrowService extends IService<ArchivalBorrowEntity> {
     ...
     * @throws WorkFlowException 异常
     */
    void submit(String id, ArchivalBorrowEntity entity, Map<String, List<String>> candidateList)
