...
import com.taotao.cloud.workflow.biz.application.service.DocumentSigningService;
...
public class DocumentSigningServiceImpl extends ServiceImpl<DocumentSigningMapper, DocumentSigningEntity>
    ...
    public void data(String id, String data) {
        DocumentSigningForm documentSigningForm = JacksonUtils.getJsonToBean(data, DocumentSigningForm.class);
