...
package com.taotao.cloud.workflow.biz.infrastructure.common.database.sql.append.create;

import com.taotao.boot.common.utils.lang.StringUtils;
import com.taotao.cloud.workflow.biz.infrastructure.common.database.model.DbTableFieldModel;
import com.taotao.cloud.workflow.biz.infrastructure.common.database.model.dto.PreparedStatementDTO;
...
public class CreateSql {
    ...
    /** 获取 - SQL */
    public static List<PreparedStatementDTO> getCreTabSql(
            CreateSqlDTO createSqlDTO) throws Exception {
    ...
    /** 装配 - 字段集合 */
    private static PreparedStatementDTO getFieldsPSD(
            CreateSqlDTO createSqlDTO) throws Exception {
