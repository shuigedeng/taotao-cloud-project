...
import com.taotao.cloud.workflow.biz.application.service.LeaveApplyService;
...
import com.taotao.cloud.workflow.biz.form.mapper.LeaveApplyMapper;
import com.taotao.cloud.workflow.biz.infrastructure.entity.LeaveApplyEntity;
...
public class LeaveApplyServiceImpl extends ServiceImpl<LeaveApplyMapper, LeaveApplyEntity>
    ...
    @Override
    @DSTransactional
    public void submit(String id, LeaveApplyEntity entity, Map<String, List<String>> candidateList)
    ...
    public void data(String id, String data) {
        LeaveApplyForm leaveApplyForm = JacksonUtils.getJsonToBean(data, LeaveApplyForm.class);
