...
import com.taotao.cloud.workflow.biz.infrastructure.entity.ViolationHandlingEntity;
...
public interface ViolationHandlingService extends IService<ViolationHandlingEntity> {
     ...
     * @throws WorkFlowException 异常
     */
    void submit(String id, ViolationHandlingEntity entity, Map<String, List<String>> candidateList)
