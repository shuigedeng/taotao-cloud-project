...
public class LeaveApplyServiceImpl extends ServiceImpl<LeaveApplyMapper, LeaveApplyEntity> implements LeaveApplyService {
    ...
    @Override
    @DSTransactional
    public void submit(String id, LeaveApplyEntity entity, Map<String, List<String>> candidateList) throws WorkFlowException {
        //表单信息
        if (id == null) {
            entity.setId(RandomUtil.uuId());
            this.save(entity);
    ...
    public void data(String id, String data) {
        LeaveApplyForm leaveApplyForm = JsonUtils.getJsonToBean(data, LeaveApplyForm.class);
