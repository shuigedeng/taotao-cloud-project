...
public class BpmTaskServiceImpl implements BpmTaskService {
    ...
    public PageResult<BpmTaskTodoPageItemRespVO> getTodoTaskPage(Long userId, BpmTaskTodoPageReqVO pageVO) {
        ...
        return new PageResult<>(
                BpmTaskConvert.INSTANCE.convertList1(tasks, processInstanceMap, userMap), taskQuery.count());
    }
    ...
    public void createTaskExt(Task task) {
        BpmTaskExtDO taskExtDO = BpmTaskConvert.INSTANCE
    ...
    public void updateTaskExtCancel(String taskId) {
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
            ...
            public void afterCommit() {
                ...
                // 更新任务
                taskExtMapper.updateById(new BpmTaskExtDO()
                        .setId(taskExt.getId())
