...
import com.taotao.cloud.workflow.biz.application.service.ReceiptSignService;
...
import com.taotao.cloud.workflow.biz.infrastructure.entity.ReceiptSignEntity;
...
public class ReceiptSignServiceImpl extends ServiceImpl<ReceiptSignMapper, ReceiptSignEntity>
    ...
    @Override
    @DSTransactional
    public void submit(String id, ReceiptSignEntity entity, Map<String, List<String>> candidateList)
