...
package com.taotao.cloud.promotion.biz.application.service.inner.impl;
...
import com.taotao.cloud.sys.biz.application.service.inner.InnerDictService;
...
@Service
@AllArgsConstructor
public class InnerDictServiceImpl extends BaseServiceImpl< Dict, Long, IDictMapper,DictRepository, IDictRepository>
        implements InnerDictService {
    @Autowired
