...
@org.springframework.data.relational.core.mapping.Table(name = KanjiaActivity.TABLE_NAME, comment = "砍价活动参与实体类")
public class KanjiaActivity extends BasePO<KanjiaActivity> {
