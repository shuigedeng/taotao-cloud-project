...
package com.taotao.cloud.member.infratructure.repositories.wallet.mapper;
...
/** 会员签到数据处理层 */
public interface IMemberWalletMapper extends BaseSuperMapper<MemberWallet, Long> {
