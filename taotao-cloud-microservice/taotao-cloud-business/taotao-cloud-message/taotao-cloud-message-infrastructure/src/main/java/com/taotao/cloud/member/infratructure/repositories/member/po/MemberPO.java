...
package com.taotao.cloud.member.infratructure.repositories.member.po;
...
public class MemberPO extends BaseSuperEntity<MemberPO, Long> {
    ...
    public MemberPO(String username, String password, String mobile) {
    ...
    public MemberPO(String username, String password, String mobile, String nickname, String face) {
        this.username = username;
        this.password = password;
        this.mobile = mobile;
    ...
    public MemberPO(String username, String password, String face, String nickname, Integer sex) {
        this.username = username;
        this.password = password;
        this.mobile = "";
        this.nickname = nickname;
