 ...
 */
public class NoticeMessageApiFallback implements FallbackFactory<NoticeMessageApi> {

    @Override
    public NoticeMessageApi create(Throwable throwable) {
        return new NoticeMessageApi() {

            @Override
            public void noticeMessage(NoticeMessageApiRequest noticeMessageDTO) {}
