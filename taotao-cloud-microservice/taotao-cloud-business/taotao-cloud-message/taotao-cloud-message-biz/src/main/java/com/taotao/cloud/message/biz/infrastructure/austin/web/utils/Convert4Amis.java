package com.taotao.cloud.message.biz.infrastructure.austin.web.utils;
...
import com.taotao.cloud.message.biz.infrastructure.austin.common.enums.SmsStatus;
...
public class Convert4Amis {
    ...
    public static EchartsVo getEchartsVo(Map<Object, Object> anchorResult, MessageTemplate messageTemplate, String businessId) {
        ...
        String title = "[" + messageTemplate.getName() + "]在" + DateUtil.format(DateUtil.parse(String.valueOf(
                TaskInfoUtils.getDateFromBusinessId(Long.valueOf(businessId)))), DatePattern.CHINESE_DATE_FORMATTER) + "的下发情况：";
