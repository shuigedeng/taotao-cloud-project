...
import com.taotao.cloud.message.biz.infrastructure.austin.common.constant.SendChanelUrlConstant;
import com.taotao.cloud.message.biz.infrastructure.austin.common.dto.account.DingDingWorkNoticeAccount;
import com.taotao.cloud.message.biz.infrastructure.austin.common.dto.account.EnterpriseWeChatRobotAccount;
...
import com.taotao.cloud.message.biz.infrastructure.austin.common.enums.FileType;
import com.taotao.cloud.message.biz.infrastructure.austin.common.enums.RespStatusEnum;
import com.taotao.cloud.message.biz.infrastructure.austin.common.vo.BasicResultVO;
import com.taotao.cloud.message.biz.infrastructure.austin.handler.domain.wechat.robot.EnterpriseWeChatRootResult;
import com.taotao.cloud.message.biz.infrastructure.austin.support.utils.AccessTokenUtils;
import com.taotao.cloud.message.biz.infrastructure.austin.support.utils.AccountUtils;
import com.taotao.cloud.message.biz.infrastructure.austin.web.service.MaterialService;
import com.taotao.cloud.message.biz.infrastructure.austin.web.utils.SpringFileUtils;
import com.taotao.cloud.message.biz.infrastructure.austin.web.vo.UploadResponseVo;
...
public class MaterialServiceImpl implements MaterialService {
    ...
    public BasicResultVO enterpriseWeChatRootMaterialUpload(MultipartFile multipartFile, String sendAccount, String fileType) {
        try {
            ...
            String key = weChatRobotAccount.getWebhook().substring(weChatRobotAccount.getWebhook().indexOf(CommonConstants.EQUAL_STRING) + 1);
