...
import com.taotao.cloud.message.biz.infrastructure.austin.common.constant.OfficialAccountParamConstant;
...
import com.taotao.cloud.message.biz.infrastructure.austin.web.annotation.AustinAspect;
import com.taotao.cloud.message.biz.infrastructure.austin.web.annotation.AustinResult;
import com.taotao.cloud.message.biz.infrastructure.austin.web.config.WeChatLoginConfig;
import com.taotao.cloud.message.biz.infrastructure.austin.web.exception.CommonException;
import com.taotao.cloud.message.biz.infrastructure.austin.web.utils.Convert4Amis;
import com.taotao.cloud.message.biz.infrastructure.austin.web.utils.LoginUtils;
import com.taotao.cloud.message.biz.infrastructure.austin.web.vo.amis.CommonAmisVo;
...
public class OfficialAccountController {
    ...
    public String receiptMessage(HttpServletRequest request) {
        try {
            ...
            String encryptType = CharSequenceUtil.isBlank(request.getParameter(OfficialAccountParamConstant.ENCRYPT_TYPE)) ? OfficialAccountParamConstant.RAW : request.getParameter(
                    OfficialAccountParamConstant.ENCRYPT_TYPE);
