...
@org.springframework.data.relational.core.mapping.Table(name = WechatMessage.TABLE_NAME, comment = "微信消息表")
public class WechatMessage extends BasePO<WechatMessage> {
