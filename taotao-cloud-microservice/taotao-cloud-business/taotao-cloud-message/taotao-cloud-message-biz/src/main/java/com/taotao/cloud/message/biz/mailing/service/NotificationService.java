...
public class NotificationService extends BaseLayeredService<Notification, String> {
	...
	public NotificationService(NotificationRepository notificationRepository,
		PullStampService pullStampService, AnnouncementService announcementService) {
	...
	public void pullAnnouncements(String userId) {
		...
		List<Announcement> systemAnnouncements = announcementService.pullAnnouncements(
			pullStamp.getLatestPullTime());
		if (CollectionUtils.isNotEmpty(systemAnnouncements)) {
			List<Notification> notificationQueues = convertAnnouncementsToNotifications(userId,
				systemAnnouncements);
			this.saveAll(notificationQueues);
		}
	}

	public Page<Notification> findByCondition(int pageNumber, int pageSize, String userId,
	...
	private List<Notification> convertAnnouncementsToNotifications(String userId,
	...
	private Notification convertAnnouncementToNotification(String userId,
