...
public class TencentSmsReceipt {
	...
	public void pull() {
		...
		// 获取腾讯云账号信息
		TencentSmsAccount account = accountUtils.getAccount(10, SendAccountConstant.SMS_ACCOUNT_KEY,
				SendAccountConstant.SMS_PREFIX, TencentSmsAccount.class);
		try {
			...
			if (resp != null && resp.getPullSmsSendStatusSet() != null
