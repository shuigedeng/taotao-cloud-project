package com.taotao.cloud.message.biz.infrastructure.austin.web.advice;
...
public class AustinResponseBodyAdvice implements ResponseBodyAdvice<Object> {
    ...
    public boolean supports(MethodParameter methodParameter, Class aClass) {
        return methodParameter.getContainingClass().isAnnotationPresent(AustinResult.class) || methodParameter.hasMethodAnnotation(
                AustinResult.class);
    }
