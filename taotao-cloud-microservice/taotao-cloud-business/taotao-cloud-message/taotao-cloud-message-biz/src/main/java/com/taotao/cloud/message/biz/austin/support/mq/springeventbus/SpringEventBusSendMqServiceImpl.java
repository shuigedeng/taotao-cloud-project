...
public class SpringEventBusSendMqServiceImpl implements SendMqService {
	...
	public void send(String topic, String jsonValue, String tagId) {
		AustinSpringEventSource source = AustinSpringEventSource.builder().topic(topic)
			.jsonValue(jsonValue).tagId(tagId).build();
		AustinSpringEventBusEvent austinSpringEventBusEvent = new AustinSpringEventBusEvent(this,
			source);
