package com.taotao.cloud.message.biz.infrastructure.austin.web.service.impl;
...
import com.taotao.cloud.message.biz.infrastructure.austin.common.enums.EnumUtil;
import com.taotao.cloud.message.biz.infrastructure.austin.support.dao.MessageTemplateDao;
import com.taotao.cloud.message.biz.infrastructure.austin.support.dao.SmsRecordDao;
import com.taotao.cloud.message.biz.infrastructure.austin.support.domain.MessageTemplate;
import com.taotao.cloud.message.biz.infrastructure.austin.support.domain.SmsRecord;
import com.taotao.cloud.message.biz.infrastructure.austin.support.utils.RedisUtils;
import com.taotao.cloud.message.biz.infrastructure.austin.support.utils.TaskInfoUtils;
import com.taotao.cloud.message.biz.infrastructure.austin.web.service.DataService;
import com.taotao.cloud.message.biz.infrastructure.austin.web.utils.AnchorStateUtils;
import com.taotao.cloud.message.biz.infrastructure.austin.web.utils.Convert4Amis;
import com.taotao.cloud.message.biz.infrastructure.austin.web.vo.DataParam;
import com.taotao.cloud.message.biz.infrastructure.austin.web.vo.amis.EchartsVo;
import com.taotao.cloud.message.biz.infrastructure.austin.web.vo.amis.SmsTimeLineVo;
import com.taotao.cloud.message.biz.infrastructure.austin.web.vo.amis.UserTimeLineVo;
...
public class DataServiceImpl implements DataService {
    ...
    public UserTimeLineVo getTraceUserInfo(String receiver) {
        ...
        // 0. 按时间排序
        List<SimpleAnchorInfo> sortAnchorList = userInfoList.stream().map(s -> JSON.parseObject(s, SimpleAnchorInfo.class)).sorted(Comparator.comparing(
                SimpleAnchorInfo::getTimestamp).reversed()).collect(Collectors.toList());
