package com.taotao.cloud.message.biz.infrastructure.austin.api.impl.service;
...
public class RecallServiceImpl implements RecallService {
    ...
    public SendResponse recall(SendRequest sendRequest) {
        ...
        ProcessContext context = ProcessContext.builder().code(sendRequest.getCode()).processModel(recallTaskModel).needBreak(false).response(
                BasicResultVO.success()).build();
