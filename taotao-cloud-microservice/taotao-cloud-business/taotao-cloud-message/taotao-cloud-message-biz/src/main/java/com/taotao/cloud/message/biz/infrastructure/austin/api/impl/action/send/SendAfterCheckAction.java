...
import com.taotao.cloud.message.biz.infrastructure.austin.common.enums.IdType;
...
public class SendAfterCheckAction implements BusinessProcess<SendTaskModel> {
    ...
    public void process( ProcessContext<SendTaskModel> context) {
        ...
        if (CollUtil.isEmpty(taskInfo)) {
            context.setNeedBreak(true).setResponse(
                    BasicResultVO.fail(RespStatusEnum.CLIENT_BAD_PARAMETERS, "手机号或邮箱不合法, 无有效的发送任务"));
        }
