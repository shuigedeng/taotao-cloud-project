package com.taotao.cloud.message.biz.infrastructure.austin.handler.script.impl;
...
import com.taotao.cloud.message.biz.infrastructure.austin.common.dto.account.sms.YunPianSmsAccount;
...
import com.taotao.cloud.message.biz.infrastructure.austin.handler.domain.sms.YunPianSendResult;
    ...
    public List<SmsRecord> send( SmsParam smsParam) {
        ...
        try {
            ...
            String result = HttpRequest.post(account.getUrl())
                    .header(Header.CONTENT_TYPE.getValue(), CommonConstants.CONTENT_TYPE_FORM_URL_ENCODE)
                    .header(Header.ACCEPT.getValue(), CommonConstants.CONTENT_TYPE_JSON)
                    .form(params)
                    .timeout(2000)
                    .execute().body();
