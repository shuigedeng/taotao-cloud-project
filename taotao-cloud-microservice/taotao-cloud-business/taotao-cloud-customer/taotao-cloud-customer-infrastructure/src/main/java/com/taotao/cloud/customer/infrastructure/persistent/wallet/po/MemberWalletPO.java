...
package com.taotao.cloud.member.infratructure.persistent.wallet.po;
...
@org.springframework.data.relational.core.mapping.Table(name = MemberWallet.TABLE_NAME, comment = "会员预存款表")
