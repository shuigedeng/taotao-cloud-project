                                ...
                                () -> {
                                    try {
                                        ...
                                        SpringShutdownHook.logger.info(
                                                "[SpringShutdownHook] Application need sleep {}"
                                                        + " seconds to wait Dubbo shutdown",
                                                timeOut / 1000.0D);
                                        Thread.sleep((long) timeOut);
                                        SpringShutdownHook.this.configurableApplicationContext
                                                .close();
                                        SpringShutdownHook.logger.info(
                                                "[SpringShutdownHook] ApplicationContext closed,"
