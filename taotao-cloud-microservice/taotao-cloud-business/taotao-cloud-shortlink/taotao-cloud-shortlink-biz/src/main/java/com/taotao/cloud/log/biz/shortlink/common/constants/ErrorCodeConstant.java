package com.taotao.cloud.log.biz.shortlink.common.constants;
...
public class ErrorCodeConstant {
	...
	public static final ErrorCode LOGIN_FAILED_OVER_TIMES = new ErrorCode(10007,
		"已达到错误次数上限！");
	public static final ErrorCode ID_CARD_NO_FORMAT_INVALID = new ErrorCode(10008,
		"身份证格式不合法！");
	...
	public static final ErrorCode VERIFY_CODE_VERIFY_FAILED = new ErrorCode(10011,
		"验证码校验失败");
	public static final ErrorCode VERIFY_CODE_TYPE_NOT_SUPPORT = new ErrorCode(10012,
		"验证码类型不支持");
	public static final ErrorCode EXPIRED_API_NOT_SUPPORT = new ErrorCode(10013,
		"过期的Api不再支持");
	...
	public static final ErrorCode SHORT_LINK_CODE_GENERATE_ERROR = new ErrorCode(20004,
		"短链码生成失败");
