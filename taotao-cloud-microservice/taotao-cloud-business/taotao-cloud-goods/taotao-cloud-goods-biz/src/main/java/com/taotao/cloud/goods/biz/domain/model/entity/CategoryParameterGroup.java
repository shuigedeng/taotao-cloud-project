...
@org.springframework.data.relational.core.mapping.Table(name = CategoryParameterGroup.TABLE_NAME)
public class CategoryParameterGroup extends BasePO<CategoryParameterGroup> {
