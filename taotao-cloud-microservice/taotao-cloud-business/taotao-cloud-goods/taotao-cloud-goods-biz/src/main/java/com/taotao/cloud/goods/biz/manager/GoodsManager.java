...
public class GoodsManager extends BaseManager {
    ...
    public <T> QueryWrapper<T> goodsQueryWrapper(GoodsPageQuery goodsPageQuery) {
        ...
        queryWrapper.eq(
                StrUtil.isNotEmpty(goodsPageQuery.getAuthFlag()), "auth_flag", goodsPageQuery.getAuthFlag());
    ...
    private <T> void goodsBetweenWrapper(QueryWrapper<T> queryWrapper, GoodsPageQuery goodsPageQuery) {
