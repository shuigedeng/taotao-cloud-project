...
public class QueryUtil {
	...
	public static <T> QueryWrapper<T> goodsQueryWrapper(GoodsPageQuery goodsPageQuery) {
		...
		queryWrapper.like(CharSequenceUtil.isNotEmpty(goodsPageQuery.getGoodsName()), "goods_name",
		...
		queryWrapper.like(CharSequenceUtil.isNotEmpty(goodsPageQuery.getStoreName()), "store_name",
			goodsPageQuery.getStoreName());
		queryWrapper.like(CharSequenceUtil.isNotEmpty(goodsPageQuery.getCategoryPath()),
			"category_path", goodsPageQuery.getCategoryPath());
		queryWrapper.like(CharSequenceUtil.isNotEmpty(goodsPageQuery.getStoreCategoryPath()),
			"store_category_path", goodsPageQuery.getStoreCategoryPath());
		queryWrapper.eq(goodsPageQuery.getSelfOperated() != null, "self_operated",
			goodsPageQuery.getSelfOperated());
		queryWrapper.eq(CharSequenceUtil.isNotEmpty(goodsPageQuery.getMarketEnable()),
			"market_enable", goodsPageQuery.getMarketEnable());
		queryWrapper.eq(CharSequenceUtil.isNotEmpty(goodsPageQuery.getAuthFlag()), "auth_flag",
		...
		queryWrapper.eq(CharSequenceUtil.isNotEmpty(goodsPageQuery.getGoodsType()), "goods_type",
	...
	private static <T> void goodsBetweenWrapper(QueryWrapper<T> queryWrapper,
