 ...
 */
public interface ISpecificationService extends BaseSuperService<SpecificationPO, Long> {
	 ...
	 * @since 2022-04-27 17:01:01
	 */
	IPage<SpecificationPO> getPage(SpecificationPageQuery specificationPageQuery);
