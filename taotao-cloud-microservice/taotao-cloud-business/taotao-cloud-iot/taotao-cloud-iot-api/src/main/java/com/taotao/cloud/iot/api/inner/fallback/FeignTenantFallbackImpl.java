...
package com.taotao.cloud.iot.api.inner.fallback;

import com.taotao.boot.common.utils.log.LogUtils;
import com.taotao.cloud.iot.api.inner.TenantServiceApi;
    ...
    public TenantServiceApi create(Throwable throwable) {
        return new TenantServiceApi() {
            ...
            public void validTenant(Long id) {
                LogUtils.error("taotao-cloud-iot  TenantServiceApi validTenant feign调用失败 ===============");
            }

            @Override
            public String addTenantWithTestSeata(TenantDTO tenantDTO) {
                LogUtils.error("taotao-cloud-iot  TenantServiceApi addTenantWithTestSeata feign调用失败 ===============");
                return null;
            }
        };
    }
