...
package com.taotao.cloud.auth.infrastructure.persistent.authorizaon.repository;
...
public interface TtcAuthorizationRepository extends
	JpaInterfaceSuperRepository<TtcAuthorization, String> {
	...
	@Query("""
		...
		""")
	Integer updateBy(
		@Param("ttcAuthorization") TtcAuthorization ttcAuthorization);
}
