...
package com.taotao.cloud.auth.infrastructure.metadata.processor;
...
import com.taotao.cloud.security.springsecurity.core.domain.SecurityAttribute;
...
import com.taotao.cloud.security.springsecurity.processor.SecurityMetadataSourceAnalyzer;
...
public class SecurityMetadataDistributeProcessor implements ApplicationStrategyEvent<List<SecurityAttribute>> {
    ...
    //
    //	public SecurityMetadataDistributeProcessor(SysAttributeService sysAttributeService, SysInterfaceService
    ...
    public void postRemoteProcess(String data, String originService, String destinationService) {
        // ServiceContext.getInstance().publishEvent(new RemoteSecurityMetadataSyncEvent(data, originService,
        // destinationService));
    }
    ...
    private String convertPermissionToCommaDelimitedString(Set<SysPermission> sysAuthorities) {
        if (CollectionUtils.isNotEmpty(sysAuthorities)) {
            List<String> codes = sysAuthorities.stream()
