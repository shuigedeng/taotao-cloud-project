...
package com.taotao.cloud.auth.infrastructure.strategy;

import com.taotao.cloud.auth.infrastructure.strategy.local.LocalPermissionDetailsService;
import com.taotao.cloud.auth.infrastructure.strategy.local.LocalUserDetailsService;
import com.taotao.cloud.auth.infrastructure.strategy.local.SysPermissionService;
import com.taotao.cloud.auth.infrastructure.strategy.local.SysUserService;
import com.taotao.cloud.auth.infrastructure.strategy.remote.RemotePermissionDetailsService;
import com.taotao.cloud.auth.infrastructure.strategy.remote.RemoteUserDetailsService;
