...
package com.taotao.cloud.sys.infrastructure.persistent.authorizaon.repository.inf;
 ...
 */
public interface IDeptRepository extends BaseInterfaceSuperRepository<com.taotao.cloud.sys.infrastructure.persistent.po.DeptPO, Long> {

	@Query("select d from DeptPO d where d.version <> ?1")
	com.taotao.cloud.sys.infrastructure.persistent.po.DeptPO findByVersionNot(Integer version);
	...
	@Query(
		value = """
			...
			""", nativeQuery = true)
	com.taotao.cloud.sys.infrastructure.persistent.po.DeptPO find(@Param("deptPO") com.taotao.cloud.sys.infrastructure.persistent.po.DeptPO deptPO);
	//
	// @Query(value = """
