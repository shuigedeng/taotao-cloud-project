...
package com.taotao.cloud.auth.infrastructure.metadata.listener;

import com.taotao.cloud.auth.infrastructure.metadata.event.SysAttributeChangeEvent;
import com.taotao.cloud.auth.infrastructure.metadata.processor.SecurityMetadataDistributeProcessor;
import com.taotao.cloud.auth.infrastructure.strategy.user.SysAttribute;
