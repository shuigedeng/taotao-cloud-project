 ...
 */
public class FormOAuth2PhoneAuthenticationTokenDeserializer extends JsonDeserializer<Oauth2FormPhoneAuthenticationToken> {
	 ...
	 */
	@Override
	public Oauth2FormPhoneAuthenticationToken deserialize(JsonParser jp, DeserializationContext ctxt)
...
//		Object credentials = getCredentials(credentialsNode);
		...
		Oauth2FormPhoneAuthenticationToken token = (!authenticated)
				? Oauth2FormPhoneAuthenticationToken.unauthenticated(principal, captcha, type)
				: Oauth2FormPhoneAuthenticationToken.authenticated(principal, captcha, type, authorities);
