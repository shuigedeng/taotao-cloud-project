...
package com.taotao.cloud.auth.biz.authentication.login.oauth2.social.all.entity;
...
@Cacheable
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "upms:sys:social:user")
