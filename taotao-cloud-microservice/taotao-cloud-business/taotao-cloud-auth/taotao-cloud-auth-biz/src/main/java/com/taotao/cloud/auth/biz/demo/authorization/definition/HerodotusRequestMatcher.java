...
/**
 * Description: 自定义 AntPathRequestMatcher
 *
 * <p>基于 AntPathRequestMatcher 代码，扩展了一些方法，解决原有 AntPathRequestMatcher 使用不方便问题。
 *
...
public final class HerodotusRequestMatcher implements RequestMatcher, Serializable {
     ...
     */
    public HerodotusRequestMatcher(
            String pattern, String httpMethod, boolean caseSensitive, UrlPathHelper urlPathHelper) {
    ...
    public boolean matches(HttpServletRequest request) {
        if (StringUtils.isNotBlank(this.httpMethod)
    ...
    public boolean matches(HerodotusRequestMatcher requestMatcher) {
        ...
        if (StringUtils.isNotBlank(this.httpMethod)
                && StringUtils.isNotBlank(requestMatcher.getHttpMethod())
