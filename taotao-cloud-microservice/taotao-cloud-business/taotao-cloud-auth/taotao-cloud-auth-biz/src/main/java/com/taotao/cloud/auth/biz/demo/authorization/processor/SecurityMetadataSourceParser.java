...
public class SecurityMetadataSourceParser {
     ...
     *
     * <p>1. 这里转换的内容，主要来源于 SecurityFilterChain 的 antMatchers 配置的权限过滤内容 2. SecurityFilterChain 中的配置
     ...
     *
     * <p>因此，这里只能通过解析 AntPathRequestMatcher toString() 方法中的信息，再拼凑成自己自定义的 RequestMatcher对象。
     ...
     * 解析并动态组装所需要的权限。
     *
     * <p>1. 原 spring-security-oauth Spring Security
     ...
     * spring-authorization-server Spring Security 基础权限规则，来源于{@link
     * org.springframework.security.config.annotation.web.configurers.ExpressionUrlAuthorizationConfigurer}
     * OAuth2 权限规则来源于 目前还没有
     *
     * <p>具体解析采用的是 Security 的 {@link org.springframework.security.access.AccessDecisionVoter}
     ...
     *
     * <p>如果实际应用不满足可以，自己扩展AccessDecisionVoter或者AccessDecisionManager
     *
     * @param securityAttribute {@link SecurityAttribute}
