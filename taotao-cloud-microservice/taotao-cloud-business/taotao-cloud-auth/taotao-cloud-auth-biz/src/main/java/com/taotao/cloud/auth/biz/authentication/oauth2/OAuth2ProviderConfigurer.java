...
public class OAuth2ProviderConfigurer
        extends AbstractHttpConfigurer<OAuth2ProviderConfigurer, HttpSecurity> {
    ...
    public OAuth2ProviderConfigurer wechatWebclient(String appId, String secret) {
        ClientRegistration clientRegistration =
                getBuilder(
                                ClientProviders.WECHAT_WEB_CLIENT.registrationId(),
     ...
     * @return the o auth 2 provider configurer
     */
    public OAuth2ProviderConfigurer workWechatWebLoginclient(
    ...
    public void init(HttpSecurity httpSecurity) throws Exception {
        ...
        oAuth2UserServiceMap.put(
                ClientProviders.WECHAT_WEB_CLIENT.registrationId(), wechatOAuth2UserService);
        oAuth2UserServiceMap.put(
                ClientProviders.WECHAT_WEB_LOGIN_CLIENT.registrationId(), wechatOAuth2UserService);
        oAuth2UserServiceMap.put(
                ClientProviders.WORK_WECHAT_SCAN_CLIENT.registrationId(),
        ...
        httpSecurity.setSharedObject(
                ClientRegistrationRepository.class, delegateClientRegistrationRepository);
                ...
                .userInfoEndpoint(
                        userInfoEndpointCustomizer -> {
                            userInfoEndpointCustomizer.userService(
                                    new DelegatingOAuth2UserService<>(oAuth2UserServiceMap));
                        });
