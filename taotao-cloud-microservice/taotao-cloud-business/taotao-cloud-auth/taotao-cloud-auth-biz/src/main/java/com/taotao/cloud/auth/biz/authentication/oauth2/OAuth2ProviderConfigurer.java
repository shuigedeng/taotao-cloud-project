...
public class OAuth2ProviderConfigurer extends AbstractHttpConfigurer<OAuth2ProviderConfigurer, HttpSecurity> {
    ...
    public OAuth2ProviderConfigurer wechatWebLoginclient(String appId, String secret) {
        ClientRegistration clientRegistration = getBuilder(
                        ClientProviders.WECHAT_WEB_LOGIN_CLIENT.registrationId(), ClientAuthenticationMethod.NONE)
                .clientId(appId)
                .clientSecret(secret)
                .scope("snsapi_login")
    ...
    public OAuth2ProviderConfigurer workWechatWebLoginclient(String corpId, String secret, String agentId) {
        ClientRegistration clientRegistration = getBuilder(
                        ClientProviders.WORK_WECHAT_SCAN_CLIENT.registrationId(), ClientAuthenticationMethod.NONE)
                .clientId(corpId)
                .clientSecret(secret)
                .scope(agentId)
