...
/**
 * <p>HerodotusAuthorizationRepository </p>
 *
 * @author shuigedeng
 * @version 2023.07
 * @since 2023-07-10 17:11:21
 */
public interface HerodotusAuthorizationRepository extends
	JpaInterfaceSuperRepository<HerodotusAuthorization, String> {
	 ...
	 * 更新由
	 *
	 * @param herodotusAuthorization 希罗多德授权
	 * @return {@link Integer }
	...
	@Query("""
		...
		""")
	Integer updateBy(
		@Param("herodotusAuthorization") HerodotusAuthorization herodotusAuthorization);
}
