...
package com.taotao.cloud.auth.biz.authentication.login.oauth2.social.wxmpp.condition;
...
public class WxmppEnabledCondition implements Condition {
    ...
    public boolean matches(ConditionContext conditionContext, AnnotatedTypeMetadata metadata) {
        boolean result = PropertyUtils.getProperty(AccessConstants.ITEM_WXMPP_ENABLED, false);
        log.debug("Condition [Wxmpp Enabled] value is [{}]", result);
        return result;
    }
}
