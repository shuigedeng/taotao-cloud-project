...
package com.taotao.cloud.auth.biz.authentication.login.oauth2.social.wxapp.condition;
...
public class WxappEnabledCondition implements Condition {
    ...
    public boolean matches(ConditionContext conditionContext, AnnotatedTypeMetadata metadata) {
        boolean result = PropertyUtils.getProperty(AccessConstants.ITEM_WXAPP_ENABLED, false);
        log.debug("Condition [Wxapp Enabled] value is [{}]", result);
        return result;
    }
}
