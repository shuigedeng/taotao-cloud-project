...
public class FingerprintAuthenticationProvider implements AuthenticationProvider, InitializingBean, MessageSourceAware {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		Assert.isInstanceOf(FingerprintAuthenticationToken.class, authentication,
			() -> this.messages.getMessage("FingerprintAuthenticationToken.onlySupports",
	...
	protected void additionalAuthenticationChecks(UserDetails userDetails,
												  FingerprintAuthenticationToken authentication) throws AuthenticationException {
...
//		}
	...
	protected final UserDetails retrieveUser(String username, FingerprintAuthenticationToken authentication)
		...
		try {
			UserDetails loadedUser = fingerprintUserDetailsService.loadUserByFingerprint((String) authentication.getPrincipal());
			if (loadedUser == null) {
