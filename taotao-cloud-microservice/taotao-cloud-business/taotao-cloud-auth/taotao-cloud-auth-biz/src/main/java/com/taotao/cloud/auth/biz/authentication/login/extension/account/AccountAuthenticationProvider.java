...
public class AccountAuthenticationProvider implements AuthenticationProvider, InitializingBean, MessageSourceAware {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        Assert.isInstanceOf(
                ...
                () -> this.messages.getMessage(
                        "AccountAuthenticationToken.onlySupports", "Only AccountAuthenticationToken is supported"));
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails, AccountAuthenticationToken authentication)
    ...
    protected final UserDetails retrieveUser(String username, AccountAuthenticationToken authentication)
        ...
        try {
            UserDetails loadedUser = accountUserDetailsService.loadUserByUsername(
