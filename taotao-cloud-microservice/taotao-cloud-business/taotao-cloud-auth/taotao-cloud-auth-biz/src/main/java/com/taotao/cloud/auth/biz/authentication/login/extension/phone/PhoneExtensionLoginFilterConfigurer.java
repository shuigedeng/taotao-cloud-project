...
public class PhoneExtensionLoginFilterConfigurer<H extends HttpSecurityBuilder<H>>
        extends AbstractExtensionLoginFilterConfigurer<
								H, PhoneExtensionLoginFilterConfigurer<H>, PhoneAuthenticationFilter, ExtensionLoginFilterSecurityConfigurer<H>> {
    ...
    public PhoneExtensionLoginFilterConfigurer(ExtensionLoginFilterSecurityConfigurer<H> securityConfigurer) {
        super(securityConfigurer, new PhoneAuthenticationFilter(), "/login/phone");
    }

    public PhoneExtensionLoginFilterConfigurer<H> phoneUserDetailsService(PhoneUserDetailsService phoneUserDetailsService) {
        this.phoneUserDetailsService = phoneUserDetailsService;
        return this;
    }

    public PhoneExtensionLoginFilterConfigurer<H> phoneService(PhoneService phoneService) {
        this.phoneService = phoneService;
        return this;
    }

    public PhoneExtensionLoginFilterConfigurer<H> jwtTokenGenerator(JwtTokenGenerator jwtTokenGenerator) {
