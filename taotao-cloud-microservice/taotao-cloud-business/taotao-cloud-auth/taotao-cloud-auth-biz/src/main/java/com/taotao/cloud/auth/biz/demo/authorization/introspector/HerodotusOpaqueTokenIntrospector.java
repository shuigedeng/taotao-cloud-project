...
package com.taotao.cloud.auth.biz.demo.authorization.introspector;
...
public class HerodotusOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
	...
	public HerodotusOpaqueTokenIntrospector(EndpointProperties endpointProperties,
	 ...
	 */
	public HerodotusOpaqueTokenIntrospector(String introspectionUri, String clientId,
		String clientSecret) {
		Assert.notNull(introspectionUri, "introspectionUri cannot be null");
		Assert.notNull(clientId, "clientId cannot be null");
		Assert.notNull(clientSecret, "clientSecret cannot be null");
		this.requestEntityConverter = this.defaultRequestEntityConverter(
			URI.create(introspectionUri));
	 ...
	 */
	public HerodotusOpaqueTokenIntrospector(String introspectionUri,
	...
	private static String getIntrospectionUri(EndpointProperties endpointProperties,
		OAuth2ResourceServerProperties resourceServerProperties) {
		String introspectionUri = endpointProperties.getTokenIntrospectionUri();
		String configIntrospectionUri = resourceServerProperties.getOpaquetoken()
			.getIntrospectionUri();
	...
	private Map<String, Object> adaptToNimbusResponse(
		...
		boolean active = (boolean) claims.compute(OAuth2TokenIntrospectionClaimNames.ACTIVE,
			(k, v) -> {
