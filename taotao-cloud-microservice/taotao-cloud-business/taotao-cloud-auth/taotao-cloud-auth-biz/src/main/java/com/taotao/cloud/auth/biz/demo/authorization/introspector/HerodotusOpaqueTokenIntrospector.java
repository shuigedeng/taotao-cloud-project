...
/**
 * Description: 自定义 OpaqueTokenIntrospector
 *
 * <p>解决默认的 OpaqueTokenIntrospector 使用 Scope 作为权限的问题。
 *
...
public class HerodotusOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
     ...
     * Creates a {@code OpaqueTokenAuthenticationProvider} with the provided parameters
     *
     * <p>The given {@link RestOperations} should perform its own client authentication against the
    ...
    /**
     * Sets the {@link Converter} used for converting the OAuth 2.0 access token to a {@link
