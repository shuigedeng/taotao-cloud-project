...
public class RedisRegisteredClientRepository extends JpaRegisteredClientRepository {
    ...
    public RegisteredClient findById(String id) {
        RegisteredClient registeredClientByRedis =
                (RegisteredClient) redisRepository.opsForValue().get(PREFIX + REGISTERED_CLIENT_ID + id);
    ...
    public RegisteredClient findByClientId(String clientId) {
        RegisteredClient registeredClientByRedis =
                (RegisteredClient) redisRepository.opsForValue().get(PREFIX + REGISTERED_CLIENT_CLIENT_ID + clientId);
    ...
    public void set(RegisteredClient registeredClient, long timeout, TimeUnit unit) {
        redisRepository
                .opsForValue()
                .set(PREFIX + REGISTERED_CLIENT_ID + registeredClient.getId(), registeredClient, timeout, unit);
        redisRepository
                .opsForValue()
                .set(
