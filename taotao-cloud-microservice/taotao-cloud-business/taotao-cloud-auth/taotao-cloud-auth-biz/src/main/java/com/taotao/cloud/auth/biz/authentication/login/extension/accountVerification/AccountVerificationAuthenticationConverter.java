 ...
 */
public class AccountVerificationAuthenticationConverter implements Converter<HttpServletRequest, AccountVerificationAuthenticationToken> {
	...
	@Override
	public AccountVerificationAuthenticationToken convert(HttpServletRequest request) {
		...
		return AccountVerificationAuthenticationToken.unauthenticated(username, password, verificationCode, type);
	}
