...
public final class RedisOAuth2AuthorizationService extends JpaOAuth2AuthorizationService {
    ...
    public void remove(OAuth2Authorization authorization) {
        if (authorization != null) {
            ...
            if (accessToken != null) {
                ...
                redisRepository.del(PREFIX + OAUTH2_AUTHORIZATION_TOKEN_TYPE + OAuth2TokenType.ACCESS_TOKEN.getValue()
                        + ":" + tokenValue);
            }
            ...
            if (refreshToken != null) {
                ...
                String tokenValue = token.getTokenValue();
                redisRepository.del(PREFIX + OAUTH2_AUTHORIZATION_TOKEN_TYPE + OAuth2TokenType.REFRESH_TOKEN.getValue()
                        + ":" + tokenValue);
            }
    ...
    public OAuth2Authorization findById(String id) {
        ...
        OAuth2Authorization oauth2AuthorizationRedis =
                (OAuth2Authorization) redisRepository.opsForValue().get(PREFIX + OAUTH2_AUTHORIZATION_ID + id);
    ...
    public void set(OAuth2Authorization authorization, long timeout, TimeUnit unit) {
        redisRepository
                .opsForValue()
                .set(PREFIX + OAUTH2_AUTHORIZATION_ID + authorization.getId(), authorization, timeout, unit);
