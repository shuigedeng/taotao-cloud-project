...
import com.taotao.cloud.auth.api.dubbo.IDubboClientRpc;
...
@Service
@AllArgsConstructor
@DubboService(interfaceClass = IDubboClientRpc.class, validation = "true")
public class DubboClientRpc implements IDubboClientRpc {
