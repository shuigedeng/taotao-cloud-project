...
public class JustAuthSocialUserController {
	...
	public Result<Page<JustAuthSocialUserDTO>> list(
		...
		Page<JustAuthSocialUserDTO> pageJustAuthSocialUser = justAuthSocialUserService.queryJustAuthSocialUserList(
	...
	public Result<?> batchDelete(@RequestBody List<Long> justAuthSocialUserIds) {
		...
		boolean result = justAuthSocialUserService.batchDeleteJustAuthSocialUser(
			justAuthSocialUserIds);
		return Result.success(result);
	}
