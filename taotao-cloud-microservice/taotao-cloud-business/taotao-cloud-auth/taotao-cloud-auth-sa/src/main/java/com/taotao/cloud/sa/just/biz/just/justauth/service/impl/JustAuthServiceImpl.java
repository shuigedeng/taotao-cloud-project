...
public class JustAuthServiceImpl implements IJustAuthService {
	 ...
	 */
	@Override
	public Long userBindId(@NotBlank @RequestParam("uuid") String uuid,
	...
	public Long userCreateOrUpdate(
		...
		UpdateJustAuthSocialDTO createJustAuthSocialDTO = BeanCopierUtils.copyByClass(
			justAuthSocialInfoDTO, UpdateJustAuthSocialDTO.class);
		JustAuthSocial justAuthSocial = justAuthSocialService.createOrUpdateJustAuthSocial(
			createJustAuthSocialDTO);
	...
	public Result<Object> userBindQuery(@NotNull @RequestParam("socialId") Long socialId) {
		...
		List<JustAuthSocialUserDTO> justAuthSocialUserList = justAuthSocialUserService.queryJustAuthSocialUserList(
			justAuthSocialUserQuery);
	 ...
	 */
	@Override
	public JustAuthSocialUser userBind(@NotNull @RequestParam("socialId") Long socialId,
		...
		JustAuthSocialUser justAuthSocialUser = justAuthSocialUserService.createJustAuthSocialUser(
			justAuthSocialUserCreate);
	 ...
	 */
	@Override
	public Result<JustAuthSocialUser> userUnbind(@NotNull @RequestParam("socialId") Long socialId,
		@NotNull @RequestParam("userId") Long userId) {
		QueryJustAuthSocialUserDTO justAuthSocialUserQuery = new QueryJustAuthSocialUserDTO();
		justAuthSocialUserQuery.setSocialId(socialId);
		justAuthSocialUserQuery.setUserId(userId);
		JustAuthSocialUserDTO justAuthSocialUserDTO = justAuthSocialUserService.queryJustAuthSocialUser(
			justAuthSocialUserQuery);
