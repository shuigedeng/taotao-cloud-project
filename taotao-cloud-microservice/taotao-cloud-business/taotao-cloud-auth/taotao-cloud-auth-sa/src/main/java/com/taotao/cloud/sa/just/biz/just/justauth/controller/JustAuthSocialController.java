...
@Api(value = "JustAuthSocialController|租户第三方登录渠道配置表前端控制器", tags = {
	"第三方登录渠道配置"})
@RefreshScope
public class JustAuthSocialController {
	...
	public Result<Page<JustAuthSocialDTO>> list(QueryJustAuthSocialDTO queryJustAuthSocialDTO,
		Page<JustAuthSocialDTO> page) {
		Page<JustAuthSocialDTO> pageJustAuthSocial = justAuthSocialService.queryJustAuthSocialList(
			page, queryJustAuthSocialDTO);
	...
	public Result<?> query(QueryJustAuthSocialDTO queryJustAuthSocialDTO) {
		JustAuthSocialDTO justAuthSocialDTO = justAuthSocialService.queryJustAuthSocial(
			queryJustAuthSocialDTO);
	...
	public void download(HttpServletResponse response,
		QueryJustAuthSocialDTO queryJustAuthSocialDTO) throws IOException {
		...
		List<JustAuthSocialDTO> justAuthSocialList = justAuthSocialService.queryJustAuthSocialList(
			queryJustAuthSocialDTO);
		...
		for (JustAuthSocialDTO justAuthSocialDTO : justAuthSocialList) {
			JustAuthSocialExport justAuthSocialExport = BeanCopierUtils.copyByClass(
				justAuthSocialDTO, JustAuthSocialExport.class);
			justAuthSocialExportList.add(justAuthSocialExport);
		}
		String sheetName = "租户第三方登录功能配置表数据列表";
		EasyExcel.write(response.getOutputStream(), JustAuthSocialExport.class).sheet(sheetName)
