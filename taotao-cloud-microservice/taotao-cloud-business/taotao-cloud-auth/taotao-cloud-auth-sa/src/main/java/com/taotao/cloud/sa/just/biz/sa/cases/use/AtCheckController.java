...
public class AtCheckController {
    ...
    // 登录鉴权   ---- http://127.0.0.1:8081/at-check/checkLogin
    // 		登录认证后才可以进入方法
    @SaCheckLogin
    ...
    // 权限校验   ---- http://127.0.0.1:8081/at-check/checkPermission
    ...
    // 权限校验2   ---- http://127.0.0.1:8081/at-check/checkPermission2
    //		一次性校验多个权限，必须全部拥有，才可以进入方法
    @SaCheckPermission(
            value = {"user.add", "user.delete", "user.update"},
            mode = SaMode.AND)
    ...
    // 权限校验3   ---- http://127.0.0.1:8081/at-check/checkPermission3
    ...
    // 角色校验   ---- http://127.0.0.1:8081/at-check/checkRole
    ...
    // 角色权限双重 “or校验”   ---- http://127.0.0.1:8081/at-check/userAdd
    ...
    // 忽略校验 ---- http://127.0.0.1:8081/at-check/ignore
