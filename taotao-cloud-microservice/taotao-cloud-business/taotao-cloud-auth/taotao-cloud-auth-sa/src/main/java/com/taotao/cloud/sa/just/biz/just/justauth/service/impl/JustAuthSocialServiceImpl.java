...
public class JustAuthSocialServiceImpl extends
	ServiceImpl<JustAuthSocialMapper, JustAuthSocial> implements IJustAuthSocialService {
	 ...
	 */
	@Override
	public Page<JustAuthSocialDTO> queryJustAuthSocialList(Page<JustAuthSocialDTO> page,
		QueryJustAuthSocialDTO queryJustAuthSocialDTO) {
		Page<JustAuthSocialDTO> justAuthSocialInfoList = justAuthSocialMapper.queryJustAuthSocialList(
	...
	public List<JustAuthSocialDTO> queryJustAuthSocialList(
		QueryJustAuthSocialDTO queryJustAuthSocialDTO) {
		List<JustAuthSocialDTO> justAuthSocialInfoList = justAuthSocialMapper.queryJustAuthSocialList(
	...
	public JustAuthSocialDTO queryJustAuthSocial(QueryJustAuthSocialDTO queryJustAuthSocialDTO) {
		JustAuthSocialDTO justAuthSocialDTO = justAuthSocialMapper.queryJustAuthSocial(
			queryJustAuthSocialDTO);
	...
	public JustAuthSocial createJustAuthSocial(CreateJustAuthSocialDTO justAuthSocial) {
		JustAuthSocial justAuthSocialEntity = BeanCopierUtils.copyByClass(justAuthSocial,
			JustAuthSocial.class);
