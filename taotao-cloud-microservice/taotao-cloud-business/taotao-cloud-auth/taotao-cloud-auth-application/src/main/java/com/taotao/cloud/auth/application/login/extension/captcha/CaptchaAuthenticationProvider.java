...
public class CaptchaAuthenticationProvider implements AuthenticationProvider, InitializingBean, MessageSourceAware {
    ...
    public CaptchaAuthenticationProvider(
            CaptchaUserDetailsService captchaUserDetailsService, CaptchaCheckService captchaCheckService) {
    ...
    protected final UserDetails retrieveUser(String username, CaptchaAuthenticationToken authentication)
        ...
        try {
            UserDetails loadedUser = captchaUserDetailsService.loadUserByUsername(
