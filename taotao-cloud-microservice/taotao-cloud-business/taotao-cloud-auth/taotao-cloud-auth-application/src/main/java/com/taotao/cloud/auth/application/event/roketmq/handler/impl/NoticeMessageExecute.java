...
package com.taotao.cloud.auth.application.event.roketmq.handler.impl;

import com.taotao.cloud.mq.stream.message.MemberWithdrawalMessage;
import com.taotao.cloud.auth.application.event.roketmq.handler.MemberPointChangeEventHandler;
import com.taotao.cloud.auth.application.event.roketmq.handler.MemberWithdrawalEventHandler;
