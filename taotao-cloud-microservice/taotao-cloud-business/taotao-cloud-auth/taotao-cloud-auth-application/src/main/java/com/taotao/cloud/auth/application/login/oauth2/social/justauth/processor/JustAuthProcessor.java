...
package com.taotao.cloud.auth.application.login.oauth2.social.justauth.processor;

import com.taotao.cloud.auth.application.login.oauth2.social.core.exception.AccessConfigErrorException;
import com.taotao.cloud.auth.application.login.oauth2.social.core.exception.IllegalAccessSourceException;
import com.taotao.cloud.auth.application.login.oauth2.social.justauth.properties.JustAuthProperties;
import com.taotao.cloud.auth.application.login.oauth2.social.justauth.stamp.JustAuthStateStampManager;
