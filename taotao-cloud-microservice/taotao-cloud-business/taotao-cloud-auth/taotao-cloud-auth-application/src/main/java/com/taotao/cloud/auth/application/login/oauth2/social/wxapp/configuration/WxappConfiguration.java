...
package com.taotao.cloud.auth.application.login.oauth2.social.wxapp.configuration;

import com.taotao.cloud.auth.application.login.oauth2.social.all.enums.AccountType;
import com.taotao.cloud.auth.application.login.oauth2.social.wxapp.processor.WxappAccessHandler;
import com.taotao.cloud.auth.application.login.oauth2.social.wxapp.processor.WxappLogHandler;
import com.taotao.cloud.auth.application.login.oauth2.social.wxapp.processor.WxappProcessor;
import com.taotao.cloud.auth.application.login.oauth2.social.wxapp.properties.WxappProperties;
