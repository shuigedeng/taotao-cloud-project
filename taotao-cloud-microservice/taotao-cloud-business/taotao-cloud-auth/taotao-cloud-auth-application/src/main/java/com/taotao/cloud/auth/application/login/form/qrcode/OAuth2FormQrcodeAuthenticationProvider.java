...
import com.taotao.cloud.auth.application.login.extension.qrcocde.QrcodeAuthenticationToken;
import com.taotao.cloud.auth.application.login.form.qrcode.service.OAuth2FormQrcodeService;
import com.taotao.cloud.auth.application.login.form.qrcode.service.OAuth2FormQrcodeUserDetailsService;
 ...
 *
 */
public class OAuth2FormQrcodeAuthenticationProvider
    ...
    public OAuth2FormQrcodeAuthenticationProvider(
            OAuth2FormQrcodeService qrcodeService, OAuth2FormQrcodeUserDetailsService qrcodeUserDetailsService) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        OAuth2FormQrcodeAuthenticationToken unAuthenticationToken =
                (OAuth2FormQrcodeAuthenticationToken) authentication;
