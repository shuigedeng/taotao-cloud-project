...
import com.taotao.cloud.auth.application.filter.ExtensionAndOauth2LoginRefreshTokenFilter;
...
import com.taotao.cloud.auth.application.login.form.qrcode.OAuth2FormQrcodeLoginHttpConfigurer;
import com.taotao.cloud.auth.application.login.form.sms.Oauth2FormSmsLoginHttpConfigurer;
...
import com.taotao.cloud.auth.application.token.JwtTokenGeneratorImpl;
import com.taotao.cloud.auth.application.token.OAuth2AccessTokenStore;
