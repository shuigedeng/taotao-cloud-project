...
package com.taotao.cloud.auth.application.login.oauth2.social;

import com.google.common.collect.ImmutableSet;
import com.taotao.cloud.auth.application.login.oauth2.social.all.processor.AccessHandlerStrategyFactory;
import com.taotao.cloud.auth.application.login.oauth2.social.core.definition.AccessUserDetails;
import com.taotao.cloud.auth.application.login.oauth2.social.core.exception.AccessIdentityVerificationFailedException;
import com.taotao.cloud.auth.application.login.oauth2.social.handler.AbstractSocialAuthenticationHandler;
import com.taotao.cloud.auth.application.login.oauth2.social.handler.SocialUserDetails;
import com.taotao.cloud.auth.infrastructure.strategy.local.SysSocialUserService;
import com.taotao.cloud.auth.infrastructure.strategy.local.SysUserService;
import com.taotao.cloud.auth.infrastructure.strategy.user.SysSocialUser;
import com.taotao.cloud.auth.infrastructure.strategy.user.SysUser;
