package com.taotao.cloud.auth.application.federation.strategy.impl;

import com.taotao.cloud.auth.application.federation.Oauth2ThirdAccount;
import com.taotao.cloud.auth.application.federation.strategy.Oauth2UserConverterStrategy;
import lombok.RequiredArgsConstructor;
import org.springframework.security.oauth2.core.user.OAuth2User;
import org.springframework.stereotype.Component;

import static com.taotao.cloud.auth.application.federation.strategy.impl.GithubUserConverter.THIRD_LOGIN_GITHUB;
