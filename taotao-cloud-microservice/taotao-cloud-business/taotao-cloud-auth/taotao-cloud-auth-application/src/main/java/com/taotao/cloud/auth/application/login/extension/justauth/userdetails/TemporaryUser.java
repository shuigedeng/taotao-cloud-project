...
package com.taotao.cloud.auth.application.login.extension.justauth.userdetails;

import com.fasterxml.jackson.annotation.JsonTypeInfo;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.taotao.cloud.auth.application.login.extension.justauth.deserializes.TemporaryUserDeserializer;
    ...
    public static class UserBuilder {
        ...
        public UserBuilder roles(String... roles) {
            ...
            for (String role : roles) {
                Assert.isTrue(
                        !role.startsWith("ROLE_"), () -> role + " cannot start with ROLE_ (it is automatically added)");
