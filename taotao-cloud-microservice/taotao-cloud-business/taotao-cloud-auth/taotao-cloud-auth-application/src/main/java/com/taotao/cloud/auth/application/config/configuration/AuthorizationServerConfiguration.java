...
import com.taotao.cloud.auth.application.device.DeviceClientAuthenticationConverter;
import com.taotao.cloud.auth.application.device.DeviceClientAuthenticationProvider;
...
import com.taotao.cloud.auth.application.login.oauth2.OAuth2AuthorizationCodeAuthenticationProvider;
import com.taotao.cloud.auth.application.login.oauth2.OAuth2ClientCredentialsAuthenticationProvider;
import com.taotao.cloud.auth.application.login.oauth2.password.OAuth2ResourceOwnerPasswordAuthenticationConverter;
...
import com.taotao.cloud.auth.infrastructure.oidc.TtcOidcUserInfoMapper;
...
import com.taotao.cloud.auth.infrastructure.response.OAuth2AccessTokenResponseHandler;
import com.taotao.cloud.auth.infrastructure.response.OAuth2AuthenticationFailureResponseHandler;
...
import com.taotao.cloud.auth.infrastructure.token.TtcJwtTokenCustomizer;
import com.taotao.cloud.auth.infrastructure.token.TtcOpaqueTokenCustomizer;
