...
import com.taotao.cloud.auth.infrastructure.oauth2.response.OAuth2AccessTokenResponseHandler;
import com.taotao.cloud.auth.infrastructure.oauth2.response.OAuth2AuthenticationFailureResponseHandler;
...
import com.taotao.cloud.auth.infrastructure.oauth2.token.TtcJwtTokenCustomizer;
import com.taotao.cloud.auth.infrastructure.oauth2.token.TtcOpaqueTokenCustomizer;
