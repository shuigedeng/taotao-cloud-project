...
package com.taotao.cloud.auth.application.login.form.sms;

import com.taotao.cloud.auth.application.login.form.sms.service.Oauth2FormSmsService;
import com.taotao.cloud.auth.application.login.form.sms.service.Oauth2FormSmsUserDetailsService;
import com.taotao.cloud.auth.application.login.oauth2.OAuth2AbstractAuthenticationProvider;
