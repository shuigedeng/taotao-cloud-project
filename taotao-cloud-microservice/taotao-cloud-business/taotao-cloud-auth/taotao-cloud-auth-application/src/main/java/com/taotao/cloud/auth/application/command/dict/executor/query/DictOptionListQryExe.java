...
package com.taotao.cloud.auth.application.command.dict.executor.query;

import com.baomidou.dynamic.datasource.annotation.DS;
import com.baomidou.mybatisplus.core.toolkit.Wrappers;
import com.taotao.cloud.common.model.Result;
import com.taotao.cloud.auth.application.adapter.DictAdapter;
import com.taotao.cloud.auth.application.command.dict.dto.DictOptionListQry;
import com.taotao.cloud.auth.application.command.dict.dto.clientobject.OptionCO;
