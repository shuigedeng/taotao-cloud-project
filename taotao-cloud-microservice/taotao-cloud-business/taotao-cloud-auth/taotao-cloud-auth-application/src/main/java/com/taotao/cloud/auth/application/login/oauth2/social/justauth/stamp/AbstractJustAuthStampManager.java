...
package com.taotao.cloud.auth.application.login.oauth2.social.justauth.stamp;
...
public abstract class AbstractJustAuthStampManager extends AbstractRenderer {
    ...
    public AbstractJustAuthStampManager(RedisRepository redisRepository, String cacheName, Duration expire) {
