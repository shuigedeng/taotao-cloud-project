...
package com.taotao.cloud.auth.application.login.oauth2.social.all.configuration;

import com.taotao.cloud.auth.application.login.oauth2.social.all.processor.AccessHandlerStrategyFactory;
import com.taotao.cloud.auth.application.login.oauth2.social.justauth.configuration.JustAuthConfiguration;
import com.taotao.cloud.auth.application.login.oauth2.social.wxapp.configuration.WxappConfiguration;
import com.taotao.cloud.auth.application.login.oauth2.social.wxmpp.configuration.WxmppConfiguration;
