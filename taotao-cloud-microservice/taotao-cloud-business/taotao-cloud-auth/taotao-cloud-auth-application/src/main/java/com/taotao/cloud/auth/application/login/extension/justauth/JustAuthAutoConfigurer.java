...
import com.taotao.cloud.auth.application.login.extension.justauth.filter.JsonRequestFilter;
import com.taotao.cloud.auth.application.login.extension.justauth.filter.login.Auth2LoginAuthenticationFilter;
import com.taotao.cloud.auth.application.login.extension.justauth.filter.redirect.Auth2DefaultRequestRedirectFilter;
...
import com.taotao.cloud.auth.application.login.extension.justauth.service.Auth2UserService;
import com.taotao.cloud.auth.application.login.extension.justauth.service.ConnectionService;
