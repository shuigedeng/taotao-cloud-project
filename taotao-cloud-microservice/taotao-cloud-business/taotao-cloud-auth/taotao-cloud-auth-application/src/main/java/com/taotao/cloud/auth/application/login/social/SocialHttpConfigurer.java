...
import com.taotao.cloud.auth.application.login.form.captcha.OAuth2FormCaptchaLoginHttpConfigurer;
import com.taotao.cloud.auth.application.login.social.gitee.GiteeOAuth2UserService;
import com.taotao.cloud.auth.application.login.social.github.GithubOAuth2UserService;
import com.taotao.cloud.auth.application.login.social.qq.QQOauth2UserService;
import com.taotao.cloud.auth.application.login.social.qq.QqOAuth2AccessTokenResponseHttpMessageConverter;
import com.taotao.cloud.auth.application.login.social.wechat.WechatOAuth2UserService;
import com.taotao.cloud.auth.application.login.social.wechatwork.WorkWechatOAuth2UserService;
import com.taotao.cloud.auth.application.login.social.weibo.WeiboOAuth2UserService;
import com.taotao.cloud.auth.application.token.JwtTokenGenerator;
