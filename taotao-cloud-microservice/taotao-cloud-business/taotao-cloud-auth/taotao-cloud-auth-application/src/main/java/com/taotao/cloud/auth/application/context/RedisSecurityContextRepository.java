...
package com.taotao.cloud.auth.application.context;

import com.taotao.cloud.auth.application.context.SupplierDeferredSecurityContext;
...
public class RedisSecurityContextRepository implements SecurityContextRepository {
	...
	public void saveContext(SecurityContext context, HttpServletRequest request,
		...
		if (emptyContext.equals(context)) {
			...
			// 保存认证信息
			redisRepository.set((SECURITY_CONTEXT_PREFIX_KEY + nonce), context,
