...
import com.taotao.cloud.auth.application.login.extension.account.AccountExtensionLoginFilterConfigurer;
import com.taotao.cloud.auth.application.login.extension.captcha.CaptchaExtensionLoginFilterConfigurer;
import com.taotao.cloud.auth.application.login.extension.email.EmailExtensionLoginFilterConfigurer;
import com.taotao.cloud.auth.application.login.extension.face.FaceExtensionLoginFilterConfigurer;
import com.taotao.cloud.auth.application.login.extension.fingerprint.FingerprintExtensionLoginFilterConfigurer;
import com.taotao.cloud.auth.application.login.extension.gestures.GesturesExtensionLoginFilterConfigurer;
import com.taotao.cloud.auth.application.login.extension.oneClick.OneClickExtensionLoginFilterConfigurer;
import com.taotao.cloud.auth.application.login.extension.qrcocde.QrcodeExtensionLoginFilterConfigurer;
import com.taotao.cloud.auth.application.login.extension.sms.SmsExtensionLoginFilterConfigurer;
import com.taotao.cloud.auth.application.login.extension.wechatminiapp.WechatMiniAppExtensionLoginFilterConfigurer;
import com.taotao.cloud.auth.application.login.extension.wechatmp.WechatMpExtensionLoginFilterConfigurer;
