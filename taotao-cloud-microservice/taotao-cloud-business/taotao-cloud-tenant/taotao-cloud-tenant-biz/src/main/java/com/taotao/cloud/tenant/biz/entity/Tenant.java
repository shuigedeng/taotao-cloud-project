...
public class Tenant extends Entity<Long> {
	...
	/**
	 * 连接类型 #TenantConnectTypeEnum{LOCAL:本地;REMOTE:远程}
	 */
	...
	@TableField("status")
	@Excel(name = "状态", width = 20, replace = {"正常_NORMAL", "待初始化_WAIT_INIT",
		"禁用_FORBIDDEN", "待审核_WAITING", "拒绝_REFUSE", "已删除_DELETE", "_null"})
	...
	@Builder
	public Tenant(Long id, LocalDateTime createTime, Long createdBy, LocalDateTime updateTime,
		Long updatedBy,
		String code, String name, TenantTypeEnum type, TenantConnectTypeEnum connectType,
