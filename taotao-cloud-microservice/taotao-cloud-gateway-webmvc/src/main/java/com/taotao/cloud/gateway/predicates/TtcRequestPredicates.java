 ...
 */
public class TtcRequestPredicates {

	private static final Logger log = LoggerFactory.getLogger(TtcRequestPredicates.class);

	/**
	 *
	 * @date 2025/12/15
	 * @description 请求头的判断（是否包含某个名称的请求头）,必须添加@Configurable注解且只能有一个参数，
	 * 不然无法生效
	 *
	 */
	@Shortcut
	public static RequestPredicate headerExists( String name ) {
	...
	public static class TtcPredicateSupplier implements PredicateSupplier {

		@Override
		public Collection<Method> get() {
			return Arrays.asList(TtcRequestPredicates.class.getMethods());
		}
	}
