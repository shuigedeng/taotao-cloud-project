...
package com.taotao.cloud.admin.model;
...
public class AlertMessage implements Serializable {
	...
	public AlertMessage(String version, Integer truncatedAlerts, String groupKey,
		String status, String receiver,
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(version, that.version) && Objects.equals(
			truncatedAlerts, that.truncatedAlerts) && Objects.equals(groupKey,
			that.groupKey) && Objects.equals(status, that.status)
			&& Objects.equals(receiver, that.receiver) && Objects.equals(
			groupLabels, that.groupLabels) && Objects.equals(commonLabels,
			that.commonLabels) && Objects.equals(commonAnnotations,
			that.commonAnnotations) && Objects.equals(externalURL, that.externalURL)
			&& Objects.equals(alerts, that.alerts);
	}

	@Override
	public int hashCode() {
		return Objects.hash(version, truncatedAlerts, groupKey, status, receiver, groupLabels,
