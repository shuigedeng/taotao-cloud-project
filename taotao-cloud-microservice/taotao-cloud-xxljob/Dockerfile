...
ADD ./build/libs/taotao-cloud-xxljob-2022.07.jar ./

RUN java -Djarmode=layertools -jar taotao-cloud-xxljob-2022.07.jar extract
...
ARG APP_NAME=taotao-cloud-xxljob
