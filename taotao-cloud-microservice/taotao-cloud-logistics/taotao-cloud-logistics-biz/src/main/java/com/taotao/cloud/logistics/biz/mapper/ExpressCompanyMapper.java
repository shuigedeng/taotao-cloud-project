 ...
 */
package com.taotao.cloud.logistics.biz.mapper;
...
public interface ExpressCompanyMapper {
	...
	ExpressCompanyMapper INSTANCE = Mappers.getMapper(ExpressCompanyMapper.class);

	/**
	 * expressCompany转ExpressCompanyVO
	 *
	 * @param expressCompany expressCompany
	 * @return com.taotao.cloud.uc.api.vo.user.UserVO
	 * @author dengtao
	 * @date 2020/11/11 14:47
	 * @since v1.0
	 */
	ExpressCompanyVO expressCompanyToExpressCompanyVO(ExpressCompany expressCompany);
