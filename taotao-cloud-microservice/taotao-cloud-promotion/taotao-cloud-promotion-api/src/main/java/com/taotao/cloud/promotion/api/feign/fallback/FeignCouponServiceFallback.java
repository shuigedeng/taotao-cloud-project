 ...
 */
public class FeignCouponServiceFallback implements FallbackFactory<IFeignCouponService> {
	@Override
	public IFeignCouponService create(Throwable throwable) {
		return new IFeignCouponService() {
			//@Override
