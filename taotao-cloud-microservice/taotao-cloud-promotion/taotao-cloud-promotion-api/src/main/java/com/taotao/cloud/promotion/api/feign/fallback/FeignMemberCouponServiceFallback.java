 ...
 */
public class FeignMemberCouponServiceFallback implements FallbackFactory<IFeignMemberCouponService> {
	@Override
	public IFeignMemberCouponService create(Throwable throwable) {
		return new IFeignMemberCouponService() {
