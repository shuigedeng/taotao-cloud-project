...
public class KanjiaActivity extends BaseSuperEntity<KanjiaActivity, Long> {
	...
	@Column(name = "kanjia_activity_goods_id", columnDefinition = "varchar(64) not null comment '砍价商品id'")
	private String kanjiaActivityGoodsId;

	@Column(name = "member_id", columnDefinition = "varchar(64) not null comment '发起砍价活动会员id'")
	private String memberId;

	@Column(name = "member_name", columnDefinition = "varchar(64) not null comment '发起砍价活动会员名称'")
	...
	@Column(name = "sku_id", columnDefinition = "varchar(64) not null comment '砍价商品skuId'")
	private String skuId;

	@Column(name = "goods_name", columnDefinition = "varchar(64) not null comment '货品名称'")
	private String goodsName;

	@Column(name = "thumbnail", columnDefinition = "varchar(64) not null comment '缩略图'")
	private String thumbnail;

	/**
	 * @see KanJiaStatusEnum
	 */
	@Column(name = "status", columnDefinition = "varchar(64) not null comment '砍价活动状态'")
