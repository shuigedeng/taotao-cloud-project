...
@TableName(RoleDept.TABLE_NAME)
@org.hibernate.annotations.Table(appliesTo = RoleDept.TABLE_NAME, comment = "角色-部门第三方表")
public class RoleDept extends SuperEntity<RoleDept,Long> {
