 ...
 */
@Repository
public class SysResourceRepository extends BaseSuperRepository<Resource, Long> {
	 ...
	 */
	public List<Resource> findResourceByRoleIds(Set<Long> roleIds) {
	 ...
	 *
	 * @param name name
	 * @return {@link Optional&lt;com.taotao.cloud.sys.biz.entity.SysResource&gt; }
	 * @author shuigedeng
