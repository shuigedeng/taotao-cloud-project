...
import com.taotao.cloud.sys.biz.entity.QSysResource;
import com.taotao.cloud.sys.biz.entity.Resource;
import com.taotao.cloud.sys.biz.mapper.ISysResourceMapper;
import com.taotao.cloud.sys.biz.mapstruct.IResourceMapStruct;
import com.taotao.cloud.sys.biz.repository.cls.SysResourceRepository;
import com.taotao.cloud.sys.biz.repository.inf.ISysResourceRepository;
import com.taotao.cloud.sys.biz.service.ISysResourceService;
import com.taotao.cloud.sys.biz.service.ISysRoleService;
...
public class SysResourceServiceImpl extends
	BaseSuperServiceImpl<ISysResourceMapper, Resource, SysResourceRepository, ISysResourceRepository, Long>
	...
	public List<ResourceBO> findResourceByIdList(List<Long> idList) {
		...
		List<Resource> resources = cr().findResourceByIdList(idList);
	...
	public List<ResourceBO> findResourceByRoleIds(Set<Long> roleIds) {
		List<Resource> resources = cr().findResourceByRoleIds(roleIds);
		return IResourceMapStruct.INSTANCE.resourcesToBos(resources)
			.stream()
