 ...
 */
@Repository
public class SysRoleRepository extends BaseSuperRepository<Role, Long> {
	 ...
	 */
	public List<Role> findRoleByUserIds(Set<Long> userIds) {
	 ...
	 */
	public List<Role> findRoleByCodes(Set<String> codes) {
		return jpaQueryFactory()
			.selectFrom(SYS_ROLE)
