package com.taotao.cloud.sys.biz.api.controller.tools.core.service.connect;
...
import com.taotao.cloud.sys.biz.api.controller.tools.core.exception.SystemMessage;
...
import com.taotao.cloud.sys.biz.api.controller.tools.core.service.connect.events.DeleteSecurityConnectEvent;
import com.taotao.cloud.sys.biz.api.controller.tools.core.service.connect.events.UpdateSecurityConnectEvent;
import com.taotao.cloud.sys.biz.api.controller.tools.core.service.file.FileManager;
import com.taotao.cloud.sys.biz.api.controller.tools.core.aspect.SerializerToFile;
import com.taotao.cloud.sys.biz.api.controller.tools.core.service.connect.dtos.ConnectInput;
import com.taotao.cloud.sys.biz.api.controller.tools.core.service.connect.dtos.ConnectOutput;
import com.taotao.cloud.sys.biz.api.controller.tools.core.service.connect.dtos.ConnectTemplate;
...
//        connectInfoMap.computeIfAbsent(name,key -> new ConcurrentHashMap<>());
    ...
    protected void checkAccess(String module, String connName) {
        if (userService == null){
            log.debug("不需要权限验证,当前用户有连接{}:{}的访问权限",module,connName);
            return ;
        }
