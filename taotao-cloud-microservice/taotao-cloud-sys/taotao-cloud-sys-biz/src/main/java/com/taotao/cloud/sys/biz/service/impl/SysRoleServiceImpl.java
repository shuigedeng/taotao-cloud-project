...
import com.taotao.cloud.sys.biz.entity.QSysRole;
import com.taotao.cloud.sys.biz.entity.Role;
import com.taotao.cloud.sys.biz.mapper.ISysRoleMapper;
import com.taotao.cloud.sys.biz.mapstruct.IRoleMapStruct;
import com.taotao.cloud.sys.biz.repository.cls.SysRoleRepository;
import com.taotao.cloud.sys.biz.repository.inf.ISysRoleRepository;
import com.taotao.cloud.sys.biz.service.ISysRoleResourceService;
...
public class SysRoleServiceImpl extends
	BaseSuperServiceImpl<ISysRoleMapper, Role, SysRoleRepository, ISysRoleRepository, Long>
	implements IDubboRoleService, ISysRoleService {

	private final static QSysRole SYS_ROLE = QSysRole.sysRole;

	private final ISysRoleResourceService sysRoleResourceService;

	public SysRoleServiceImpl(ISysRoleResourceService sysRoleResourceService) {
