...
public class BackendResourceController extends
	SuperController<ISysResourceService, Resource, Long, BaseQuery, ResourceSaveDTO, ResourceUpdateDTO, ResourceQueryVO> {
