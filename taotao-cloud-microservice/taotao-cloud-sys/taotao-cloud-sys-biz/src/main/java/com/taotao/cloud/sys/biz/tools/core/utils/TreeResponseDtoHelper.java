...
import com.taotao.cloud.sys.biz.tools.core.dtos.RootTreeResponseDto;
import com.taotao.cloud.sys.biz.tools.core.dtos.TreeResponseDto;
...
//    }
    ...
    public static List<? extends TreeResponseDto> fastConvertForest(List<? extends TreeResponseDto> treeModels, String rootParentId){
        ...
        if(CollectionUtils.isEmpty(roots)){
	        LogUtil.warn("无根节点，无法生成树，rootParentId:"+rootParentId);
