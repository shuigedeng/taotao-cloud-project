...
public class KafkaEventListener {
	...
	@Component
	public static class ConsumerPartitionPausedEventEventListener implements ApplicationListener<ConsumerPartitionPausedEvent> {
		@Override
	...
	@Component
	public static class ConsumerPartitionResumedEventListener implements ApplicationListener<ConsumerPartitionResumedEvent> {
		@Override
	...
	@Component
	public static class ListenerContainerPartitionIdleEventListener implements ApplicationListener<ListenerContainerPartitionIdleEvent> {
		@Override
		public void onApplicationEvent(ListenerContainerPartitionIdleEvent event) {
			LogUtils.info("KafkaEventListener ----- ListenerContainerPartitionIdleEvent onApplicationEvent {}", event);
