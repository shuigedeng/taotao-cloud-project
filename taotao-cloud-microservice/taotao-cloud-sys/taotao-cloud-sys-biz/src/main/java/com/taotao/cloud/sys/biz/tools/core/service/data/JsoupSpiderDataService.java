...
import com.taotao.cloud.sys.biz.tools.core.service.data.jsoup.Request;
import com.taotao.cloud.sys.biz.tools.core.service.data.jsoup.Select;
...
public class JsoupSpiderDataService {
	 ...
	 * @throws IOException
	 */
	public Object spiderData(String className, ClassLoader classLoader, Map<String, String> params)
	...
	public Object spiderData(Class<?> clazz, Map<String, String> params) throws IOException {
		...
		if (request == null) {
			LogUtil.warn("使用此方法爬取数据,需要类上带有 Request 标记 ");
			return null;
		}
	...
	private Object populate(Class clazz, Element element) {
		...
		while (currentClass != Object.class) {
			try {
				...
				for (Field declaredField : declaredFields) {
					...
					if (elements != null && elements.size() > 0) {
						...
						if (type == List.class) {
							...
							Select listTypeSelect = AnnotationUtils.getAnnotation(listType,
								Select.class);
				...
				LogUtil.error("反射异常[{}]", e.getMessage(), e);
			} finally {
