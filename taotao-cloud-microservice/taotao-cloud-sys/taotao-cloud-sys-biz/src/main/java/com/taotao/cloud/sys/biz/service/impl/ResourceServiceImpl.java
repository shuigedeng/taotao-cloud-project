...
import com.taotao.cloud.sys.biz.entity.QResource;
...
public class ResourceServiceImpl extends
	...
	implements IDubboResourceService, IResourceService {
	...
	public ResourceServiceImpl(IRoleService sysRoleService,
	...
	private final static QResource SYS_RESOURCE = QResource.sysResource;
	...
	public Boolean testSeata() {
		...
		//Resource sysResource = Resource.builder()
		//	.name("资源三")
		//	.type((byte) 1)
		//	.parentId(0L)
		//	.sortNum(2)
		...
		//Resource resourceById = findResourceById(37L);
	...
	public Future<Boolean> testAsync() {
		long start = tem.currentTimeMillis();

		try {
			//Resource resourceById = findResourceById(51L);
			//LogUtil.info("resourceById ======> ", resourceById);
