...
public class NetUtil {
    ...
    public static boolean isHostConnectable(String host, int port) {
        ...
        try {
	        ...
	        LogUtil.error("isHostConnectable[{}:{}] connect fail : {}",host,port,e.getMessage());
            return false;
        } finally {
            try {
                socket.close();
    ...
    public static boolean isHostReachable(String host, Integer timeOut) {
        try {
           ...
           LogUtil.error("isHostReachable () error : {}",e.getMessage(),e);
        }
        return false;
    }
    ...
    public static List<String> getLocalIPs() {
        ...
        try {
	        ...
	        LogUtil.error("getLocalIPs() error : {}",e.getMessage(),e);
        }
        return ipList;
    }
