...
import com.taotao.cloud.recommend.api.feign.fallback.FeignRecommendFallback;
 ...
 */
@FeignClient(contextId = "RemoteProductService", value = ServiceName.TAOTAO_CLOUD_GOODS, fallbackFactory = FeignRecommendFallback.class)
public interface IFeignRecommendService {
