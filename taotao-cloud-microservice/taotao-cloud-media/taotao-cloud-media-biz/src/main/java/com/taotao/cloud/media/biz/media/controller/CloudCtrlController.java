...
//		boolean imgSavePath = Control.getImgSavePath(camera.getIp(), "D:\\tempFile\\3.jpg");
		...
		if (StrUtil.equals(camera.getOp(), "up")) {
			// 制摄像机云台控制(开启)
			Control.cloudControl(camera.getIp(), CloudCode.TILT_UP, CloudCode.SPEED_LV6,
					CloudCode.START);
			try {
				// 让云台运行1000ms
				Thread.sleep(1000);
			...
			// 制摄像机云台控制(开启)
			Control.cloudControl(camera.getIp(), CloudCode.TILT_DOWN, CloudCode.SPEED_LV6,
					CloudCode.START);
			try {
				// 让云台运行1000ms
				Thread.sleep(1000);
			...
			// 制摄像机云台控制(开启)
			Control.cloudControl(camera.getIp(), CloudCode.PAN_LEFT, CloudCode.SPEED_LV6,
					CloudCode.START);
			try {
				// 让云台运行1000ms
				Thread.sleep(1000);
			...
			// 制摄像机云台控制(开启)
			Control.cloudControl(camera.getIp(), CloudCode.PAN_RIGHT, CloudCode.SPEED_LV6,
					CloudCode.START);
			try {
				// 让云台运行1000ms
				Thread.sleep(1000);
			...
			// 制摄像机云台控制(开启)
			Control.cloudControl(camera.getIp(), CloudCode.UP_LEFT, CloudCode.SPEED_LV6,
					CloudCode.START);
			try {
				// 让云台运行1000ms
				Thread.sleep(1000);
			...
			// 制摄像机云台控制(开启)
			Control.cloudControl(camera.getIp(), CloudCode.DOWN_LEFT, CloudCode.SPEED_LV6,
					CloudCode.START);
			try {
				// 让云台运行1000ms
				Thread.sleep(1000);
			...
			// 制摄像机云台控制(开启)
			Control.cloudControl(camera.getIp(), CloudCode.UP_RIGHT, CloudCode.SPEED_LV6,
					CloudCode.START);
			try {
				// 让云台运行1000ms
				Thread.sleep(1000);
			...
			// 制摄像机云台控制(开启)
			Control.cloudControl(camera.getIp(), CloudCode.DOWN_RIGHT, CloudCode.SPEED_LV6,
					CloudCode.START);
			try {
				// 让云台运行1000ms
				Thread.sleep(1000);
			...
			// 制摄像机云台控制(开启)
			Control.cloudControl(camera.getIp(), CloudCode.ZOOM_IN, CloudCode.SPEED_LV6,
					CloudCode.START);
			try {
				// 让云台运行1000ms
				Thread.sleep(1000);
			...
			// 制摄像机云台控制(开启)
			Control.cloudControl(camera.getIp(), CloudCode.ZOOM_OUT, CloudCode.SPEED_LV6,
					CloudCode.START);
			try {
				// 让云台运行1000ms
				Thread.sleep(1000);
	...
	private void checkLogin(CameraCtrl camera) {
		...
		if (null == nativeLong) {
			...
			// 输入摄像机ip，端口，账户，密码登录
			try {
				boolean doLogin = lp.doLogin(camera.getIp(),
						Convert.toShort(camera.getPort(), (short) 8000), camera.getUsername(),
						camera.getPassword());
			} catch (Exception e) {
				e.printStackTrace();
			}
