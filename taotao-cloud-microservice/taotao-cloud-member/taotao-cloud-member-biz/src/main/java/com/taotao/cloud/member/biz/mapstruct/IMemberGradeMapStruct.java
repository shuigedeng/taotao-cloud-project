...
public interface IMemberGradeMapStruct {

	/**
	 * 实例
	 */
	IMemberGradeMapStruct INSTANCE = Mappers.getMapper(IMemberGradeMapStruct.class);


	MemberGradeVO memberGradeToMemberGradeVO(MemberGrade memberGrade);
