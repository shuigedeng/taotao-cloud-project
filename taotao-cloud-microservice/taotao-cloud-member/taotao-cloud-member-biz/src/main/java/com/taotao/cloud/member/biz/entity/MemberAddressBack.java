...
public class MemberAddressBack extends JpaSuperEntity {
	...
	public boolean equals(Object o) {
		...
		MemberAddressBack that = (MemberAddressBack) o;
	...
	public MemberAddressBack() {
	}

	public MemberAddressBack(Long memberUserId, String receiverName, String phone,
	...
	public MemberAddressBack(Long id, Long createBy, Long lastModifiedBy,
	...
	public static final class MemberAddressBuilder {
		...
		public MemberAddressBack build() {
			MemberAddressBack memberAddress = new MemberAddressBack(memberUserId, receiverName, phone,
