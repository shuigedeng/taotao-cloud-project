...
@RequestMapping("/member/buyer/passport/member")
public class MemberPcController {
	...
	@PostMapping("/login")
	public ResultMessage<Object> userLogin(
	...
	public ResultMessage<Member> resetByMobile(
	...
	@PreAuthorize("@el.check('admin','timing:list')")
	@PutMapping("/password")
	public ResultMessage<Object> resetByMobile(
	...
	public ResultMessage<Member> modifyPass(
