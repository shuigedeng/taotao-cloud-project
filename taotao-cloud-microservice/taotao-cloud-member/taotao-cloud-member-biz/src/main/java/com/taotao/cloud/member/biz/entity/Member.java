...
public class Member extends JpaSuperEntity {
	...
	public Member(String nickname, String username, String phone, String password,
	...
	public Member(Long id, Long createBy, Long lastModifiedBy, LocalDateTime createTime,
