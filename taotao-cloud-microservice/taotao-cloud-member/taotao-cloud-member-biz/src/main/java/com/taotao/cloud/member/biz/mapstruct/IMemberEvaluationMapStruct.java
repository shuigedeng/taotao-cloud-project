...
public interface IMemberEvaluationMapStruct {

	/**
	 * 实例
	 */
	IMemberEvaluationMapStruct INSTANCE = Mappers.getMapper(IMemberEvaluationMapStruct.class);


	MemberEvaluationVO memberEvaluationToMemberEvaluationVO(MemberEvaluation memberEvaluation);
