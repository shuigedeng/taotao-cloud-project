...
public class McpGaphConfiguration {
    ...
    @Autowired private McpClientToolCallbackProvider mcpClientToolCallbackProvider;
        ...
        StateGraph stateGraph =
                new StateGraph(keyStrategyFactory)
                        .addNode(
                                ...
                                node_async(
                                        new McpNode(
                                                chatClientBuilder, mcpClientToolCallbackProvider)))
                        .addEdge(StateGraph.START, "mcp")
                        .addEdge("mcp", StateGraph.END);

        // 添加 PlantUML 打印
        GraphRepresentation representation =
                stateGraph.getGraph(GraphRepresentation.Type.PLANTUML, "mcp flow");
        logger.info("\n=== mcp UML Flow ===");
