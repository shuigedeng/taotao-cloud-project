...
package com.taotao.cloud.ai.alibaba.graph.stream_node.controller.GraphProcess;
...
public class GraphProcess {
    ...
    public void processStream(
            AsyncGenerator<NodeOutput> generator, Sinks.Many<ServerSentEvent<String>> sink) {
        executor.submit(
                () -> {
                    generator
                            .forEachAsync(
