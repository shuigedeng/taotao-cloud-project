 ...
 */
package com.taotao.cloud.opencv.api.vo;
...
public class FileVO implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(id, fileVO.id) && Objects.equals(bizId, fileVO.bizId)
			&& Objects.equals(bizType, fileVO.bizType) && Objects.equals(dataType,
			fileVO.dataType) && Objects.equals(originalFileName, fileVO.originalFileName)
			&& Objects.equals(url, fileVO.url) && Objects.equals(fileMd5,
			fileVO.fileMd5) && Objects.equals(contextType, fileVO.contextType)
			&& Objects.equals(filename, fileVO.filename) && Objects.equals(ext,
			fileVO.ext) && Objects.equals(size, fileVO.size) && Objects.equals(
			createTime, fileVO.createTime) && Objects.equals(lastModifiedTime,
			fileVO.lastModifiedTime);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, bizId, bizType, dataType, originalFileName, url, fileMd5,
			contextType,
			filename, ext, size, createTime, lastModifiedTime);
	}
	...
	public FileVO(Long id, Long bizId, String bizType, String dataType,
		String originalFileName, String url, String fileMd5, String contextType,
		String filename, String ext, Long size, LocalDateTime createTime,
