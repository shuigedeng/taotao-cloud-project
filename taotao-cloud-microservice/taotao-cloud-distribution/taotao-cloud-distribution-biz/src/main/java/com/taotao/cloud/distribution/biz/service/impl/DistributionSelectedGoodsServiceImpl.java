 ...
 */
@Service
public class DistributionSelectedGoodsServiceImpl extends
	ServiceImpl<DistributionSelectedGoodsMapper, DistributionSelectedGoods> implements
	IDistributionSelectedGoodsService {
	...
	public boolean add(String distributionGoodsId) {
		...
		DistributionSelectedGoods distributionSelectedGoods = new DistributionSelectedGoods(
			distributionId, distributionGoodsId);
