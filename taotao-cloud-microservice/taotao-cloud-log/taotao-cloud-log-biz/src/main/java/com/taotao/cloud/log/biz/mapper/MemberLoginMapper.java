...
public interface MemberLoginMapper {
	...
	MemberLoginMapper INSTANCE = Mappers.getMapper(MemberLoginMapper.class);

	/**
	 * memberLogin转MemberLoginVO
	 *
	 * @param memberLogin memberLogin
	 * @return com.taotao.cloud.uc.api.vo.user.UserVO
	 * @author dengtao
	 * @date 2020/11/11 14:47
	 * @since v1.0
	 */
	MemberLoginVO memberLoginToMemberLoginVO(MemberLogin memberLogin);
