...
@MapperScan(
        basePackages = "com.taotao.cloud.data.analysis.doris.mapper",
...
public class DorisDataSourceConfiguration {
    ...
    public SqlSessionFactory mysqlSqlSessionFactory(@Qualifier("dorisDruidDataSource") DataSource dataSource)
            throws Exception {
