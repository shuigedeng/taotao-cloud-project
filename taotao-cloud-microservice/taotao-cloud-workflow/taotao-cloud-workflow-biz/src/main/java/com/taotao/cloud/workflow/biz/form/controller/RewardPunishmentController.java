...
import com.taotao.cloud.workflow.api.common.model.form.rewardpunishment.RewardPunishmentForm;
import com.taotao.cloud.workflow.api.common.model.form.rewardpunishment.RewardPunishmentInfoVO;
...
public class RewardPunishmentController {
    ...
    public Result<RewardPunishmentInfoVO> info(@PathVariable("id") String id, String taskOperatorId) throws DataException {
        ...
        if (isData) {
            ...
            vo = JsonUtils.getJsonToBean(entity, RewardPunishmentInfoVO.class);
        }
