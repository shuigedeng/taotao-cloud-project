...
import com.taotao.cloud.workflow.api.common.model.form.officesupplies.OfficeSuppliesForm;
import com.taotao.cloud.workflow.api.common.model.form.officesupplies.OfficeSuppliesInfoVO;
...
public class OfficeSuppliesController {
    ...
    @GetMapping("/{id}")
    public Result<OfficeSuppliesInfoVO> info(@PathVariable("id") String id, String taskOperatorId) throws DataException {
        ...
        if (isData) {
            ...
            vo = JsonUtils.getJsonToBean(entity, OfficeSuppliesInfoVO.class);
        }
    ...
    @PutMapping("/{id}")
    public Result update(@RequestBody OfficeSuppliesForm officeSuppliesForm, @PathVariable("id") String id) throws WorkFlowException {
        OfficeSuppliesEntity entity = JsonUtils.getJsonToBean(officeSuppliesForm, OfficeSuppliesEntity.class);
        if (FlowStatusEnum.save.getMessage().equals(officeSuppliesForm.getStatus())) {
