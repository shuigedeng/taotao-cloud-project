...
import com.taotao.cloud.workflow.api.common.model.visiual.FormCloumnUtil;
...
public class FlowDynamicServiceImpl implements FlowDynamicService {
	...
	public FlowTaskInfoVO info(FlowTaskEntity entity, String taskOperatorId)
		...
		List<TableModel> tableModelList = JsonUtils.toList(flowEntity.getFlowTables(),
				TableModel.class);
		...
		if (infoData) {
			//formTempJson
			FormDataModel formData = JsonUtils.toObject(entity.getFlowForm(),
					FormDataModel.class);
	...
	public void save(String id, FlowTaskForm flowTaskForm) throws WorkFlowException {
		...
		//表单值
		Map<String, Object> dataMap = JsonUtils.toMap(data);
