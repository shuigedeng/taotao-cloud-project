...
public class IncomeRecognitionController {
	...
	@GetMapping("/{id}")
	public Result<IncomeRecognitionInfoVO> info(@PathVariable("id") String id,
	...
	public Result create(@RequestBody @Valid IncomeRecognitionForm incomeRecognitionForm)
		...
		IncomeRecognitionEntity entity = JsonUtils.getJsonToBean(incomeRecognitionForm,
				IncomeRecognitionEntity.class);
		...
		incomeRecognitionService.submit(entity.getId(), entity,
				incomeRecognitionForm.getCandidateList());
	...
	@Operation("修改收入确认分析表")
	@PutMapping("/{id}")
	public Result update(@RequestBody @Valid IncomeRecognitionForm incomeRecognitionForm,
