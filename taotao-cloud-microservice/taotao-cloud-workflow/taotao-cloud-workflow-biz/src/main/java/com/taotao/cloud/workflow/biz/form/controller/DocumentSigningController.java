...
public class DocumentSigningController {
	...
	public Result create(@RequestBody @Valid DocumentSigningForm documentSigningForm)
		...
		DocumentSigningEntity entity = JsonUtils.getJsonToBean(documentSigningForm,
				DocumentSigningEntity.class);
		...
		documentSigningService.submit(entity.getId(), entity,
				documentSigningForm.getCandidateList());
	...
	@Operation("修改文件签阅表")
	@PutMapping("/{id}")
	public Result update(@RequestBody @Valid DocumentSigningForm documentSigningForm,
