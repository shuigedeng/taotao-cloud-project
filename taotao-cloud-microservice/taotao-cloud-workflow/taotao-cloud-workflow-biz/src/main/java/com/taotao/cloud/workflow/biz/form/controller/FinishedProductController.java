...
public class FinishedProductController {
	...
	public Result<FinishedProductInfoVO> info(@PathVariable("id") String id, String taskOperatorId)
		...
		if (isData) {
			...
			List<FinishedProductEntryEntity> entityList = finishedProductService.getFinishedEntryList(
					id);
	...
	public Result create(@RequestBody @Valid FinishedProductForm finishedProductForm)
			throws WorkFlowException {
		FinishedProductEntity finished = JsonUtils.getJsonToBean(finishedProductForm,
				FinishedProductEntity.class);
		List<FinishedProductEntryEntity> finishedEntryList = JsonUtils.getJsonToList(
	...
	@Operation("修改成品入库单")
	@PutMapping("/{id}")
	public Result update(@RequestBody @Valid FinishedProductForm finishedProductForm,
