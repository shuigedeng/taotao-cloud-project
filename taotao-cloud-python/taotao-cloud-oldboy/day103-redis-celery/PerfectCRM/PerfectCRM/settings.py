...
SECRET_KEY = 'q1s178q$i-k@vn*^*5^-3i%=ihx*2ir11(n9#tnm&d^mffm0#!'
...
#for celery
CELERY_BROKER_URL = 'redis://:alex3714@192.168.14.52'
CELERY_RESULT_BACKEND = 'redis://:alex3714@192.168.14.52'
