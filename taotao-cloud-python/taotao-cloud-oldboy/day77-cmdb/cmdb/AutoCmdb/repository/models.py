...
class BusinessUnit(models.Model):
    ...
    contact = models.ForeignKey('UserGroup', verbose_name='业务联系人', related_name='c', on_delete=None) # 多个人
    manager = models.ForeignKey('UserGroup', verbose_name='系统管理员', related_name='m', on_delete=None) # 多个人
...
class Disk(models.Model):
    ...
    server_obj = models.ForeignKey('Server',related_name='disk', on_delete=None)
...
class NIC(models.Model):
    ...
    server_obj = models.ForeignKey('Server',related_name='nic', on_delete=None)
...
class Memory(models.Model):
    ...
    server_obj = models.ForeignKey('Server',related_name='memory', on_delete=None)
...
class AssetRecord(models.Model):
    ...
    """
    asset_obj = models.ForeignKey('Asset', related_name='ar', on_delete=None)
