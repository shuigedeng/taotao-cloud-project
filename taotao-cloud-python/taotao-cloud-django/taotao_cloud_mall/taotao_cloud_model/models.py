...
class Card(models.Model):
    ...
    status = models.CharField(choices=STATUS_CHOICES,default='used',help_text='状态')
    orderValue = models.IntegerField(null=False, default=0, help_text='排序')
    userId = models.BigIntegerField(null=False)
    createdAt = models.DateTimeField(null=False,
                                     default=datetime.datetime.now(),
...
class Config(models.Model):
    ...
    type = models.CharField(choices=TYPE_CHOICES,default='string',help_text='状态')
    ...
    decimal5with5 = models.DecimalField(decimal_places=5,default=0.0,help_text='decimal5with5')
    orderValue = models.IntegerField(null=False, default=0, help_text='排序')
    userId = models.BigIntegerField(null=False)
