package com.taotao.cloud.distributed.tx.rm.interceptor;
...
public class GroupIdRespAdvice implements ResponseBodyAdvice {
    ...
    public Object beforeBodyWrite(Object body, MethodParameter methodParameter,
        ...
        if (ZhuziTxParticipant.getCurrentGroupId() != null){
            ...
            response.getHeaders().set("transactionalCount",String.valueOf(ZhuziTxParticipant.getTransactionCount()));
        }
        return body;
    }
}
