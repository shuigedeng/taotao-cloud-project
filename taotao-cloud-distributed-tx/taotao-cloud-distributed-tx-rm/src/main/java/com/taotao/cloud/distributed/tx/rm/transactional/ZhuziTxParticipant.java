package com.taotao.cloud.distributed.tx.rm.transactional;

import com.alibaba.fastjson.JSONObject;
import com.zhuzi.distributedtx.netty.NettyClient;
import com.zhuzi.distributedtx.util.ApplicationContextProvider;
...
public class ZhuziTxParticipant {
    ...
    public static String createZhuziTransactionalManagerGroup(){
        ...
        System.err.println("创建事务组：" + Thread.currentThread().getId() + "，事务组ID：" + getCurrentGroupId());
        // 通过JSON做序列化
