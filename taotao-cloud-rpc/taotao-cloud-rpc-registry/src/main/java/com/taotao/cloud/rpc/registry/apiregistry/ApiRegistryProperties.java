...
//        return StringUtils.spilt(PropertyUtils.getPropertyCache("ttc.apiRegistry.{appName}.hosts".replace("{appName}",appName),""),",");
//    }
//
//    public static Integer getHttpUrlConnectionConnectTimeOut(){
//        return PropertyUtils.getPropertyCache("ttc.apiRegistry.rpcClient.httpUrlConnection.connectTimeOut",3000);
//    }
//    public static Integer getHttpUrlConnectionReadTimeOut(){
//        return PropertyUtils.getPropertyCache("ttc.apiRegistry.rpcClient.httpUrlConnection.readTimeOut",60000);
//    }
//    public static Boolean getHttpUrlConnectionPoolEnabled(){
//        return PropertyUtils.getPropertyCache("ttc.apiRegistry.rpcClient.httpUrlConnection.poolEnabled",true);
//    }
//    public static String getRpcClientType(){
//        return PropertyUtils.getPropertyCache("ttc.apiRegistry.rpcClient.type","HttpUrlConnectionRpcClient");
//    }
//    public static String[] getRpcClientBasePackages(){
//        return StringUtils.spilt(PropertyUtils.getPropertyCache("ttc.apiRegistry.rpcClient.basePackages",""),",");
//    }
//    //重写beanName命名规则
//    public static Boolean getRpcClientTypeBeanNameEnabled(){
//        return PropertyUtils.getPropertyCache("ttc.apiRegistry.rpcClient.typeBeanName.enabled",true);
//    }
...
//        return PropertyUtils.getPropertyCache("ttc.apiRegistry.rcpClient.failRetryTimeSpan",30000);
//    }
//    public static String getRegistryType(){
//        return PropertyUtils.getPropertyCache("ttc.apiRegistry.registry.type","RedisRegistry");
//    }
//    public static boolean getRegistryClientRegistered(){
//        return PropertyUtils.getPropertyCache("ttc.apiRegistry.registry.clientRegistered",true);
//    }
...
//        return PropertyUtils.getPropertyCache("ttc.apiRegistry.registry.redis.heartBeatTime",3000);
//    }
...
//        return PropertyUtils.getPropertyCache("ttc.apiRegistry.registry.nacos.serverListCache.heartBeatTime",10000);
//    }
//    public static String getRegistryLoadBalanceType(){
//        return PropertyUtils.getPropertyCache("ttc.apiRegistry.loadBalance.type","RoundRobinLoadBalance");
//    }
