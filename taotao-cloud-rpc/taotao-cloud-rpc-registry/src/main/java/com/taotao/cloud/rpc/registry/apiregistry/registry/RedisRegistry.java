...
//        jedis = new Jedis(hostPort.split(":")[0], ConvertUtils.convert(hostPort.split(":")[1], Integer.class));
    ...
    public void register() {
        ...
        //                 heartBeat();
        //             } catch (Exception e) {
        //                 LogUtils.error(RedisRegistry.class, ApiRegistryProperties.Project, "redis心跳出错");
        //             }
        //         });
        //         int sleepTime = ApiRegistryProperties.getRegistryRedisHeartBeatTime()-timeSpan.intValue();
    ...
    private void heartBeat() {
        synchronized (lock) {
            if (running && jedis != null) {
                ...
                //         jedis.set(getClientKey(), WebUtils.getHost(), SetParams.setParams().ex(ApiRegistryProperties.getRegistryRedisExpireTime()));
                //     }
                // }
                //刷新本地缓存列表
                refreshServerList();
