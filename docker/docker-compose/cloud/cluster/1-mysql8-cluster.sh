...
mysql -uroot -p -h127.0.0.1 -P3316
...
stop slave;
change master to master_host='127.0.0.1',master_port=3376,master_user='slave',master_password='123456',master_log_file='mysql-bin.000003',master_log_pos=1611;
start slave;
