...
function stop_redis() {
  /opt/cloud/redis_cluster/redis-6.0.9/src/redis-cli -p 7100 -h 192.168.10.220 shutdown 2>/dev/null
  /opt/cloud/redis_cluster/redis-6.0.9/src/redis-cli -p 7101 -h 192.168.10.220 shutdown 2>/dev/null
  /opt/cloud/redis_cluster/redis-6.0.9/src/redis-cli -p 7102 -h 192.168.10.220 shutdown 2>/dev/null
  /opt/cloud/redis_cluster/redis-6.0.9/src/redis-cli -p 7103 -h 192.168.10.220 shutdown 2>/dev/null
  /opt/cloud/redis_cluster/redis-6.0.9/src/redis-cli -p 7104 -h 192.168.10.220 shutdown 2>/dev/null
  /opt/cloud/redis_cluster/redis-6.0.9/src/redis-cli -p 7105 -h 192.168.10.220 shutdown 2>/dev/null
