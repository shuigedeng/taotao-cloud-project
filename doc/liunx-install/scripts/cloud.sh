...
function start_cloud() {
  ...
  # tpc -> 7100 -> 7105
  /root/script/redis_cluster.sh start
  ...
  # http -> 8848 http://127.0.0.1:8848/nacos  nacos/nacos
  ...
  # tcp/http -> 8849 http://127.0.0.1:8849 sentinel/sentinel
  /root/script/sentinel.sh start

  # tcp/http -> 9411 http://127.0.0.1:9411
  /root/script/zipkin.sh start

  # tcp -> 11800
  # http -> 18080 http://127.0.0.1:28080
  /root/script/skywalking.sh start

  # tcp/http -> 5601 http://127.0.0.1:8081
  /root/script/arthas.sh start

  # tcp/http -> 9090 http://127.0.0.1:9090 http://127.0.0.1:9090/metrics
  /root/script/prometheus.sh start

  # tcp/http -> 3000 http://127.0.0.1:3000 admin/admin
  /root/script/grafana.sh start

  # tcp/http -> 9200 http://127.0.0.1:9200
  su - elasticsearch -c "/home/elasticsearch/elasticsearch.sh start"

  # tcp/http -> 5601 http://127.0.0.1:5601
  /root/script/kibana.sh start

  # tcp/http -> 8089 http://127.0.0.1:8089
...
function stop_cloud() {
  ...
  /root/script/redis_cluster.sh stop
