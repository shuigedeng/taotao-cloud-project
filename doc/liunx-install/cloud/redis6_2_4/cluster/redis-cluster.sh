...
function stop_redis() {
  /opt/cloud/redis_cluster/redis-6.0.9/src/redis-cli -p 7100 -h 127.0.0.1 shutdown 2>/dev/null
  /opt/cloud/redis_cluster/redis-6.0.9/src/redis-cli -p 7101 -h 127.0.0.1 shutdown 2>/dev/null
  /opt/cloud/redis_cluster/redis-6.0.9/src/redis-cli -p 7102 -h 127.0.0.1 shutdown 2>/dev/null
  /opt/cloud/redis_cluster/redis-6.0.9/src/redis-cli -p 7103 -h 127.0.0.1 shutdown 2>/dev/null
  /opt/cloud/redis_cluster/redis-6.0.9/src/redis-cli -p 7104 -h 127.0.0.1 shutdown 2>/dev/null
  /opt/cloud/redis_cluster/redis-6.0.9/src/redis-cli -p 7105 -h 127.0.0.1 shutdown 2>/dev/null
