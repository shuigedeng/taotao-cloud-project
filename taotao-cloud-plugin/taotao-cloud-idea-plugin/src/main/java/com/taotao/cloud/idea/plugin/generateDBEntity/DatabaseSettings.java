...
public class DatabaseSettings implements PersistentStateComponent<DatabaseSettings> {
    ...
    public String getAnnotationOption() { return annotationOption; }
    public void setAnnotationOption(String annotationOption) { this.annotationOption = annotationOption; }
