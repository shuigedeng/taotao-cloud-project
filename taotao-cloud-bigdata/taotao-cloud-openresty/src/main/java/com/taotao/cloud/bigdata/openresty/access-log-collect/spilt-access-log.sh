...
default(){
  echo "use default"
  echo "log_file=/opt/access-log-collect/logs/access-log-collect.access.log"
  echo "data_dir=/opt/access-log-collect/logs/data/"
  echo "pid_file=/opt/access-log-collect/logs/nginx.pid"

  log_file="/opt/access-log-collect/logs/access-log-collect.access.log"
  data_dir="/opt/access-log-collect/logs/data/"
  pid_file="/opt/access-log-collect/logs/nginx.pid"
}
