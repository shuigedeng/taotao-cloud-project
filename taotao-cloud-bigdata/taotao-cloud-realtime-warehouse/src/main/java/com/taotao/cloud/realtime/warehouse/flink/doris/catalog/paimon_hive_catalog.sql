...
create catalog paimon with (
    'type' = 'paimon',
    'warehouse' = 'file:///home/bigdata/paimon/warehouse'
);
...
CREATE TABLE kafka_source (
    ...
    'properties.bootstrap.servers' = '192.168.218.3:9092', -- Kafka服务器地址
...
CREATE TABLE IF NOT EXISTS ods_log_full(
    ...
    'url' = 'jdbc:mysql://192.168.218.3:9030/ods', -- Doris的JDBC连接URL
