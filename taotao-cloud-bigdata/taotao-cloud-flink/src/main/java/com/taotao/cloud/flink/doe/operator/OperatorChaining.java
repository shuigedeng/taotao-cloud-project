...
public class OperatorChaining {
   ...
   // 4  组成(单词 , 1)
      ...
      // 新的ds   32
        SingleOutputStreamOperator<Tuple2<String, Integer>> ds5 = ds4.map(e -> e).returns(TypeInformation.of(new TypeHint<Tuple2<String, Integer>>() {}))
                .disableChaining()
                ;
        SingleOutputStreamOperator<Tuple2<String, Integer>> ds6 = ds5.map(e -> e).returns(TypeInformation.of(new TypeHint<Tuple2<String, Integer>>() {
        }));
