package com.taotao.cloud.bigdata.flink.doe.sink;
...
public class Sink05ExcatlyOnce {
    public static void main(String[] args) throws Exception {
         ...
         *
         */
        SinkFunction<HeroBean> sink = JdbcSink.exactlyOnceSink(sql, jdbcStatementBuilder, executionOptions, exactlyOnceOptions, serializableSupplier);
