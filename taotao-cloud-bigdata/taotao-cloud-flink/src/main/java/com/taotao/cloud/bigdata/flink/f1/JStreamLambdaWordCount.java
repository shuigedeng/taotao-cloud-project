...
public class JStreamLambdaWordCount {
	public static void main(String[] args) throws Exception {
		...
		DataStream<Tuple2<String, Integer>> dso = dss.flatMap((FlatMapFunction<String, Tuple2<String, Integer>>) (value, out) -> {
		...
		KeyedStream<Tuple2<String, Integer>, String> kst = dso.keyBy(new KeySelector<Tuple2<String, Integer>, String>() {
			@Override
