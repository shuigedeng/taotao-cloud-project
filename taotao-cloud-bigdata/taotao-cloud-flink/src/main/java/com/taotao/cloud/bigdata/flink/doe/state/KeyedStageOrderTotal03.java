...
public class KeyedStageOrderTotal03 {
    public static void main(String[] args) throws Exception {
        ...
        // 计算城市,总额,最大金额
        keyed.map(new RichMapFunction<Tuple2<String, Double>, Tuple3<String, Double, Double>>() {
            ListState<Double> listState;

            @Override
            public void open(Configuration parameters) throws Exception {
                ListStateDescriptor<Double> listStateDescriptor = new ListStateDescriptor<>("moneys", TypeInformation.of(Double.class));
            ...
            @Override
            public Tuple3<String, Double, Double> map(Tuple2<String, Double> value) throws Exception {
