package com.taotao.cloud.bigdata.flink.doe.high;
...
public class FunctionProcess {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<String> res1 = ds2.process(new ProcessFunction<String, String>() {
            /**
             *
        ...
        ds2.process(new ProcessFunction<String, String>() {
            @Override
            public void processElement(String value, ProcessFunction<String, String>.Context ctx, Collector<String> out) throws Exception {
