...
public class WindowsFunctionsAllTopN {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<OrdersBean> res = window.process(new ProcessWindowFunction<OrdersBean, OrdersBean, String, TimeWindow>() {
            @Override
            public void process(String key , ProcessWindowFunction<OrdersBean, OrdersBean, String, TimeWindow>.Context context, Iterable<OrdersBean> elements, Collector<OrdersBean> out) throws Exception {
                ...
                list.sort(new Comparator<OrdersBean>() {
                    @Override
