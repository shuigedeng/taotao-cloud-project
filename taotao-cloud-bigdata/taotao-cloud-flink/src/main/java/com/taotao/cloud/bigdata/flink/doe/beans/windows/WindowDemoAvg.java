...
public class WindowDemoAvg {
    public static void main(String[] args) throws Exception {
         ...
         * 3 最终的输出结果类型
         */
        SingleOutputStreamOperator<Tuple2<String, Double>> res = window.aggregate(new AggregateFunction<OrdersBean, Tuple3<String, Double, Integer>, Tuple2<String, Double>>() {
            // 中间 缓存的默认值
            @Override
            ...
            public Tuple3<String, Double, Integer> add(OrdersBean value, Tuple3<String, Double, Integer> accumulator) {
                ...
                return Tuple3.of(accumulator.f0, accumulator.f1 + money, accumulator.f2 + 1);
            }
