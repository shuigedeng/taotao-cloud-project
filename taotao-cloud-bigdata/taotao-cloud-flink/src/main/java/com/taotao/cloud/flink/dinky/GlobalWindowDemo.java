...
public class GlobalWindowDemo {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> text = env.addSource(new com.taotao.cloud.flink.flink.part4_flink_window.GlobalWindowDemo.DataGeneratorSourceFunction());
        ...
        DataStream<Tuple2<String, Integer>> globalWindowedStream = withWatermarks
                ...
                .process(new com.taotao.cloud.flink.flink.part4_flink_window.GlobalWindowDemo.CountProcessFunction());
