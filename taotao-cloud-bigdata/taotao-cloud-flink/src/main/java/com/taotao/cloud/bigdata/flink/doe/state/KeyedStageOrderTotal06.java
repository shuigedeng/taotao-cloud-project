package com.taotao.cloud.bigdata.flink.doe.state;
...
public class KeyedStageOrderTotal06 {
    public static void main(String[] args) throws Exception {
       ...
       //每个城市的订单总额
        keyed.process(new ProcessFunction<Tuple3<String, String, Double>, Tuple4<String,String,Double , Integer>>() {

            AggregatingState<Tuple2<String, Double>, Tuple3<String, Double, Integer>> aggregatingState  ;
            @Override
            public void processElement(Tuple3<String, String, Double> value, ProcessFunction<Tuple3<String, String, Double>, Tuple4<String,String,Double , Integer>>.Context ctx, Collector<Tuple4<String,String,Double , Integer>> out) throws Exception {
                aggregatingState.add(Tuple2.of(value.f1 , value.f2));
                //返回类别 总额  总个数
                Tuple3<String, Double, Integer> stringDoubleIntegerTuple3 = aggregatingState.get();
                out.collect(Tuple4.of(value.f0 ,stringDoubleIntegerTuple3.f0 , stringDoubleIntegerTuple3.f1 , stringDoubleIntegerTuple3.f2 ));
            }
            ...
            public void open(Configuration parameters) throws Exception {
                 ...
                 *
                 */
                AggregatingStateDescriptor<Tuple2<String,Double> ,Tuple3<String,Double,Integer> ,Tuple3<String,Double,Integer>> agg =  new AggregatingStateDescriptor<Tuple2<String,Double> ,Tuple3<String,Double,Integer> ,Tuple3<String,Double,Integer>>(
                        "agg",
                        new AggregateFunction<Tuple2<String, Double>, Tuple3<String, Double, Integer>, Tuple3<String, Double, Integer>>() {
                    @Override
