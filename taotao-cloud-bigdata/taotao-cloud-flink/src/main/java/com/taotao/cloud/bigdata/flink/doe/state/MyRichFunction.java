 ...
 * @Description:
 */
public class MyRichFunction extends RichMapFunction<String, String>  implements CheckpointedFunction {
    ...
    public void initializeState(FunctionInitializationContext context) throws Exception {
        ...
        // 底层  类似 list 结构存储数据
        ListStateDescriptor listStateDescriptor = new ListStateDescriptor("cnt", TypeInformation.of(Integer.class));
