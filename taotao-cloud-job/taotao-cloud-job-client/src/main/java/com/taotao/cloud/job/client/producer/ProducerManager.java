...
public class ProducerManager {
    ...
    public ProducerManager(List<String> nameServerAddressList) {
        ...
        ThreadFactory producerExecuteFactory = new ThreadFactoryBuilder()
                .setNameFormat("ttcjob-producer-send-%d")
                .build();
        ...
        ThreadFactory invokeCallbackExecuteFactory = new ThreadFactoryBuilder()
                .setNameFormat("ttcjob-invokeCallback-%d")
                .build();
        invokeCallbackExecute = new ThreadPoolExecutor(
                availableProcessors * 10,
                availableProcessors * 10,
                120L,
                TimeUnit.SECONDS,
