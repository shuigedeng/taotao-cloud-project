...
public class TtcJobTemplate {
    ...
    public Long createJob(JobUpdateReq JobUpdateReq) {
        ...
        MqCausa.CreateJobReq build = MqCausa.CreateJobReq.newBuilder()
                ...
                .setTimeExpressionType(
                        TimeExpressionType.getProtoBufTimeExpressionType(JobUpdateReq.getTimeExpressionType()))
                ...
                .build();
        MqCausa.Message build1 = MqCausa.Message.newBuilder()
    ...
    public void deleteJob(JobDeleteReq jobDeleteReq) {
        MqCausa.DeleteJobReq build = MqCausa.DeleteJobReq.newBuilder()
                .setJobId(jobDeleteReq.getJobId())
                .build();
        MqCausa.Message build1 = MqCausa.Message.newBuilder()
                .setRetryTime(2)
