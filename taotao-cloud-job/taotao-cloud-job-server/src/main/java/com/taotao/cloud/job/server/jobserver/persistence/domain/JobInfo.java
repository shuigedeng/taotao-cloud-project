...
package com.taotao.cloud.job.server.jobserver.persistence.domain;
...
public class JobInfo implements Serializable {
    ...
    public String toString() {
        return "JobInfo{" + "id="
                + id + ", appId="
                + appName + ", dispatchStrategy="
                + dispatchStrategy + ", gmtCreate="
                + gmtCreate + ", gmtModified="
                + gmtModified + ", jobDescription='"
                + jobDescription + '\'' + ", jobName='"
                + jobName + '\'' + ", jobParams='"
                + jobParams + '\'' + ", lifecycle='"
                + lifecycle + '\'' + ", nextTriggerTime="
                + nextTriggerTime + ", processorInfo='"
                + processorInfo + '\'' + ", status="
                + status + ", timeExpression='"
                + timeExpression + '\'' + ", timeExpressionType="
                + timeExpressionType + '}';
    }
