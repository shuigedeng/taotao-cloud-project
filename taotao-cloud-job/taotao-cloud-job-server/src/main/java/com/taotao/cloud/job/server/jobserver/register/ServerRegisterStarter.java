...
import com.taotao.cloud.job.server.jobserver.extension.singletonpool.GrpcStubSingletonPool;
...
public class ServerRegisterStarter implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ThreadFactory registerThreadFactory = new ThreadFactoryBuilder()
                .setNameFormat("ttcjob-server-register-%d")
                .build();
                        ...
                        try {
                            RegisterCausa.ServerRegisterReporter build =
                                    RegisterCausa.ServerRegisterReporter.newBuilder()
                                            .setServerIpAddress(ttcJobServerConfig.getAddress() + ":"
