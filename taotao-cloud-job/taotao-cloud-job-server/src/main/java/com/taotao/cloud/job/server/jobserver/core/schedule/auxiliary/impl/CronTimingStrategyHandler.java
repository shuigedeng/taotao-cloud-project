...
package com.taotao.cloud.job.server.jobserver.core.schedule.auxiliary.impl;
...
import com.taotao.cloud.job.server.jobserver.core.schedule.auxiliary.TimingStrategyHandler;
...
public class CronTimingStrategyHandler implements TimingStrategyHandler {
    ...
    public CronTimingStrategyHandler() {
        ...
        //	.withDayOfWeek().withValidRange(1,
        // 7).withMondayDoWValue(2).supportsHash().supportsL().supportsQuestionMark().and()
    ...
    public Long calculateNextTriggerTime(Long preTriggerTime, String timeExpression, Long startTime, Long endTime) {
        ...
        // executionTime.lastExecution(ZonedDateTime.ofInstant(Instant.ofEpochMilli(startTime),
