...
public class InstanceInfo implements Serializable {
    ...
    public int hashCode() {
        ...
        result = prime * result
                + ((getActualTriggerTime() == null) ? 0 : getActualTriggerTime().hashCode());
        ...
        result = prime * result
                + ((getRunningTimes() == null) ? 0 : getRunningTimes().hashCode());
        ...
        result = prime * result
                + ((getWfInstanceId() == null) ? 0 : getWfInstanceId().hashCode());
        return result;
    }
