...
import com.taotao.cloud.job.server.jobserver.remote.worker.filter.WorkerFilter;
...
public class WorkerClusterQueryService {
    ...
    public List<WorkerInfo> geAvailableWorkers(JobInfo jobInfo) {
        ...
        List<WorkerInfo> workers = Lists.newLinkedList(
                getWorkerInfosByAppName(jobInfo.getAppName()).values());
