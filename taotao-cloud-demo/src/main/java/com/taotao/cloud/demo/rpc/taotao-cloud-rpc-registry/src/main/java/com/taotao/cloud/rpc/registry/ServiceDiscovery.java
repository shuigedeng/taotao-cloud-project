/**
 * Project Name: my-projects Package Name: com.taotao.rpc.registry Date: 2020/2/27 13:48 Author:
 * shuigedeng
 */
...
public class ServiceDiscovery {
	...
	public String discover() {
		...
		if (size > 0) {
			//负载均衡策略  使用随机方式获取服务
			data = size > 1 ? dataList.get(ThreadLocalRandom.current().nextInt(size))
					: dataList.get(0);
		}
		return data;
	}
